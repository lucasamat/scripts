...
"""
	...
	""
	+ str(Parameter2.QUERY_CRITERIA_1)
	+ " MAEAPM_INBOUND FROM MAEAPM_INBOUND  LEFT JOIN MAEQUP ON MAEAPM_INBOUND.ASSEMBLY_ID = MAEQUP.EQUIPMENT_ID WHERE TIMESTAMP = '"+str(timestamp_sessionid)+"' AND MAEQUP.EQUIPMENT_ID IS NULL '")
	...
	msg.Subject = "SC KIT DATA - Notification(Q-Tenant)"
	msg.IsBodyHtml = True
	msg.Body = Error_Info
	...
	# Set message subject and body
	msg.Subject = "KIT BOM - Error Notification(Q-Tenant)"
	msg.IsBodyHtml = True
	msg.Body = Error_Info
