    ...
    def _create(self):
        ...
        if self.action_type == "ADD_FAB":
            ...
            try:
                ...
                CREDIT_NOTE = ''
            #Trace.Write("CREDIT_NOTE_CHK "+list(self.values))
            for key,val in enumerate(list(self.values)):
                ...
                Trace.Write("total_credits_used--- "+str(total_credits_used)+" - "+str(total_amount_available))
                if float(total_credits_used) > float(total_amount_available):
                    ...
                    if APPLIED_CREDITS!='':
                        ...
                        # try:
                        if float(credit_details.UNBL_INGL_CURR)== 0.00 or float(credit_details.UNBL_INGL_CURR)=='':
            ...
            if credit_applicable != "No":
                ...
                if credit_details.HKONT:
                    credit_HKONT = credit_details.HKONT
                else:
                    credit_HKONT = ''

                if credit_details.ZUONR:
                    credit_ZUONR = credit_details.ZUONR
                else:
                    credit_ZUONR = ''
                if credit_details.SPART:
                    credit_SPART =  credit_details.SPART
                else:
                    credit_SPART = ''
                if get_div_rec:
                    credit_div_rec = get_div_rec.DIVISION_RECORD_ID
                else:
                    credit_div_rec = ''
                row_values = {
                    "GREENBOOK": self.tree_parent_level_0,
                    ...
                    "GL_ACCOUNT_NO": credit_HKONT,
                    "SALESORDER_NO": credit_ZUONR,
                    "CRDVCH_NOTE": CREDIT_NOTE,
                    "DIVISION_ID": credit_SPART,
                    "DIVISION_RECORD_ID": credit_div_rec
                }
    ...
    def _get(self):
        ...
        if get_approvaltxn_steps and str(current_prod).upper() == 'SALES':
            ...
            for val in get_approvaltxn_steps:				
                gettransactionmessage += ('<div class="col-md-12" id="dirty-flag-warning"><div class="col-md-12 alert-warning"><label> <img src="/mt/APPLIEDMATERIALS_UAT/Additionalfiles/warning1.svg" alt="Warning"> '+val.APRCHN_ID +' | Description : ' +val.APRCHN_DESCRIPTION+'</label></div></div>')
...
class ContractQuoteNoficationModel(ContractQuoteCrudOpertion):
    ...
    def _get(self):
        ...
        if adoprod_message_query and not check_active_query and str(current_prod).upper() == 'SALES':			
            msg_app_txt = (
                    '<div  class="col-md-12" id="dirty-flag-warning"><div class="col-md-12 alert-info"><label> <img src="/mt/APPLIEDMATERIALS_UAT/Additionalfiles/infor_icon_green.svg" alt="Warning">'
        ...
        if get_quote_id:
            ...
            if get_approvaltxn_steps and str(current_prod).upper() == 'SALES':
                ...
                for val in get_approvaltxn_steps:
                    ...
                    gettransactionmessage += ('<div class="col-md-12" id="dirty-flag-warning"><div class="col-md-12 alert-warning"><label> <img src="/mt/APPLIEDMATERIALS_UAT/Additionalfiles/warning1.svg" alt="Warning"> '+val.APRCHN_ID +' | Description : ' +str(val.APRCHN_DESCRIPTION).upper()+'</label></div></div>')
            ...
            if edit_config_notification_query:
                if str(edit_config_notification_query.DIRTY_FLAG) == "True":
                    gettransactionmessage += ('<div class="col-md-12" id="dirty-flag-warning"><div class="col-md-12 alert-warning"><label> <img src="/mt/APPLIEDMATERIALS_UAT/Additionalfiles/warning1.svg" alt="Warning"> The quote configuration has changed. Please click on the complete stage button to regenerate the quote items.</label></div></div>')
            ...
            if getStatus:
                if getStatus.MODVRS_DIRTY_FLAG == 1:
                    ...
                    gettransactionmessage += ('<div class="col-md-12" id="dirty-flag-warning"><div class="col-md-12 alert-warning"><label> <img src="/mt/APPLIEDMATERIALS_UAT/Additionalfiles/warning1.svg" alt="Warning"> 99999 | NEW COST MODEL VERSIONS AVAILABLE | There are new cost model versions available from SSCM. In order to update the costs and prices, please revision the quote.</label></div></div>')
            elif getItemFlag:
            ...
            # 	gettransactionmessage += '<div class="col-md-12" id="dirty-flag-warning"><div class="col-md-12 alert-warning"><label> <img src="/mt/APPLIEDMATERIALS_UAT/Additionalfiles/warning1.svg" alt="Warning">The quote revision is on hold due to missing TKM Kit IDs. Your quote will automatically transition out of the hold status once all TKM Kit IDs are available in SSCM.</label></div></div>'
        ...
        # 						ent_msg_txt = (
        # 							'<div class="col-md-12" id="dirty-flag-warning"><div class="col-md-12 alert-warning"><label> <img src="/mt/APPLIEDMATERIALS_UAT/Additionalfiles/warning1.svg" alt="Warning"> '
        ...
        #equip_level_entitlement_obj = Sql.GetFirst("SELECT QUOTE_SERVICE_COVERED_OBJ_ENTITLEMENTS_RECORD_ID FROM SAQSCE (NOLOCK) WHERE IS_CHANGED = 1 AND QUOTE_RECORD_ID= '{QuoteRecordId}' AND QTEREV_RECORD_ID = '{RevisionRecordId}'".format(QuoteRecordId=self.contract_quote_record_id,RevisionRecordId=self.quote_revision_record_id))
            ...
            # if log_message_obj:
            # 	ent_msg_txt += (
            # 		'<div class="col-md-12" id="entitlement-info"><div class="col-md-12 alert-info"><label> <img src="/mt/APPLIEDMATERIALS_UAT/Additionalfiles/infocircle1.svg" alt="Info"> '
