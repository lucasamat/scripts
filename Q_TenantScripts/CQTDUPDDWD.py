...
class ContractQuoteUploadTableData(ContractQuoteSpareOpertion):	
	...
	def _message_txt(self):
		msg_txt = (
					'<div  class="col-md-12" id="dirty-flag-warning"><div class="col-md-12 alert-info"><label> <img src="/mt/APPLIEDMATERIALS_TST/Additionalfiles/infor_icon_green.svg" alt="Warning">PART NUMBERS IMPORTED SUCCESSFULLY </label></div></div>'
				)
		return msg_txt
