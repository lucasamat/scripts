...
TreeSuperParentParam = Quote.GetGlobal("TreeParentLevel1")
TreeTopSuperParentParam = Quote.GetGlobal("TreeParentLevel2")
...
TreeSuperParentParam = Quote.GetGlobal("TreeParentLevel1")
TreeTopSuperParentParam = Quote.GetGlobal("TreeParentLevel2")
TreeSuperTopParentParam = Quote.GetGlobal("TreeParentLevel3")
quote_revision_record_id = Quote.GetGlobal("quote_revision_record_id")
userId = str(User.Id)
userName = str(User.UserName)
