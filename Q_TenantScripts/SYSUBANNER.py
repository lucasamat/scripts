...
def Related_Sub_Banner(
        ...
        if CurrentRecordId.startswith("SYOBJR", 0) == True:
            ...
            if Tab_Obj_Name is not None:
                ...
                if (str(ObjName) == 'SAQTSV'or str(ObjName) == 'SAQSCO' or str(ObjName) == 'SAQSPT') and TreeSuperParentParam == 'Product Offerings'and TabName == "Quotes":
                    ...
                    PrimaryLable = ListKey[0]
                    PrimaryValue = PrimaryValue
    Trace.Write("TreeParam_chk_J_E---"+str(TreeParam))
    if (TreeParam == "Quote Information" and str(ObjName) == 'SAQTMT') and (str(CurrentRecordId) != 'SYOBJR-98857' and str(CurrentRecordId) != 'SYOBJR-98798' and str(CurrentRecordId) != 'SYOBJR-98871' and str(CurrentRecordId) != 'SYOBJR-98858' and str(CurrentRecordId) != 'SYOBJR-00028'):
        try:
    ...
    if subTabName == 'Add On Products' and TreeParentParam == "Comprehensive Services":
        ...
        if str(TreeParam).upper() == "QUOTE INFORMATION" and subTabName == "Involved Parties" and TabName == "Quotes":
            Trace.Write("check addonprod -- 2283")
            sec_rel_sub_bnr += (
    ...
    if bill_plan_years:
        ...
        get_bill_message_warning = ''
    Trace.Write('billing_message-->'+str(billing_message)+'<--get_bill_message_warning---->'+str(get_bill_message_warning))
