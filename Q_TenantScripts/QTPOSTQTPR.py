...
try:
        ...
        for json_data in Jsonquery:
            ...
            if len(rebuilt_data) != 0:      
                ...
                if Check_flag == 1 and Saqico_Flag == 1:
                    ...
                    msg.Subject = "Pricing Initiated - AMAT CPQ(Q-Tenant)"
                    msg.IsBodyHtml = True
                    msg.Body = Error_Info
                    ...
                    # Set message subject and body
                    msg.Subject = "Pricing Completed - AMAT CPQ(Q-Tenant)"
                    msg.IsBodyHtml = True
                    msg.Body = Error_Info
                    ...
                    for Gbk in Greenbkquery:
                        ...
                        if len(tbl_info) > 0:
                            ...
                            # Set message subject and body
                            sub = "On Hold - Costing Quote("+str(Gbk.GREENBOOK)+")- AMAT CPQ (Q-Tenant)"
                            msg.Subject = sub
                            msg.IsBodyHtml = True
                            msg.Body = Error_Info
                    ...
                    if Saqico_Flag == 0:
                        ...
                        # Set message subject and body
                        msg.Subject = "SSCM to CPQ - SAQICO Error Notification(Q-Tenant)"
                        msg.IsBodyHtml = True
                        msg.Body = Error_Info
    ...
    # Set message subject and body
    msg.Subject = "SSCM to CPQ - Pricing Error Notification(Q-Tenant)"
    msg.IsBodyHtml = True
    msg.Body = Error_Info
