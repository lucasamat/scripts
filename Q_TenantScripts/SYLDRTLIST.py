		...
		if Columns != "" and Obj_Name != "":
			...
			if Qstn_REC_ID != "" and Wh_API_NAME != "":
				...
				if str(Qury_str) == "" and str(QuryCount_str) == "":
					...
					if str(RECORD_ID) == "SYOBJR-98795":                                           
						...
						if Product.GetGlobal("TreeParentLevel2") == "Quote Items":                            
							...
							on_hold_costing = '<img title="CFG-ON HOLD - COSTING" src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/pricing_on_hold.svg>'
							on_hold_pricing = '<img title="PRR-ON HOLD PRICING" src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/pricing_on_hold.svg>'
							offline_pricing = '<img title="OFFLINE PRICING" src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/manual_pricing.svg>'
				...
				if RECORD_ID == "SYOBJR-94443" and str(current_tab) == "Tab":                    
					...
					acquiring_img_str = '<img title="Acquiring" src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/Cloud_Icon.svg>'
					cps_pricing_img = ""
					#cps_pricing_img ="<a href=''#'' onclick=''cps_pricing_call(this)''><img src=''/mt/APPLIEDMATERIALS_UAT/Additionalfiles/info.png''  style=''height: 15px; width: 15px; background-size: 20px 20px;''> </a>" 
					error = '<img title="Error" src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/exclamation_icon.svg>'
					Qury_str = (
						"SELECT DISTINCT TOP "
						+ str(PerPage)
						...
						if RECORD_ID != 'SYOBJR-98869':
							if value1234 == "ACQUIRED" or value1234 == "PRICED":
								if RECORD_ID == 'SYOBJR-00005' or RECORD_ID == 'SYOBJR-00029':
									value1234 = value1234.replace(value1234,"<img title='"+str(value1234).title()+"' src='/mt/APPLIEDMATERIALS_UAT/Additionalfiles/Green_Tick.svg'> ")
								else:
									value1234 = value1234.replace(value1234,"<img title='"+str(value1234).title()+"' src='/mt/APPLIEDMATERIALS_UAT/Additionalfiles/Green_Tick.svg'> "+str(value1234))
								
							if value1234 == "APPROVAL REQUIRED":
								value1234 = value1234.replace("APPROVAL REQUIRED","<img title='Approval Required' src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/clock_exe.svg> APPROVAL REQUIRED")
							if value1234 == "ACQUIRING":
								if RECORD_ID == 'SYOBJR-00005' or RECORD_ID =='SYOBJR-00029':
									value1234 = value1234.replace("ACQUIRING","<img title='Acquiring' src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/Cloud_Icon.svg>")
								else:
									value1234 = value1234.replace("ACQUIRING","<img title='Acquiring' src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/Cloud_Icon.svg> ACQUIRING")
							if value1234 == "ERROR":
								if RECORD_ID == 'SYOBJR-00005' or RECORD_ID == 'SYOBJR-00029':
									value1234 = value1234.replace("ERROR","<img title='Error' src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/exclamation_icon.svg>")
								else:
									value1234 = value1234.replace("ERROR","<img title='Error' src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/exclamation_icon.svg> ERROR")
							if value1234 == "NOT PRICED" or RECORD_ID =='SYOBJR-00029':
									if RECORD_ID == 'SYOBJR-00005':
										value1234 = value1234.replace("NOT PRICED","<img title='NOT PRICED' class ='img-noprice' src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/no-price.svg>") 
							if value1234 == "ASSEMBLY IS MISSING":
								value1234 = value1234.replace("ASSEMBLY IS MISSING","<img title='Assembly Missing' src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/Orange1_Circle.svg> ASSEMBLY IS MISSING")
							if value1234 == "CFG-ON HOLD - COSTING":
								#Trace.Write("cmng_inside_on_hold_1 "+str(value1234))
								value1234 = value1234.replace("CFG-ON HOLD - COSTING","<img title='CFG-ON HOLD - COSTING' src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/pricing_on_hold.svg>")
							if value1234 ==  "PRR-ON HOLD PRICING":
								value1234 = value1234.replace("PRR-ON HOLD PRICING","<img title='PRR-ON HOLD PRICING' src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/pricing_on_hold.svg>")
							if value1234 ==  "CFG-ON HOLD TKM":
								value1234 = value1234.replace("CFG-ON HOLD TKM","<img title='ON-HOLD-TKM' src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/icons/on_hold_tkm.svg>")
							if value1234 ==  "OFFLINE PRICING":
								value1234 = value1234.replace("OFFLINE PRICING","<img title='OFFLINE PRICING' src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/manual_pricing.svg>")
							if value1234 == "PARTIALLY PRICED":
								value1234 = value1234.replace("PARTIALLY PRICED","<img title='Partially Priced' src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/Red1_Circle.svg> PARTIALLY PRICED")
						else:
							value1234 = value1234    
				...
				for string in StringValue_list:
					...
					if RECORD_ID != 'SYOBJR-98869':
						if string == "ACQUIRED" or string == "PRICED":
							...
							string_value = string.replace(string,"<img title='"+str(string).title()+"' src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/Green_Tick.svg> ")
						...
						if string == "ASSEMBLY IS MISSING":
							string_value = string.replace("ASSEMBLY IS MISSING","<img title='Assembly Missing' src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/Orange1_Circle.svg> ASSEMBLY IS MISSING")
						if string == "OFFLINE PRICING":
							string_value = string.replace("OFFLINE PRICING","<img title='OFFLINE PRICING' src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/manual_pricing.svg> OFFLINE PRICING")
						if string == "CFG-ON HOLD - COSTING":
							#Trace.Write("cmng_inside_on_hold_1 "+str(value1234))
							string_value = string.replace("CFG-ON HOLD - COSTING","<img title='CFG-ON HOLD - COSTING' src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/pricing_on_hold.svg> CFG-ON HOLD - COSTING")
						if string ==  "PRR-ON HOLD PRICING":
							string_value = string.replace("PRR-ON HOLD PRICING","<img title='PRR-ON HOLD PRICING' src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/pricing_on_hold.svg>")
			...
			if Qstn_REC_ID != "" and Wh_API_NAME != "":
				...
				if ATTRIBUTE_VALUE_STR != "":
					...
					if RECORD_ID == "SYOBJR-95868":                        
						...
						if Product.GetGlobal("TreeParentLevel2") == "Quote Items":  
							...
							if TreeParam == "Quote Items":
								...
								Qury_str = (
									...
									"select top "
										+ str(PerPage)
										+ " CASE WHEN STATUS = 'ACQUIRED' THEN '"+ imgstr +"' WHEN STATUS = 'CFG-ON HOLD TKM' THEN '"+ on_hold_tkm +"' WHEN STATUS = 'APPROVAL REQUIRED' THEN '" +exclamation+ "'  WHEN STATUS = 'OFFLINE PRICING' THEN '" +offline_pricing+ "' WHEN STATUS = 'CFG-ON HOLD - COSTING' THEN '"+on_hold_costing+"' WHEN STATUS = 'PRR-ON HOLD PRICING' THEN '"+on_hold_pricing+"' WHEN STATUS = 'ERROR' THEN '"+ error +"' WHEN STATUS = 'PARTIALLY PRICED' THEN '"+ partially_priced +"' WHEN STATUS = 'ASSEMBLY IS MISSING' THEN '"+ assembly_missing +"'  ELSE '"+ acquiring_img_str +"' END AS STATUS,QUOTE_ITEM_COVERED_OBJECT_RECORD_ID,LINE,SERVICE_ID,OBJECT_ID,EQUIPMENT_ID,ASSEMBLY_ID,GOT_CODE,CNTYER,EQNODE,PROCES,PM_ID,KIT_ID,KIT_NUMBER,MNTEVT_LEVEL,SAPMMP,CNTDAY,FABLOCATION_ID,GREENBOOK,QUANTITY,TOLCFG,KPU,SPQTEV,SPSPCT,SVSPCT,WTYSTE,WTYEND,WTYDAY,INWRTY,ATGKEC,ATGKEP,NWPTOC,ATKNCI,ATKNPI,NWPTOP,CONSCP,CONSPI,NONCCI,NONCPI,AIUICI,AIUIPI,AMNCCI,AMNPPI,TNTVGC,TENVGC,ADDCOF,CAVVCI,CAVVPI,BPTKCI,BPTKPI,TRGPRC,SLSPRC,BDVPRC,CELPRC,TGADJP,YOYPCT,USRPRC,BCHPGC,BCHDPT,CNTPRC,CpqTableEntryId from ( select  ROW_NUMBER() OVER( ORDER BY LINE) AS ROW, * from SAQICO (NOLOCK) where "+ str(ATTRIBUTE_VALUE_STR)+" QUOTE_ID = '"
										+ str(qt_rec_id.QUOTE_ID)
										+ "' AND QTEREV_RECORD_ID = '"
										+ str(quote_revision_record_id)
										+ "') m where m.ROW BETWEEN "
						...
						error = '<img title="Error" src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/exclamation_icon.svg>'
						cps_pricing_img = ""                     
						#cps_pricing_img ='<a href="#" onclick=""><img src="/mt/APPLIEDMATERIALS_UAT/Additionalfiles/info.png"></a>' 
						Qury_str = (
							"SELECT DISTINCT TOP "
							+ str(PerPage)
					...
					if RECORD_ID == "SYOBJR-95868":                        
						...
						if RECORD_ID == "SYOBJR-93122":
							...
							if Product.GetGlobal("TreeParentLevel2") == "Quote Items":
								...
								if TreeParam == "Quote Items":
									...
									Qury_str = (
										"select top "
											+ str(PerPage)
											+ " CASE WHEN STATUS = 'ACQUIRED' THEN '"+ imgstr +"' WHEN STATUS = 'CFG-ON HOLD TKM' THEN '"+ on_hold_tkm +"' WHEN STATUS = 'APPROVAL REQUIRED' THEN '" +exclamation+ "' WHEN STATUS = 'CFG-ON HOLD - COSTING' THEN '"+on_hold_costing+"' WHEN STATUS = 'PRR-ON HOLD PRICING' THEN '"+on_hold_pricing+"' WHEN STATUS = 'OFFLINE PRICING' THEN '"+offline_pricing+"' WHEN STATUS = 'ERROR' THEN '"+ error +"'  WHEN STATUS = 'PARTIALLY PRICED' THEN '"+ partially_priced +"' WHEN STATUS = 'ASSEMBLY IS MISSING' THEN '"+ assembly_missing +"'  ELSE '"+ acquiring_img_str +"' END AS STATUS, QUOTE_ITEM_COVERED_OBJECT_RECORD_ID,LINE,SERVICE_ID,OBJECT_ID,EQUIPMENT_ID,ASSEMBLY_ID,GOT_CODE,CNTYER,EQNODE,PROCES,PM_ID,KIT_NUMBER,KIT_ID,MNTEVT_LEVEL,SAPMMP,CNTDAY,FABLOCATION_ID,GREENBOOK,QUANTITY,TOLCFG,KPU,SPQTEV,SPSPCT,SVSPCT,WTYSTE,WTYEND,WTYDAY,INWRTY,ATGKEC,ATGKEP,NWPTOC,NWPTOP,CONSCP,CONSPI,NONCCI,NONCPI,AIUICI,AIUIPI,AMNCCI,AMNPPI,TNTVGC,TENVGC,ADDCOF,CAVVCI,CAVVPI,BPTKCI,BPTKPI,TRGPRC,ATKNCI,ATKNPI,SLSPRC,BDVPRC,CELPRC,TGADJP,YOYPCT,USRPRC,BCHPGC,BCHDPT,CNTPRC,CpqTableEntryId from ( select  ROW_NUMBER() OVER( ORDER BY "+ str(wh)
											+") AS ROW, * from SAQICO (NOLOCK) where  QUOTE_ID = '"
											+ str(qt_rec_id.QUOTE_ID)
											+ "' AND QTEREV_RECORD_ID = '"+str(quote_revision_record_id)+"') m where m.ROW BETWEEN "
											+ str(Page_start)
							...
							if "ACQUIRED" in price_status and ('ACQUIRING' not in price_status and 'APPROVAL REQUIRED' not in price_status and 'ERROR' not in price_status):
								...
								icon = '<img title="Acquiring" src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/exclamation_icon.svg'
							elif "APPROVAL REQUIRED" in price_status and ('ACQUIRED' not in price_status and 'ERROR' not in price_status and 'ACQUIRING' not in price_status):
								icon = '<img title="Acquiring" src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/clock_exe.svg>'
							elif "ACQUIRING" in price_status and 'ACQUIRED' not in price_status and 'ERROR' not in price_status and 'APPROVAL REQUIRED' not in price_status:
								icon = '<img title="Acquiring" src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/Cloud_Icon.svg>'
				...
				for inm in ik:
					...
					if RECORD_ID != 'SYOBJR-98869':
						...
						if value1234 == "PARTIALLY PRICED":
							value1234 = value1234.replace("PARTIALLY PRICED","<img title='Partially Priced' src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/Red1_Circle.svg> PARTIALLY PRICED")
						if value1234 == "OFFLINE PRICING":
							value1234 = value1234.replace("OFFLINE PRICING","<img title='OFFLINE PRICING' src=/mt/APPLIEDMATERIALS_UAT/Additionalfiles/manual_pricing.svg> OFFLINE PRICING")
