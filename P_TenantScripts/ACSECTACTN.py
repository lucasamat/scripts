            ...
            if GetMaxStepsQuery:
                ...
                <div class="col-md-6 border_rigt_cust chainstep_sub_content p-0">
                            <div class="col-md-1 p-0">
                                <img title="'''+str(my_approval_queue_obj.OWNER_NAME)+'''" class="large_man_recp" src="/mt/APPLIEDMATERIALS_PRD/Additionalfiles/approval_user_icon.svg" >
                            </div>
                                    ...
                                    if contract_quote_record_id != '' and self.quote_revision_record_id:
                                        ...
                                        if quote_obj is not None:
                                            ...
                                            if chain_Type.APPROVAL_METHOD == "SERIES STEP APPROVAL":
                                                parallel_icon = "/mt/APPLIEDMATERIALS_PRD/Additionalfiles/parllel_arrow_icon.svg"
                                            elif chain_Type.APPROVAL_METHOD == "PARALLEL STEP APPROVAL":
                                                parallel_icon = "/mt/APPLIEDMATERIALS_PRD/Additionalfiles/parllel_icon.svg"
                                        else:
                                            parallel_icon = "/mt/APPLIEDMATERIALS_PRD/Additionalfiles/parllel_arrow_icon.svg"
                                    else:
                                        parallel_icon = "/mt/APPLIEDMATERIALS_PRD/Additionalfiles/parllel_arrow_icon.svg"
                                        ...
                                        for GetApprover in GetApproverQuery:
                                            ...
                                            if str(AllStep.APRCHNSTP_ID) not in chain:
                                                ...
                                                if (str(approver_id).startswith("PRO") or str(approver_id).startswith("ROL")):
                                                    Htmlstr += ('''<div class="chainstep_arrow_out_collapse"> <div class="col-md-12 border_rigt_cust chainstep_sub_content p-0">  <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse_'''+str(AllStep.APRCHNSTP_ID)+'''" id="approval-toggle"> <img title="'''+str(apr_chn_stp.APRCHNSTP_APPROVER_ID)+'''" src="/mt/APPLIEDMATERIALS_PRD/Additionalfiles/group_3_user_icon.svg"> <span title="'''+str(apr_chn_stp.APRCHNSTP_APPROVER_ID)+'''">'''+str(apr_chn_stp.APRCHNSTP_APPROVER_ID)+'''</span> </a> '''+str(dynamic_icon_1)+''' </div> </div>''')
                                                        ...
                                                        Htmlstr += (''' <div class="chainstep_arrow_out">
                                                                    ...
                                                                    <div class="col-md-6 border_rigt_cust chainstep_sub_content p-0">
                                                                        <div class="col-md-3 p-0">
                                                                            <img title="'''+str(data.APPROVAL_RECIPIENT)+'''" class="man_recp" src="/mt/APPLIEDMATERIALS_PRD/Additionalfiles/approval_user_icon.svg" class="center-block">
                                                                        </div>
                ...
                Htmlstr += ('''</div>''')
                                ...
                                #                 </div>
                                #                 </div>
                                #                 <img src="/mt/APPLIEDMATERIALS_PRD/Additionalfiles/parllel_connector.svg" class="center-block">
