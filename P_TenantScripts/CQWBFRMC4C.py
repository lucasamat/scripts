...
if 'Param' in globals():    
    if hasattr(Param, 'CPQ_Columns'):       
        ...
        opportunity_status_dictionary = {"OPEN": "OPPORTUNITY OPEN","IN PROCESS": "OPPORTUNITY IN PROCESS","STOPPED":"OPPORTUNITY STOPPED", "LOST":"OPPORTUNITY LOST", "CANCELLED":"OPPORTUNITY CANCELLED","WON" : "OPPROTUNITY WON"}        
