        ...
        if is_key_Flag == "TRUE" or is_required == "TRUE" or is_Past_Date == "TRUE":			
            if Product.Attributes.GetByName("SEC_N_TAB_PAGE_ALERT") is not None:
                ...
                if len(Field_Labels) == 1:
                    ...
                    ).HintFormula = "<div class='col-md-12' id='PageAlert' ><div class='row modulesecbnr brdr' data-toggle='collapse' data-target='#Alert_notifcatio2' aria-expanded='true' >NOTIFICATIONS<i class='pull-right fa fa-chevron-down '></i><i class='pull-right fa fa-chevron-up'></i></div><div  id='Alert_notifcatio2' class='col-md-12  alert-notification  brdr collapse in' ><div  class='col-md-12 alert-danger'  ><label ><img src='/mt/APPLIEDMATERIALS_PRD/Additionalfiles/stopicon1.svg' alt='Error'>'{}' is a required field</label></div></div></div>".format(
                    ...
                    Product.Attributes.GetByName(
                        "SEC_N_TAB_PAGE_ALERT"
                    ).HintFormula = "<div class='col-md-12' id='PageAlert' ><div class='row modulesecbnr brdr' data-toggle='collapse' data-target='#Alert_notifcatio2' aria-expanded='true' >NOTIFICATIONS<i class='pull-right fa fa-chevron-down '></i><i class='pull-right fa fa-chevron-up'></i></div><div  id='Alert_notifcatio2' class='col-md-12  alert-notification  brdr collapse in' ><div  class='col-md-12 alert-danger'  ><label ><img src='/mt/APPLIEDMATERIALS_PRD/Additionalfiles/stopicon1.svg' alt='Error'>ERROR : You will not be able to save your data until all required fields are populated </label></div></div></div>"
                    flag = "FALSE"
            ...
            if TABLE_NAME != "COPART":				
                ...
                if TABLE_NAME == "SAQTMT":
                    ...
                    if GetquoteID.QUOTE_STATUS == "APPROVED":
                        Log.Info("===> QTPOSTACRM calling from SYSECTACTN ===> ")
