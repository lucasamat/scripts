...
def RolesTree_Basic_info_ADD_NEW():
	...
	if str(current_prod) == "SYSTEM ADMIN" and str(current_prod) != "":
		...
		sec_str += '<div id="alert_msg" class="row  alert-danger pad-10 mrg-bt-10 collapse in brdr" style="display: none;"><div class="row"><label class="pad_top10"><img src="/mt/APPLIEDMATERIALS_PRD/Additionalfiles/stopicon1.svg" alt="Error"> You will not able to save until all required fields are populated!</label></div></div>'
