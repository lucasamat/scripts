...
def CoveredObjEntitlement():
	...
	Log.Info("SAQSGE_query---163--156--saqsgeinsert----"+str(qtqtse_query)+'Qt_rec_id--'+str(Qt_rec_id))
	...
	try:
		...
		for rec_table in ['SAQSGE','SAQSCE','SAQGPE','SAQTSE','SAQSAE']:
	...
	if ancillary_dict:
		...
		for anc_key,anc_val in ancillary_dict.items():
			...
			if anc_val == "INSERT" :
				...
				ancillary_result = ScriptExecutor.ExecuteGlobal("CQENANCOPR",{"where_string": where_condition, "quote_record_id": Qt_rec_id, "revision_rec_id": rev_rec_id, "ActionType":ActionType, "ancillary_obj": anc_key, "service_id" : TreeParam , "tablename":"SAQTSE","equip_insert_flag":"True"})
				#2127 ends ..
...
def sendEmail(level):
	...
	LOGIN_CRE = SqlHelper.GetFirst("SELECT User_name,Password FROM SYCONF (nolock) where Domain ='SUPPORT_MAIL'")
	...
	copyEmail4 = MailAddress("suriyanarayanan_pazhani@contractor.amat.com")
