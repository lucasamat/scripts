	...
	if Message is not None:
		...
		for mlist in Message:
			if str(mlist["MESSAGE_LEVEL"]) == "ERROR":
				ErrorIcon = '<img src="/mt/APPLIEDMATERIALS_PRD/Additionalfiles/stopicon1.svg" alt="Error">'
			elif str(mlist["MESSAGE_LEVEL"]) == "WARNING":
				ErrorIcon = '<img src="/mt/APPLIEDMATERIALS_PRD/Additionalfiles/warning1.svg" alt="Warning">'
			else:
				ErrorIcon = '<img src="/mt/APPLIEDMATERIALS_PRD/Additionalfiles/infocircle1.svg" alt="Info">'
			msg_txt.append(
				"<label> "
				+ str(ErrorIcon)
...
def GetQBlevelinfoMessage(OBJRECID, SegmentId, versionId):
	...
	if ErrorMessageObjQry is not None:
		...
		if ErrorMessageObjQryQB is not None:
			msg_txt = (
				'<label> <img src="/mt/APPLIEDMATERIALS_PRD/Additionalfiles/infocircle1.svg" alt="Info"> '
...
def GetCompleteWarningMessage(OBJRECID, SegmentId, versionId):
	...
	if ErrorMessageObjQry is not None:
		msg_txt = (
			'<div class="col-md-12" id="complete-warning"><div class="col-md-12 alert-warning"><label><img src="/mt/APPLIEDMATERIALS_PRD/Additionalfiles/warning1.svg" alt="Warning">'
			+ str(ErrorMessageObjQry.MESSAGE_LEVEL)
			+ " : "
			+ str(ErrorMessageObjQry.MESSAGE_CODE)
			+ " : "
