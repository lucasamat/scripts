										...
										if iskey is not None and flag == "True": 
											...
											if unique_val is not None and unique_val != "":
												...
												if is_key_table is None:
													...
													if TABLE_NAME == "cpq_permissions"  and Product.Attributes.GetByName(
														...
														if TABLE_NAME == "ACAPCH":
															Product.Attributes.GetByName(
																"SEC_N_TAB_PAGE_ALERT"
															).HintFormula = '<div class="col-md-12"   id="PageAlert"  ><div class="row modulesecbnr brdr" data-toggle="collapse" data-target="#Alert11" aria-expanded="true" >NOTIFICATIONS<i class="pull-right fa fa-chevron-down "></i><i class="pull-right fa fa-chevron-up"></i></div><div  id="Alert11" class="col-md-12  alert-notification  brdr collapse in" ><div  class="col-md-12 alert-danger"    ><label ><img src="/mt/APPLIEDMATERIALS_PRD/Additionalfiles/stopicon1.svg" alt="Error">  ERROR : This "Approval Chain Id" Already exists </label></div></div></div>'
														else:
															Product.Attributes.GetByName(
																"SEC_N_TAB_PAGE_ALERT"
															).HintFormula = '<div class="col-md-12"   id="PageAlert"  ><div class="row modulesecbnr brdr" data-toggle="collapse" data-target="#Alert11" aria-expanded="true" >NOTIFICATIONS<i class="pull-right fa fa-chevron-down "></i><i class="pull-right fa fa-chevron-up"></i></div><div  id="Alert11" class="col-md-12  alert-notification  brdr collapse in" ><div  class="col-md-12 alert-danger"    ><label ><img src="/mt/APPLIEDMATERIALS_PRD/Additionalfiles/stopicon1.svg" alt="Error">  ERROR : This "Role Id & Name" Already exists </label></div></div></div>'
												...
												if (
													...
													Product.Attributes.GetByName(
														"SEC_N_TAB_PAGE_ALERT"
													).HintFormula = '<div class="col-md-12"   id="PageAlert"  ><div class="row modulesecbnr brdr" data-toggle="collapse" data-target="#Alert12" aria-expanded="true" >NOTIFICATIONS<i class="pull-right fa fa-chevron-down "></i><i class="pull-right fa fa-chevron-up"></i></div><div  id="Alert12" class="col-md-12  alert-notification  brdr collapse in" ><div  class="col-md-12 alert-danger"    ><label ><img src="/mt/APPLIEDMATERIALS_PRD/Additionalfiles/stopicon1.svg" alt="Error">  ERROR : You will not be able to save your data until all required fields are populated </label></div></div></div>'
											...
											if (
												...
												# Product.Attributes.GetByName("SEC_N_TAB_PAGE_ALERT").HintFormula = """<div class='col-md-12' id='PageAlert' style='display':'block'; ><div class='row modulesecbnr brdr' data-toggle='collapse' data-target='#Alert13' aria-expanded='true' >NOTIFICATIONS<i class='pull-right fa fa-chevron-down '></i><i class='pull-right fa fa-chevron-up'></i></div><div  id='Alert13' class='col-md-12  alert-notification  brdr collapse in' ><div  class='col-md-12 alert-danger'><label ><img src="/mt/APPLIEDMATERIALS_PRD/Additionalfiles/stopicon1.svg" alt="Error">  ERROR : '{}' is a required field </label></div></div></div>""".format(sectalert)
												...
												if len(Field_Labels) > 1:
													...
													Product.Attributes.GetByName(
														"SEC_N_TAB_PAGE_ALERT"
													).HintFormula = "<div class='col-md-12' id='PageAlert' style='display':'block';  ><div class='row modulesecbnr brdr' data-toggle='collapse' data-target='#Alert13' aria-expanded='true' >NOTIFICATIONS<i class='pull-right fa fa-chevron-down '></i><i class='pull-right fa fa-chevron-up'></i></div><div  id='Alert13' class='col-md-12  alert-notification  brdr collapse in' ><div  class='col-md-12 alert-danger'><label ><img src='/mt/APPLIEDMATERIALS_PRD/Additionalfiles/stopicon1.svg' alt='Error'>  ERROR : '{}' are required fields </label></div></div></div>".format(
														sectalert
													)                                                    
												...
												if Product.Attributes.GetByName("QSTN_SYSEFL_AC_00006"):
													...
													if ApprovalMethod == "":
														Product.Attributes.GetByName(
															"SEC_N_TAB_PAGE_ALERT"
														).HintFormula = "<div class='col-md-12' id='PageAlert' style='display':'block';  ><div class='row modulesecbnr brdr' data-toggle='collapse' data-target='#Alert13' aria-expanded='true' >NOTIFICATIONS<i class='pull-right fa fa-chevron-down '></i><i class='pull-right fa fa-chevron-up'></i></div><div  id='Alert13' class='col-md-12  alert-notification  brdr collapse in' ><div  class='col-md-12 alert-danger'><label ><img src='/mt/APPLIEDMATERIALS_PRD/Additionalfiles/stopicon1.svg' alt='Error'>  ERROR : Please select an Approval Method from the list for Approval Chain</label></div></div></div>".format(
															sectalert
														)    
												if len(Field_Labels) <= 1:
													...
													if sectalert:  
														Product.Attributes.GetByName(
															"SEC_N_TAB_PAGE_ALERT"
														).HintFormula = "<div class='col-md-12' id='PageAlert' style='display':'block';  ><div class='row modulesecbnr brdr' data-toggle='collapse' data-target='#Alert13' aria-expanded='true' >NOTIFICATIONS<i class='pull-right fa fa-chevron-down '></i><i class='pull-right fa fa-chevron-up'></i></div><div  id='Alert13' class='col-md-12  alert-notification  brdr collapse in' ><div  class='col-md-12 alert-danger'><label ><img src='/mt/APPLIEDMATERIALS_PRD/Additionalfiles/stopicon1.svg' alt='Error'>  ERROR : '{}' is a required field</label></div></div></div>".format(
															sectalert
														)      
													else:
														Product.Attributes.GetByName(
															"SEC_N_TAB_PAGE_ALERT"
														).HintFormula = "<div class='col-md-12' id='PageAlert' style='display':'block';  ><div class='row modulesecbnr brdr' data-toggle='collapse' data-target='#Alert13' aria-expanded='true' >NOTIFICATIONS<i class='pull-right fa fa-chevron-down '></i><i class='pull-right fa fa-chevron-up'></i></div><div  id='Alert13' class='col-md-12  alert-notification  brdr collapse in' ><div  class='col-md-12 alert-danger'><label ><img src='/mt/APPLIEDMATERIALS_PRD/Additionalfiles/stopicon1.svg' alt='Error'>  ERROR : Approval Chain Id should be 8 Characters</label></div></div></div>"
											elif (
												Product.Attributes.GetByName("SEC_N_TAB_PAGE_ALERT") is not None
												and flag == "null"
											):
												...
												if len(Field_Labels) > 1:
													Product.Attributes.GetByName(
														"SEC_N_TAB_PAGE_ALERT"
													).HintFormula = "<div class='col-md-12' id='PageAlert'  ><div class='row modulesecbnr brdr' data-toggle='collapse' data-target='#Alert13' aria-expanded='true' >NOTIFICATIONS<i class='pull-right fa fa-chevron-down '></i><i class='pull-right fa fa-chevron-up'></i></div><div  id='Alert13' class='col-md-12  alert-notification  brdr collapse in' ><div  class='col-md-12 alert-danger'><label ><img src='/mt/APPLIEDMATERIALS_PRD/Additionalfiles/stopicon1.svg' alt='Error'>  ERROR : '{}' are required fields </label></div></div></div>".format(
														sectalert
													)
													...
													Product.Attributes.GetByName(
														"SEC_N_TAB_PAGE_ALERT"
													).HintFormula = "<div class='col-md-12' id='PageAlert'  ><div class='row modulesecbnr brdr' data-toggle='collapse' data-target='#Alert13' aria-expanded='true' >NOTIFICATIONS<i class='pull-right fa fa-chevron-down '></i><i class='pull-right fa fa-chevron-up'></i></div><div  id='Alert13' class='col-md-12  alert-notification  brdr collapse in' ><div  class='col-md-12 alert-danger'><label ><img src='/mt/APPLIEDMATERIALS_PRD/Additionalfiles/stopicon1.svg' alt='Error'>  ERROR : '{}' is a required field</label></div></div></div>".format(
														sectalert
													)
										...
										if (
															...
															if (
																...
																if len(Field_Labels) > 1:
																	...
																	if Field_Labels:
																		Product.Attributes.GetByName(
																			"SEC_N_TAB_PAGE_ALERT"
																		).HintFormula = '<div class="col-md-12"   id="PageAlert"  ><div class="row modulesecbnr brdr" data-toggle="collapse" data-target="#Alert18" aria-expanded="true" >NOTIFICATIONS<i class="pull-right fa fa-chevron-down "></i><i class="pull-right fa fa-chevron-up"></i></div><div  id="Alert18" class="col-md-12  alert-notification  brdr collapse in" ><div  class="col-md-12 alert-danger"    ><label ><img src="/mt/APPLIEDMATERIALS_PRD/Additionalfiles/stopicon1.svg" alt="Error"> ERROR : "{0}" are required fields </label></div></div></div>'.format(
																			sectalert
																	)
										else:
											if Product.Attributes.GetByName("SEC_N_TAB_PAGE_ALERT") is not None:
												...
												if len(Field_Labels) > 1:
													Product.Attributes.GetByName(
														"SEC_N_TAB_PAGE_ALERT"
													).HintFormula = '<div class="col-md-12"   id="PageAlert"  ><div class="row modulesecbnr brdr" data-toggle="collapse" data-target="#Alert19" aria-expanded="true" >NOTIFICATIONS<i class="pull-right fa fa-chevron-down "></i><i class="pull-right fa fa-chevron-up"></i></div><div  id="Alert19" class="col-md-12  alert-notification  brdr collapse in" ><div  class="col-md-12 alert-danger"    ><label ><img src="/mt/APPLIEDMATERIALS_PRD/Additionalfiles/stopicon1.svg" alt="Error"> ERROR : "{0}" are required fields </label></div></div></div>'.format(
														sectalert
													)
												else:
													Product.Attributes.GetByName(
														"SEC_N_TAB_PAGE_ALERT"
													).HintFormula = '<div class="col-md-12"   id="PageAlert"  ><div class="row modulesecbnr brdr" data-toggle="collapse" data-target="#Alert19" aria-expanded="true" >NOTIFICATIONS<i class="pull-right fa fa-chevron-down "></i><i class="pull-right fa fa-chevron-up"></i></div><div  id="Alert19" class="col-md-12  alert-notification  brdr collapse in" ><div  class="col-md-12 alert-danger"    ><label ><img src="/mt/APPLIEDMATERIALS_PRD/Additionalfiles/stopicon1.svg" alt="Error"> ERROR :"{0}" is a required field  </label></div></div></div>'.format(
														sectalert
													)