...
class DeleteConfirmPopup:
    ...
    def CommonDeleteConfirmation(self, RecordId, ObjName, Message, RecordValue):
        ...
        try:
            ...
            if str(Message) == "WARNING":
                InfoIcon = "/mt/APPLIEDMATERIALS_SIT/Additionalfiles/warning1.svg"
                ...
                InfoIcon = "mt/APPLIEDMATERIALS_SIT/Additionalfiles/infocircle1.svg"
                ...
                InfoIcon = "mt/APPLIEDMATERIALS_SIT/Additionalfiles/stopicon1.svg"
    ...
    def DelEquipmentTrace(self, RecordId, ObjName):
        ...
        Trace.Write("OM...ObjName-----> " + str(ObjName) + " - "+str(TreeParam)+" - "+str(Product.GetGlobal("TreeParentLevel0"))+ " - "+str(Product.GetGlobal("TreeParentLevel1")))
        refresh_flag = False
        if TreeParentParam == 'Fab Locations':
            ...
            if CheckItem is None:
                if GetCount.cnt >1:
                    ...
                    Objects = ["SAQFEQ","SAQFEA","SAQSCO","SAQSCA","SAQSAP","SAQSKP","SAQSCE","SAQSCN","SAQSAE","SAQGPA","SAQFGB","SAQSGB"]#1934 
                    for obj in Objects:
                    ...
                    if GetCount.cnt == 1:
                        ...
                        Objects = ["SAQFEQ","SAQFEA","SAQSCO","SAQSCA","SAQSAP","SAQSKP","SAQSCN","SAQSFB","SAQSCE","SAQSAE","SAQSGE","SAQSFE","SAQSGB","SAQGPA","SAQFGB","SAQSGB"]#1934 
                        for obj in Objects:
                ...
                GetEquipment = Sql.GetFirst("SELECT EQUIPMENT_ID FROM SAQFEQ WHERE QUOTE_FAB_LOCATION_EQUIPMENTS_RECORD_ID = '{}'".format(ObjName.split("#")[1]))
                Objects = ["SAQFEQ","SAQFEA","SAQSCO","SAQSCA","SAQSAP","SAQSCN","SAQSKP","SAQSCE","SAQSAE","SAQGPA","SAQFGB","SAQSGB"]#1934 
                for obj in Objects:
                    a = Sql.RunQuery("DELETE FROM {Obj} WHERE QUOTE_RECORD_ID = '{QuoteId}' AND EQUIPMENT_ID = '{Eq}' AND QTEREV_RECORD_ID = '{quote_revision_record_id}'".format(Obj=obj,QuoteId=Quote.GetGlobal("contract_quote_record_id"),Eq=GetEquipment.EQUIPMENT_ID,quote_revision_record_id=quote_revision_record_id))
            else:
            ...
            if CheckItem is None:
                ...
                GetEquipment = Sql.GetFirst("SELECT EQUIPMENT_ID FROM SAQFEQ WHERE QUOTE_FAB_LOCATION_EQUIPMENTS_RECORD_ID = '{}'".format(ObjName.split("#")[1]))
                Objects = ["SAQFEQ","SAQFEA","SAQSCO","SAQSCA","SAQSCN","SAQSAP","SAQSKP","SAQSCE","SAQSAE","SAQGPA"]#1934 
                for obj in Objects:
                    a = Sql.RunQuery("DELETE FROM {Obj} WHERE QUOTE_RECORD_ID = '{QuoteId}' AND EQUIPMENT_ID = '{Eq}' AND QTEREV_RECORD_ID = '{quote_revision_record_id}'".format(Obj=obj,QuoteId=Quote.GetGlobal("contract_quote_record_id"),Eq=GetEquipment.EQUIPMENT_ID,quote_revision_record_id=quote_revision_record_id))
            else:
                Sql.RunQuery("UPDATE SAQTRV SET DIRTY_FLAG = 1 WHERE QUOTE_RECORD_ID = '{}' AND QTEREV_RECORD_ID = '{}'".format(Quote.GetGlobal("contract_quote_record_id"),quote_revision_record_id))
            ...
            if CheckItem is None:
                if GetCount.cnt >1:
                    ...
                    if GetCount.cnt == 1:
                        Trace.Write("Only one equipment")
                        Objects = ["SAQFEQ","SAQFEA","SAQSCO","SAQSCA","SAQSAP","SAQSCN","SAQSKP","SAQSFB","SAQSCE","SAQSAE","SAQSGE","SAQSFE","SAQSGB","SAQGPA","SAQFGB","SAQSGB"]#1934 
                        for obj in Objects:
                ...
                GetEquipment = Sql.GetFirst("SELECT EQUIPMENT_ID FROM SAQFEQ WHERE QUOTE_FAB_LOCATION_EQUIPMENTS_RECORD_ID = '{}'".format(ObjName.split("#")[1]))
                Objects = ["SAQFEQ","SAQFEA","SAQSCO","SAQSCA","SAQSAP","SAQSKP","SAQSCN","SAQSCE","SAQSAE","SAQGPA","SAQFGB","SAQSGB"]#1934 
                for obj in Objects:
                    a = Sql.RunQuery("DELETE FROM {Obj} WHERE QUOTE_RECORD_ID = '{QuoteId}' AND EQUIPMENT_ID = '{Eq}' AND QTEREV_RECORD_ID = '{quote_revision_record_id}'".format(Obj=obj,QuoteId=Quote.GetGlobal("contract_quote_record_id"),Eq=GetEquipment.EQUIPMENT_ID,quote_revision_record_id=quote_revision_record_id))
            else:
                Sql.RunQuery("UPDATE SAQTRV SET DIRTY_FLAG = 1 WHERE QUOTE_RECORD_ID = '{}' AND QTEREV_RECORD_ID = '{}'".format(Quote.GetGlobal("contract_quote_record_id"),quote_revision_record_id))
    ...
    def CommonDelete(self, RecordId, ObjName):
        ...
        # A055S000P01-1170 End-Om Shanker
            ...
            if fab_location:                
                TOOLDELETELIST = ["SAQFBL","SAQFEQ","SAQSAP","SAQSCA","SAQSKP","SAQSCO","SAQGPA","SAQFGB","SAQSGB"]#1934 
                for Table in TOOLDELETELIST:
            ...
            credit_applied = sacrcv_rec_query.CRTAPP_INGL_CURR - deleted_rec_query.CREDIT_APPLIED_INGL_CURR if deleted_rec_query.CREDIT_APPLIED_INGL_CURR else ""
            unapplied_balance = sacrcv_rec_query.UNBL_INGL_CURR + deleted_rec_query.CREDIT_APPLIED_INGL_CURR if deleted_rec_query.CREDIT_APPLIED_INGL_CURR else ""
