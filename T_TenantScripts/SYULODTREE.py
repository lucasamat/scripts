            ...
            if getParentObjQuery is not None:
                for getParentObj in getParentObjQuery:
                    ...
                    if str(getParentObj.TREEIMAGE_URL):
                        ...
                        image_url = '<img class="leftside-bar-icons" src="/mt/appliedmaterials_sit/Additionalfiles/AMAT/Quoteimages/{image_url}"/>'.format(
                            image_url=image_url
                        )
                        active_image_url = str(getParentObj.ACTIVE_TREEIMAGE_URL)
                        active_image_url = '<img class="activeimage-leftside-bar-icons" src="/mt/appliedmaterials_sit/Additionalfiles/AMAT/Quoteimages/{image_url}"/>'.format(
                            ...
                            if NodeText == "True":
                                ...
                                if str(ObjName).strip() == "SAQTSV" and str(NodeName) == "SERVICE_ID":
                                    ...
                                    try:
                                        ...
                                        image_url = ""
                                    if image_url:
                                        image_url = '<img class="leftside-bar-status_icon" src="/mt/appliedmaterials_sit/Additionalfiles/AMAT/Quoteimages/{image_url}"/>'.format(
                                            image_url=image_url
                                        )
                                ...
                                if NodeText.replace(lock_icon,"") in (
                                    ...
                                    if Currenttab == "Contracts":
                                        ...
                                        Subwhere_string += " AND SERVICE_TYPE = '{}' AND QTEREV_RECORD_ID = '{}' AND SERVICE_ID != 'Z0046' AND SERVICE_ID != 'Z0101'".format(
                                            NodeText.replace(lock_icon,""), quote_revision_record_id
                                        )
