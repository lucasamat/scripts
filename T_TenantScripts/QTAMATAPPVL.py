...
def InsertApprovals(QTRevId):     
    ...
    appcount=0
    if approverQuery.QT_PAYMENTTERM_DAYS is not None:
...
if str(Quote_status) == "Preparing" and (str(Revision_Status) != "APR-APPROVED" and str(Revision_Status) != "APR-REJECTED" and str(Revision_Status) != "APR-RECALLED"):
