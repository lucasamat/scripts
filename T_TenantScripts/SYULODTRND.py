...
def CommonTreeViewHTMLDetail(
    ...
    if ObjectName != 'SAQRIB':
        sec_str += ' <div class="col-md-12"   id="alert_msg" style="display: none;"><div class="row modulesecbnr brdr" data-toggle="collapse" data-target="#Alertmsg8" aria-expanded="true">NOTIFICATIONS<i class="pull-right fa fa-chevron-down "></i><i class="pull-right fa fa-chevron-up"></i></div><div  id="Alertmsg8" class="col-md-12  alert-notification  brdr collapse in" ><div  class="col-md-12 alert-danger"  ><label ><img src="/mt/APPLIEDMATERIALS_SIT/Additionalfiles/stopicon1.svg" alt="Error">  </label></div></div></div>'
...
and GREENBOOK = '{}' AND FABLOCATION_ID = '{}' AND SERVICE_ID = '{}'""".format(quote_record_id,quote_revision_record_id,TreeParam,TreeParentParam,Product.GetGlobal("TreeParentLevel1").split(" ")[0].strip())
        ...
        try:
            ...
            if ObjectName == "SAQSKP":
                Product.SetGlobal("KitId",str(Custom_obj.KIT_ID))
                KitId = Product.GetGlobal("KitId")
            Trace.Write("TreeParam"+str(TreeParam))
        ...
        if data_obj is not None:
            ...
            for val in data_obj:				
                ...
                if ObjectName == "SAQRIB" and TreeParam == "Billing":
                    contract_quote_record_id = Quote.GetGlobal("contract_quote_record_id")
                    get_billing_cycle = Sql.GetFirst("SELECT BILLING_CYCLE FROM SAQITE where QUOTE_RECORD_ID = '"+str(contract_quote_record_id)+"' AND QTEREV_RECORD_ID = '"+str(quote_revision_record_id)+"' AND SERVICE_ID='"+str(TreeParam)+"'")
                    if get_billing_cycle:
                        if str(get_billing_cycle.BILLING_CYCLE).upper() == "WEEKLY":
                            noninlist = [						
                                "SALESORG_ID","BILLING_DAY",
                                "SALESORG_NAME"					
                            ]
                            if current_obj_api_name in noninlist:
                                add_style = "display: none;"
                            ...
                            noninlist = [						
                                "SALESORG_ID","BILLING_DAY_OF_THE_WEEK",
                                "SALESORG_NAME"					
                            ]
                            if current_obj_api_name in noninlist:
                                add_style = "display: none;"
                ...
                Trace.Write('current_obj_field_lable-->'+ str(current_obj_field_lable))
                sec_str += (
                ...
                Trace.Write("CHKZ_MODE_J 1315---- "+str(MODE))
                ...
                if data_type == "AUTO NUMBER":					
                    ...
                    if current_obj_api_name == "approve_condition_id" and ObjectName == "approve_condition":
                        ...
                        if (
                            ...
                            Trace.Write('@@@'+str(ObjectName)+':'+str(current_obj_value))
                    ...
                    Trace.Write('@@@'+str(current_obj_value)+':'+str(current_obj_api_name))
                    auto_field = (
                    ...
                    if str(MODE)=="VIEW" or str(MODE)=="CANCEL":							
                        ...
                        #added try except for defect 1603
                        try:
                            sec_str += (
                                '<td><textarea title="'
                                + str(current_obj_value)
                    ...
                    Trace.Write("lookup_fields "+str(current_obj_api_name))
                    sec_str += (
                        '<td><input id="'
                        + str(current_obj_api_name)
                        + '" type="text" value="'
                    ...
                    if str(MODE) == "EDIT":				
                        ...
                        # 	)
                        # else:
                        Trace.Write('2408--->'+ str(current_obj_api_name))
                        sec_str += (
                            '<td><input id="'
                            + str(current_obj_api_name)
                            + '" type="text" '+len_restrict+' value="'
    ...
    # 					WHERE QUOTE_BILLING_PLAN_RECORD_ID = '{}'""".format(RECORD_ID))
        ...
        # 		notification = ' <div class="col-md-12" id="alert_msg" style="display: block;"><div class="row modulesecbnr brdr" data-toggle="collapse" data-target="#Alertmsg8" aria-expanded="true" >NOTIFICATIONS<i class="pull-right fa fa-chevron-down "></i><i class="pull-right fa fa-chevron-up"></i></div><div  id="Alertmsg8" class="col-md-12  alert-notification  brdr collapse in" ><div  class="col-md-12 alert-warning"  ><label ><img src="/mt/APPLIEDMATERIALS_SIT/Additionalfiles/warning1.svg" alt="Warning">  Changes have been made to the Quote Configuration. Please refresh the Billing Matrix.</label></div></div></div>'
...
def UpdateBreadcrumb(REC_ID):	
    ...
    Action_Str += '</abbr></a><span class="angle_symbol"><img src="/mt/appliedmaterials_sit/images/productimages/BREADCRUMB_ICON_TRANS.PNG"></span></li>'
...
# 									imgstr = ('<img title=Acquired src=/mt/APPLIEDMATERIALS_SIT/Additionalfiles/clock_exe.svg>')
# 								else:
# 									imgstr  = ""
...
# 	if GetCPSVersion:
# 		if GetCPSVersion.KB_VERSION is not None and GetCPSVersion.KB_VERSION != Fullresponse["kbKey"]["version"]:
# 			sec_str += '<div id="Headerbnr" class="mart_col_back disp_blk"><div class="col-md-12" id="PageAlert"><div class="row modulesecbnr brdr" data-toggle="collapse" data-target="#Alert_notifcatio6" aria-expanded="true">NOTIFICATIONS<i class="pull-right fa fa-chevron-down"></i><i class="pull-right fa fa-chevron-up"></i></div><div id="Alert_notifcatio6" class="col-md-12 alert-notification brdr collapse in"><div class="col-md-12 alert-info"><label title=" Information : The Knowledgebase of the VC Characteristics has been updated in CPS."><img src="/mt/APPLIEDMATERIALS_SIT/Additionalfiles/infocircle1.svg" alt="Info"> Information : The Knowledgebase of the VC Characteristics has been updated in CPS.</label></div></div></div></div>'
# 		else:
# 			sec_str = ''
# 	else:
# 		Trace.Write("GETCPS VERSION EMPTY!")'''	
