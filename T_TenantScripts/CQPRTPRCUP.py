...
if (domain).lower() == 'appliedmaterials_sit':
	kyma_url='https://t-tenant-spares-pricing.c-1404e87.kyma.shoot.live.k8s-hana.ondemand.com'
	cpi_url="https://e250404-iflmap.hcisbt.us3.hana.ondemand.com/cxf/QTGETENPRT"
elif (domain).lower() == 'appliedmaterials_uat':
	kyma_url='https://q-tenant-hanadbconnectivity.c-1404e87.kyma.shoot.live.k8s-hana.ondemand.com'
	cpi_url="https://e250404-iflmap.hcisbt.us3.hana.ondemand.com/cxf/QTGETENPRQ"
elif (domain).lower() == 'appliedmaterials_opt':
	kyma_url='https://stateless-pricing-call.c-68c90e5.kyma.ondemand.com'
...
try:
	...
	responseData = webclient.UploadString(str(kyma_url),requestData)
