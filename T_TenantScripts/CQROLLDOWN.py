    ...
    if ancillary_dict:
        ...
        for anc_key,anc_val in ancillary_dict.items():
            ...
            if anc_val == "INSERT" :
                ...
                ancillary_result = ScriptExecutor.ExecuteGlobal("CQENANCOPR",{"where_string": where_condition, "quote_record_id": Qt_rec_id, "revision_rec_id": rev_rec_id, "ActionType":ActionType, "ancillary_obj": anc_key, "service_id" : TreeParam , "tablename":"SAQTSE","equip_insert_flag":"True"}) #2127
