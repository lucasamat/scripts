...
"""
	...
	if len(Error_list) > 0:
		...
		# Send the message
		mailClient.Send(msg)
		Lst_resp.append({"Status": "400", "Message": "Error mail sent"})
	else:
		Lst_resp.append({"Status": "200", "Message": "CONTRACT DATA SUCCESSFULLY UPLOADED"})
