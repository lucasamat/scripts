		...
		for json_data in Jsonquery:			
			...
			if len(rebuilt_data) != 0:      
				...
				if Check_flag == 1:  
					...
					#result = ScriptExecutor.ExecuteGlobal("CQSAQITMIN",{"QT_REC_ID":})	
