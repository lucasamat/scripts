				...
				if Check_flag == 1 and Saqico_Flag == 1:  
					...
					while Check_flag12 == 1:
						...
						if str(table12) != "None":
							...
							"sp_executesql @T=N'SELECT * INTO "+str(SAQSCE)+" FROM SAQIEN(NOLOCK) JOIN "+str(CRMTMP)+"  ON EQUIPMENT_ID = EQUIPMENT_IDD  WHERE QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"''  '")
							
							#SAQIEN NPI
							#Z0091
							primaryQueryItems = SqlHelper.GetFirst("sp_executesql @t=N'UPDATE A SET ENTITLEMENT_XML = REPLACE(entitlement_xml ,  substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0091_VAL_NPIREC</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''</ENTITLEMENT_VALUE_CODE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0091_VAL_NPIREC</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ), ''<ENTITLEMENT_ID>AGS_Z0091_VAL_NPIREC</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>''+NPI_CODE ) FROM SAQIEN(NOLOCK) A JOIN (SELECT DISTINCT QUOTE_ID ,SERVICE_ID,EQUIPMENT_ID,REVISION_ID,NPI_CODE FROM SAQICO_INBOUND B(NOLOCK) JOIN "+str(CRMTMP)+" C ON B.EQUIPMENT_ID = C.EQUIPMENT_IDD WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND SERVICE_ID = ''Z0091'' ) B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID  = B.EQUIPMENT_ID AND A.QTEREV_ID = B.REVISION_ID  WHERE A.QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND A.QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"'' AND ISNULL(NPI_CODE,'''')<>'''' AND charindex( ''<ENTITLEMENT_ID>AGS_Z0091_VAL_NPIREC</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'',replace(replace(entitlement_xml,''	'',''''),''\n'','''')) >0 '")
							
							primaryQueryItems = SqlHelper.GetFirst("sp_executesql @t=N'UPDATE A SET ENTITLEMENT_XML = REPLACE(entitlement_xml ,  substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0091_VAL_NPIREC</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''</ENTITLEMENT_DISPLAY_VALUE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0091_VAL_NPIREC</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ), replace(substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0091_VAL_NPIREC</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''<ENTITLEMENT_DISPLAY_VALUE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0091_VAL_NPIREC</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ),''select'','''') +''<ENTITLEMENT_DISPLAY_VALUE>'' + TOOL_NPI  ) FROM SAQIEN(NOLOCK) A JOIN (SELECT DISTINCT QUOTE_ID ,SERVICE_ID,EQUIPMENT_ID,REVISION_ID,TOOL_NPI FROM SAQICO_INBOUND B(NOLOCK) JOIN "+str(CRMTMP)+" C ON B.EQUIPMENT_ID = C.EQUIPMENT_IDD WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND SERVICE_ID = ''Z0091'' ) B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID  = B.EQUIPMENT_ID AND A.QTEREV_ID = B.REVISION_ID  WHERE A.QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND A.QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"'' AND ISNULL(TOOL_NPI,'''')<>'''' AND charindex( ''<ENTITLEMENT_ID>AGS_Z0091_VAL_NPIREC</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'',replace(replace(entitlement_xml,''	'',''''),''\n'','''')) >0 '")
							
							#Z0092
							primaryQueryItems = SqlHelper.GetFirst("sp_executesql @t=N'UPDATE A SET ENTITLEMENT_XML = REPLACE(entitlement_xml ,  substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0092_VAL_NPIREC</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''</ENTITLEMENT_VALUE_CODE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0092_VAL_NPIREC</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ), ''<ENTITLEMENT_ID>AGS_Z0092_VAL_NPIREC</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>''+NPI_CODE ) FROM SAQIEN(NOLOCK) A JOIN (SELECT DISTINCT QUOTE_ID ,SERVICE_ID,EQUIPMENT_ID,REVISION_ID,NPI_CODE FROM SAQICO_INBOUND B(NOLOCK) JOIN "+str(CRMTMP)+" C ON B.EQUIPMENT_ID = C.EQUIPMENT_IDD WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND SERVICE_ID = ''Z0092'' ) B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID  = B.EQUIPMENT_ID AND A.QTEREV_ID = B.REVISION_ID  WHERE A.QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND A.QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"'' AND ISNULL(NPI_CODE,'''')<>'''' AND charindex( ''<ENTITLEMENT_ID>AGS_Z0092_VAL_NPIREC</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'',replace(replace(entitlement_xml,''	'',''''),''\n'','''')) >0 '")
							...
							#Z0035
							primaryQueryItems = SqlHelper.GetFirst("sp_executesql @t=N'UPDATE A SET ENTITLEMENT_XML = REPLACE(entitlement_xml ,  substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0035_VAL_NPIREC</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''</ENTITLEMENT_VALUE_CODE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0035_VAL_NPIREC</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ), ''<ENTITLEMENT_ID>AGS_Z0035_VAL_NPIREC</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>''+NPI_CODE ) FROM SAQIEN(NOLOCK) A JOIN (SELECT DISTINCT QUOTE_ID ,SERVICE_ID,EQUIPMENT_ID,REVISION_ID,NPI_CODE FROM SAQICO_INBOUND B(NOLOCK) JOIN "+str(CRMTMP)+" C ON B.EQUIPMENT_ID = C.EQUIPMENT_IDD WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND SERVICE_ID = ''Z0035'' ) B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID  = B.EQUIPMENT_ID AND A.QTEREV_ID = B.REVISION_ID  WHERE A.QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND A.QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"'' AND ISNULL(NPI_CODE,'''')<>''''  AND charindex( ''<ENTITLEMENT_ID>AGS_Z0035_VAL_NPIREC</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'',replace(replace(entitlement_xml,''	'',''''),''\n'','''')) >0 '")
							...
							primaryQueryItems = SqlHelper.GetFirst("sp_executesql @t=N'UPDATE A SET ENTITLEMENT_XML = REPLACE(entitlement_xml ,  substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0091_VAL_SCCCDF</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''</ENTITLEMENT_DISPLAY_VALUE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0091_VAL_SCCCDF</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ), replace(substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0091_VAL_SCCCDF</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''<ENTITLEMENT_DISPLAY_VALUE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0091_VAL_SCCCDF</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ),''select'','''') + ''<ENTITLEMENT_DISPLAY_VALUE>'' + TOOL_SERVICE_COMPLEXITY  ) FROM SAQIEN(NOLOCK) A JOIN (SELECT DISTINCT QUOTE_ID ,SERVICE_ID,EQUIPMENT_ID,REVISION_ID,TOOL_SERVICE_COMPLEXITY FROM SAQICO_INBOUND B(NOLOCK) JOIN "+str(CRMTMP)+" C ON B.EQUIPMENT_ID = C.EQUIPMENT_IDD WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND SERVICE_ID = ''Z0091'' ) B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID  = B.EQUIPMENT_ID AND A.QTEREV_ID = B.REVISION_ID  WHERE A.QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND A.QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"'' AND ISNULL(TOOL_SERVICE_COMPLEXITY,'''')<>'''' AND charindex( ''<ENTITLEMENT_ID>AGS_Z0091_VAL_SCCCDF</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'',replace(replace(entitlement_xml,''	'',''''),''\n'','''')) >0 '")
							
							#Z0092
							primaryQueryItems = SqlHelper.GetFirst("sp_executesql @t=N'UPDATE A SET ENTITLEMENT_XML = REPLACE(entitlement_xml ,  substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0092_VAL_SCCCDF</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''</ENTITLEMENT_VALUE_CODE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0092_VAL_SCCCDF</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ), ''<ENTITLEMENT_ID>AGS_Z0092_VAL_SCCCDF</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>''+SERVICE_COMPLEXITY_CODE ) FROM SAQIEN(NOLOCK) A JOIN (SELECT DISTINCT QUOTE_ID ,SERVICE_ID,EQUIPMENT_ID,REVISION_ID,SERVICE_COMPLEXITY_CODE FROM SAQICO_INBOUND B(NOLOCK) JOIN "+str(CRMTMP)+" C ON B.EQUIPMENT_ID = C.EQUIPMENT_IDD  WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND SERVICE_ID = ''Z0092'' )B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID  = B.EQUIPMENT_ID AND A.QTEREV_ID = B.REVISION_ID  WHERE A.QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND A.QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"'' AND ISNULL(SERVICE_COMPLEXITY_CODE,'''')<>'''' AND charindex( ''<ENTITLEMENT_ID>AGS_Z0092_VAL_SCCCDF</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'',replace(replace(entitlement_xml,''	'',''''),''\n'','''')) >0 '")
							
							primaryQueryItems = SqlHelper.GetFirst("sp_executesql @t=N'UPDATE A SET ENTITLEMENT_XML = REPLACE(entitlement_xml ,  substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0092_VAL_SCCCDF</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''</ENTITLEMENT_DISPLAY_VALUE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0092_VAL_SCCCDF</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ), replace(substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0092_VAL_SCCCDF</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''<ENTITLEMENT_DISPLAY_VALUE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0092_VAL_SCCCDF</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ),''select'','''') + ''<ENTITLEMENT_DISPLAY_VALUE>'' + TOOL_SERVICE_COMPLEXITY  ) FROM SAQIEN(NOLOCK) A JOIN (SELECT DISTINCT QUOTE_ID ,SERVICE_ID,EQUIPMENT_ID,REVISION_ID,TOOL_SERVICE_COMPLEXITY FROM SAQICO_INBOUND B(NOLOCK) JOIN "+str(CRMTMP)+" C ON B.EQUIPMENT_ID = C.EQUIPMENT_IDD WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND SERVICE_ID = ''Z0092'' ) B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID  = B.EQUIPMENT_ID AND A.QTEREV_ID = B.REVISION_ID  WHERE A.QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND A.QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"'' AND ISNULL(TOOL_SERVICE_COMPLEXITY,'''')<>'''' AND charindex( ''<ENTITLEMENT_ID>AGS_Z0092_VAL_SCCCDF</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'',replace(replace(entitlement_xml,''	'',''''),''\n'','''')) >0 '")
							...
							primaryQueryItems = SqlHelper.GetFirst("sp_executesql @t=N'UPDATE A SET ENTITLEMENT_XML = REPLACE(entitlement_xml ,  substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0004_VAL_SCCCDF</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''</ENTITLEMENT_DISPLAY_VALUE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0004_VAL_SCCCDF</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ), replace(substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0004_VAL_SCCCDF</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''<ENTITLEMENT_DISPLAY_VALUE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0004_VAL_SCCCDF</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ),''select'','''') +''<ENTITLEMENT_DISPLAY_VALUE>'' + TOOL_SERVICE_COMPLEXITY  ) FROM SAQIEN(NOLOCK) A JOIN (SELECT DISTINCT QUOTE_ID ,SERVICE_ID,EQUIPMENT_ID,REVISION_ID,TOOL_SERVICE_COMPLEXITY FROM SAQICO_INBOUND B(NOLOCK) JOIN "+str(CRMTMP)+" C ON B.EQUIPMENT_ID = C.EQUIPMENT_IDD WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND SERVICE_ID = ''Z0004'' ) B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID  = B.EQUIPMENT_ID AND A.QTEREV_ID = B.REVISION_ID  WHERE A.QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND A.QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"'' AND ISNULL(TOOL_SERVICE_COMPLEXITY,'''')<>'''' AND charindex( ''<ENTITLEMENT_ID>AGS_Z0004_VAL_SCCCDF</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'',replace(replace(entitlement_xml,''	'',''''),''\n'','''')) >0 '")
							...
							primaryQueryItems = SqlHelper.GetFirst(
												""
												+ str(Parameter1.QUERY_CRITERIA_1)
												+ "  SAQICO_INBOUND SET CAPITALAVOIDANCE_COEFFICIENT = CONVERT(VARCHAR,ENTITLEMENT_COEFFICIENT),CAPITAL_AVOIDANCE_CODE=ENTITLEMENT_VALUE_CODE FROM SAQICO_INBOUND (NOLOCK) A JOIN "+str(CRMTMP)+" C ON A.EQUIPMENT_ID = C.EQUIPMENT_IDD JOIN PRENVL B(NOLOCK) ON A.TOOL_CAPITAL_AVOIDANCE = B.ENTITLEMENT_DISPLAY_VALUE WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND ISNULL(TOOL_CAPITAL_AVOIDANCE,'''') <> '''' AND ENTITLEMENT_ID = ''AGS_Z0091_VAL_CAPAVD'' AND A.SERVICE_ID = ''Z0091'' ' ")
							
							#Z0092
							primaryQueryItems = SqlHelper.GetFirst(
												""
												+ str(Parameter1.QUERY_CRITERIA_1)
												+ "  SAQICO_INBOUND SET CAPITALAVOIDANCE_COEFFICIENT = CONVERT(VARCHAR,ENTITLEMENT_COEFFICIENT),CAPITAL_AVOIDANCE_CODE = ENTITLEMENT_VALUE_CODE FROM SAQICO_INBOUND (NOLOCK) A JOIN "+str(CRMTMP)+" C ON A.EQUIPMENT_ID = C.EQUIPMENT_IDD JOIN PRENVL B(NOLOCK) ON A.TOOL_CAPITAL_AVOIDANCE = B.ENTITLEMENT_DISPLAY_VALUE WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND ISNULL(TOOL_CAPITAL_AVOIDANCE,'''') <> '''' AND ENTITLEMENT_ID = ''AGS_Z0092_VAL_CAPAVD'' AND A.SERVICE_ID = ''Z0092'' ' ")
							
							#Z0004
							primaryQueryItems = SqlHelper.GetFirst(
												""
												+ str(Parameter1.QUERY_CRITERIA_1)
												+ "  SAQICO_INBOUND SET CAPITALAVOIDANCE_COEFFICIENT = CONVERT(VARCHAR,ENTITLEMENT_COEFFICIENT),CAPITAL_AVOIDANCE_CODE = ENTITLEMENT_VALUE_CODE FROM SAQICO_INBOUND (NOLOCK) A JOIN "+str(CRMTMP)+" C ON A.EQUIPMENT_ID = C.EQUIPMENT_IDD JOIN PRENVL B(NOLOCK) ON A.TOOL_CAPITAL_AVOIDANCE = B.ENTITLEMENT_DISPLAY_VALUE WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND ISNULL(TOOL_CAPITAL_AVOIDANCE,'''') <> '''' AND ENTITLEMENT_ID = ''AGS_Z0004_VAL_CAPAVD'' AND A.SERVICE_ID = ''Z0004'' ' ")
							
							#Z0099
							primaryQueryItems = SqlHelper.GetFirst(
												""
												+ str(Parameter1.QUERY_CRITERIA_1)
												+ "  SAQICO_INBOUND SET CAPITALAVOIDANCE_COEFFICIENT = CONVERT(VARCHAR,ENTITLEMENT_COEFFICIENT),CAPITAL_AVOIDANCE_CODE = ENTITLEMENT_VALUE_CODE FROM SAQICO_INBOUND (NOLOCK) A JOIN "+str(CRMTMP)+" C ON A.EQUIPMENT_ID = C.EQUIPMENT_IDD JOIN PRENVL B(NOLOCK) ON A.TOOL_CAPITAL_AVOIDANCE = B.ENTITLEMENT_DISPLAY_VALUE WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND ISNULL(TOOL_CAPITAL_AVOIDANCE,'''') <> '''' AND ENTITLEMENT_ID = ''AGS_Z0099_VAL_CAPAVD'' AND A.SERVICE_ID = ''Z0099'' ' ")
							
							#Z0035
							primaryQueryItems = SqlHelper.GetFirst(
												""
												+ str(Parameter1.QUERY_CRITERIA_1)
												+ "  SAQICO_INBOUND SET CAPITALAVOIDANCE_COEFFICIENT = CONVERT(VARCHAR,ENTITLEMENT_COEFFICIENT),CAPITAL_AVOIDANCE_CODE = ENTITLEMENT_VALUE_CODE FROM SAQICO_INBOUND (NOLOCK) A JOIN "+str(CRMTMP)+" C ON A.EQUIPMENT_ID = C.EQUIPMENT_IDD JOIN PRENVL B(NOLOCK) ON A.TOOL_CAPITAL_AVOIDANCE = B.ENTITLEMENT_DISPLAY_VALUE WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND ISNULL(TOOL_CAPITAL_AVOIDANCE,'''') <> '''' AND ENTITLEMENT_ID = ''AGS_Z0035_VAL_CAPAVD'' AND A.SERVICE_ID = ''Z0035'' ' ")
							...
							#Z0091
							primaryQueryItems = SqlHelper.GetFirst("sp_executesql @t=N'UPDATE A SET ENTITLEMENT_XML = REPLACE(entitlement_xml ,  substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0091_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''</ENTITLEMENT_VALUE_CODE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0091_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ), ''<ENTITLEMENT_ID>AGS_Z0091_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>''+CAPITAL_AVOIDANCE_CODE ) FROM SAQIEN(NOLOCK) A JOIN (SELECT DISTINCT QUOTE_ID ,SERVICE_ID,EQUIPMENT_ID,REVISION_ID,CAPITAL_AVOIDANCE_CODE FROM SAQICO_INBOUND B(NOLOCK) JOIN "+str(CRMTMP)+" C ON B.EQUIPMENT_ID = C.EQUIPMENT_IDD WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND B.SERVICE_ID = ''Z0091'') B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID  = B.EQUIPMENT_ID AND A.QTEREV_ID = B.REVISION_ID  WHERE A.QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND A.QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"'' AND ISNULL(CAPITAL_AVOIDANCE_CODE,'''')<>'''' AND charindex( ''<ENTITLEMENT_ID>AGS_Z0091_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'',replace(replace(entitlement_xml,''	'',''''),''\n'','''')) >0 '")
							
							primaryQueryItems = SqlHelper.GetFirst("sp_executesql @t=N'UPDATE A SET ENTITLEMENT_XML = REPLACE(entitlement_xml ,  substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0091_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''</ENTITLEMENT_DISPLAY_VALUE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0091_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ), replace(substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0091_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''<ENTITLEMENT_DISPLAY_VALUE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0091_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ),''select'','''') + ''<ENTITLEMENT_DISPLAY_VALUE>'' + TOOL_CAPITAL_AVOIDANCE  ) FROM SAQIEN(NOLOCK) A JOIN (SELECT DISTINCT QUOTE_ID ,SERVICE_ID,EQUIPMENT_ID,REVISION_ID,TOOL_CAPITAL_AVOIDANCE FROM SAQICO_INBOUND B(NOLOCK) JOIN "+str(CRMTMP)+" C ON B.EQUIPMENT_ID = C.EQUIPMENT_IDD WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND SERVICE_ID = ''Z0091'' ) B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID  = B.EQUIPMENT_ID AND A.QTEREV_ID = B.REVISION_ID  WHERE A.QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND A.QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"'' AND ISNULL(TOOL_CAPITAL_AVOIDANCE,'''')<>'''' AND charindex( ''<ENTITLEMENT_ID>AGS_Z0091_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'',replace(replace(entitlement_xml,''	'',''''),''\n'','''')) >0 '")
							
							#Z0092
							primaryQueryItems = SqlHelper.GetFirst("sp_executesql @t=N'UPDATE A SET ENTITLEMENT_XML = REPLACE(entitlement_xml ,  substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0092_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''</ENTITLEMENT_VALUE_CODE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0092_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ), ''<ENTITLEMENT_ID>AGS_Z0092_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>''+CAPITAL_AVOIDANCE_CODE ) FROM SAQIEN(NOLOCK) A JOIN (SELECT DISTINCT QUOTE_ID ,SERVICE_ID,EQUIPMENT_ID,REVISION_ID,CAPITAL_AVOIDANCE_CODE FROM SAQICO_INBOUND B(NOLOCK) JOIN "+str(CRMTMP)+" C ON B.EQUIPMENT_ID = C.EQUIPMENT_IDD WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND B.SERVICE_ID = ''Z0092'') B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID  = B.EQUIPMENT_ID AND A.QTEREV_ID = B.REVISION_ID  WHERE A.QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND A.QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"'' AND ISNULL(CAPITAL_AVOIDANCE_CODE,'''')<>'''' AND charindex( ''<ENTITLEMENT_ID>AGS_Z0092_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'',replace(replace(entitlement_xml,''	'',''''),''\n'','''')) >0 '")
							
							primaryQueryItems = SqlHelper.GetFirst("sp_executesql @t=N'UPDATE A SET ENTITLEMENT_XML = REPLACE(entitlement_xml ,  substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0092_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''</ENTITLEMENT_DISPLAY_VALUE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0092_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ), replace(substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0092_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''<ENTITLEMENT_DISPLAY_VALUE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0092_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ),''select'','''') + ''<ENTITLEMENT_DISPLAY_VALUE>'' + TOOL_CAPITAL_AVOIDANCE  ) FROM SAQIEN(NOLOCK) A JOIN (SELECT DISTINCT QUOTE_ID ,SERVICE_ID,EQUIPMENT_ID,REVISION_ID,TOOL_CAPITAL_AVOIDANCE FROM SAQICO_INBOUND B(NOLOCK) JOIN "+str(CRMTMP)+" C ON B.EQUIPMENT_ID = C.EQUIPMENT_IDD WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND SERVICE_ID = ''Z0092'' ) B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID  = B.EQUIPMENT_ID AND A.QTEREV_ID = B.REVISION_ID  WHERE A.QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND A.QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"'' AND ISNULL(TOOL_CAPITAL_AVOIDANCE,'''')<>'''' AND charindex( ''<ENTITLEMENT_ID>AGS_Z0092_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'',replace(replace(entitlement_xml,''	'',''''),''\n'','''')) >0 '")
							
							#Z0004
							primaryQueryItems = SqlHelper.GetFirst("sp_executesql @t=N'UPDATE A SET ENTITLEMENT_XML = REPLACE(entitlement_xml ,  substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0004_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''</ENTITLEMENT_VALUE_CODE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0004_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ), ''<ENTITLEMENT_ID>AGS_Z0004_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>''+CAPITAL_AVOIDANCE_CODE ) FROM SAQIEN(NOLOCK) A JOIN (SELECT DISTINCT QUOTE_ID ,SERVICE_ID,EQUIPMENT_ID,REVISION_ID,CAPITAL_AVOIDANCE_CODE FROM SAQICO_INBOUND B(NOLOCK) JOIN "+str(CRMTMP)+" C ON B.EQUIPMENT_ID = C.EQUIPMENT_IDD WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND B.SERVICE_ID = ''Z0004'') B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID  = B.EQUIPMENT_ID AND A.QTEREV_ID = B.REVISION_ID  WHERE A.QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND A.QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"'' AND ISNULL(CAPITAL_AVOIDANCE_CODE,'''')<>'''' AND charindex( ''<ENTITLEMENT_ID>AGS_Z0004_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'',replace(replace(entitlement_xml,''	'',''''),''\n'','''')) >0  '")
							
							primaryQueryItems = SqlHelper.GetFirst("sp_executesql @t=N'UPDATE A SET ENTITLEMENT_XML = REPLACE(entitlement_xml ,  substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0004_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''</ENTITLEMENT_DISPLAY_VALUE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0004_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ), replace(substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0004_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''<ENTITLEMENT_DISPLAY_VALUE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0004_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ),''select'','''') + ''<ENTITLEMENT_DISPLAY_VALUE>'' + TOOL_CAPITAL_AVOIDANCE  ) FROM SAQIEN(NOLOCK) A JOIN (SELECT DISTINCT QUOTE_ID ,SERVICE_ID,EQUIPMENT_ID,REVISION_ID,TOOL_CAPITAL_AVOIDANCE FROM SAQICO_INBOUND B(NOLOCK) JOIN "+str(CRMTMP)+" C ON B.EQUIPMENT_ID = C.EQUIPMENT_IDD WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND SERVICE_ID = ''Z0004'' ) B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID  = B.EQUIPMENT_ID AND A.QTEREV_ID = B.REVISION_ID  WHERE A.QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND A.QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"'' AND ISNULL(TOOL_CAPITAL_AVOIDANCE,'''')<>'''' AND charindex( ''<ENTITLEMENT_ID>AGS_Z0004_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'',replace(replace(entitlement_xml,''	'',''''),''\n'','''')) >0 '")
							
							#Z0099
							primaryQueryItems = SqlHelper.GetFirst("sp_executesql @t=N'UPDATE A SET ENTITLEMENT_XML = REPLACE(entitlement_xml ,  substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0099_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''</ENTITLEMENT_VALUE_CODE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0099_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ), ''<ENTITLEMENT_ID>AGS_Z0099_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>''+CAPITAL_AVOIDANCE_CODE ) FROM SAQIEN(NOLOCK) A JOIN (SELECT DISTINCT QUOTE_ID ,SERVICE_ID,EQUIPMENT_ID,REVISION_ID,CAPITAL_AVOIDANCE_CODE FROM SAQICO_INBOUND B(NOLOCK) JOIN "+str(CRMTMP)+" C ON B.EQUIPMENT_ID = C.EQUIPMENT_IDD WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND B.SERVICE_ID = ''Z0099'') B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID  = B.EQUIPMENT_ID AND A.QTEREV_ID = B.REVISION_ID  WHERE A.QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND A.QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"'' AND ISNULL(CAPITAL_AVOIDANCE_CODE,'''')<>'''' AND charindex( ''<ENTITLEMENT_ID>AGS_Z0099_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'',replace(replace(entitlement_xml,''	'',''''),''\n'','''')) >0 '")
							
							primaryQueryItems = SqlHelper.GetFirst("sp_executesql @t=N'UPDATE A SET ENTITLEMENT_XML = REPLACE(entitlement_xml ,  substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0099_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''</ENTITLEMENT_DISPLAY_VALUE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0099_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ), replace(substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0099_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''<ENTITLEMENT_DISPLAY_VALUE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0099_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ),''select'','''') + ''<ENTITLEMENT_DISPLAY_VALUE>'' + TOOL_CAPITAL_AVOIDANCE  ) FROM SAQIEN(NOLOCK) A JOIN (SELECT DISTINCT QUOTE_ID ,SERVICE_ID,EQUIPMENT_ID,REVISION_ID,TOOL_CAPITAL_AVOIDANCE FROM SAQICO_INBOUND B(NOLOCK) JOIN "+str(CRMTMP)+" C ON B.EQUIPMENT_ID = C.EQUIPMENT_IDD WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND SERVICE_ID = ''Z0099'' ) B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID  = B.EQUIPMENT_ID AND A.QTEREV_ID = B.REVISION_ID  WHERE A.QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND A.QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"'' AND ISNULL(TOOL_CAPITAL_AVOIDANCE,'''')<>'''' AND charindex( ''<ENTITLEMENT_ID>AGS_Z0099_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'',replace(replace(entitlement_xml,''	'',''''),''\n'','''')) >0 '")
							
							#Z0035
							primaryQueryItems = SqlHelper.GetFirst("sp_executesql @t=N'UPDATE A SET ENTITLEMENT_XML = REPLACE(entitlement_xml ,  substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0035_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''</ENTITLEMENT_VALUE_CODE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0035_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ), ''<ENTITLEMENT_ID>AGS_Z0035_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>''+CAPITAL_AVOIDANCE_CODE ) FROM SAQIEN(NOLOCK) A JOIN (SELECT DISTINCT QUOTE_ID ,SERVICE_ID,EQUIPMENT_ID,REVISION_ID,CAPITAL_AVOIDANCE_CODE FROM SAQICO_INBOUND B(NOLOCK) JOIN "+str(CRMTMP)+" C ON B.EQUIPMENT_ID = C.EQUIPMENT_IDD WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND B.SERVICE_ID = ''Z0035'') B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID  = B.EQUIPMENT_ID AND A.QTEREV_ID = B.REVISION_ID  WHERE A.QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND A.QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"'' AND ISNULL(CAPITAL_AVOIDANCE_CODE,'''')<>'''' AND charindex( ''<ENTITLEMENT_ID>AGS_Z0035_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'',replace(replace(entitlement_xml,''	'',''''),''\n'','''')) >0 '")
							
							primaryQueryItems = SqlHelper.GetFirst("sp_executesql @t=N'UPDATE A SET ENTITLEMENT_XML = REPLACE(entitlement_xml ,  substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0035_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''</ENTITLEMENT_DISPLAY_VALUE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0035_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ), replace(substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0035_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''<ENTITLEMENT_DISPLAY_VALUE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0035_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ),''select'','''') +''<ENTITLEMENT_DISPLAY_VALUE>'' + TOOL_CAPITAL_AVOIDANCE  ) FROM SAQIEN(NOLOCK) A JOIN (SELECT DISTINCT QUOTE_ID ,SERVICE_ID,EQUIPMENT_ID,REVISION_ID,TOOL_CAPITAL_AVOIDANCE FROM SAQICO_INBOUND B(NOLOCK) JOIN "+str(CRMTMP)+" C ON B.EQUIPMENT_ID = C.EQUIPMENT_IDD WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND SERVICE_ID = ''Z0035'' ) B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID  = B.EQUIPMENT_ID AND A.QTEREV_ID = B.REVISION_ID  WHERE A.QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND A.QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"'' AND ISNULL(TOOL_CAPITAL_AVOIDANCE,'''')<>'''' AND charindex( ''<ENTITLEMENT_ID>AGS_Z0035_VAL_CAPAVD</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'',replace(replace(entitlement_xml,''	'',''''),''\n'','''')) >0 '")
							...
							#Z0091
							primaryQueryItems = SqlHelper.GetFirst("sp_executesql @t=N'UPDATE A SET ENTITLEMENT_XML = REPLACE(entitlement_xml ,  substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0091_VAL_CAPACO</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml),charindex(''</ENTITLEMENT_VALUE_CODE>''  ,substring(entitlement_xml,charindex(''<ENTITLEMENT_ID>AGS_Z0091_VAL_CAPACO</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'' ,entitlement_xml) , 1000 ))-1  ), ''<ENTITLEMENT_ID>AGS_Z0091_VAL_CAPACO</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>''+CAPITALAVOIDANCE_COEFFICIENT ) FROM SAQIEN(NOLOCK) A JOIN (SELECT DISTINCT QUOTE_ID ,SERVICE_ID,EQUIPMENT_ID,REVISION_ID,CAPITALAVOIDANCE_COEFFICIENT FROM SAQICO_INBOUND B(NOLOCK) JOIN "+str(CRMTMP)+" C ON B.EQUIPMENT_ID = C.EQUIPMENT_IDD WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"' AND B.SERVICE_ID = ''Z0091'' )B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID  = B.EQUIPMENT_ID AND A.QTEREV_ID = B.REVISION_ID  WHERE A.QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND A.QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"''  AND ISNULL(CAPITALAVOIDANCE_COEFFICIENT,'''')<>'''' AND charindex( ''<ENTITLEMENT_ID>AGS_Z0091_VAL_CAPACO</ENTITLEMENT_ID><ENTITLEMENT_VALUE_CODE>'',replace(replace(entitlement_xml,''	'',''''),''\n'','''')) >0 '")
					...
					primaryQueryItems = SqlHelper.GetFirst(
						""
						+ str(Parameter1.QUERY_CRITERIA_1)
						+ "  A SET TARGET_PRICE = ROUND( (TARGET_PRICE * ISNULL(EXCHANGE_RATE,1)) ,CONVERT(INT,"+str(roundcurr.DECIMAL_PLACES)+"),CONVERT(INT,"+str(roundcurr.ROUNDING_METHOD)+")), SALES_DISCOUNT_PRICE = ROUND( (SALES_DISCOUNT_PRICE * ISNULL(EXCHANGE_RATE,1)) ,CONVERT(INT,"+str(roundcurr.DECIMAL_PLACES)+"),CONVERT(INT,"+str(roundcurr.ROUNDING_METHOD)+")), BD_PRICE = ROUND( (BD_PRICE * ISNULL(EXCHANGE_RATE,1)) ,CONVERT(INT,"+str(roundcurr.DECIMAL_PLACES)+"),CONVERT(INT,"+str(roundcurr.ROUNDING_METHOD)+")), CEILING_PRICE = ROUND( (CEILING_PRICE * ISNULL(EXCHANGE_RATE,1)) ,CONVERT(INT,"+str(roundcurr.DECIMAL_PLACES)+"),CONVERT(INT,"+str(roundcurr.ROUNDING_METHOD)+")),MODEL_PRICE = ROUND( (MODEL_PRICE * ISNULL(EXCHANGE_RATE,1)) ,CONVERT(INT,"+str(roundcurr.DECIMAL_PLACES)+"),CONVERT(INT,"+str(roundcurr.ROUNDING_METHOD)+")),TARGET_PRICE_INGL_CURR = ROUND( (TARGET_PRICE_INGL_CURR) ,CONVERT(INT,"+str(roundcurr.DECIMAL_PLACES)+"),CONVERT(INT,"+str(roundcurr.ROUNDING_METHOD)+")), SLSDIS_PRICE_INGL_CURR = ROUND( (SLSDIS_PRICE_INGL_CURR) ,CONVERT(INT,"+str(roundcurr.DECIMAL_PLACES)+"),CONVERT(INT,"+str(roundcurr.ROUNDING_METHOD)+")), BD_PRICE_INGL_CURR = ROUND( (BD_PRICE_INGL_CURR) ,CONVERT(INT,"+str(roundcurr.DECIMAL_PLACES)+"),CONVERT(INT,"+str(roundcurr.ROUNDING_METHOD)+")), CEILING_PRICE_INGL_CURR = ROUND( (CEILING_PRICE_INGL_CURR) ,CONVERT(INT,"+str(roundcurr.DECIMAL_PLACES)+"),CONVERT(INT,"+str(roundcurr.ROUNDING_METHOD)+")),MODEL_PRICE_INGL_CURR = ROUND( (MODEL_PRICE_INGL_CURR) ,CONVERT(INT,"+str(roundcurr.DECIMAL_PLACES)+"),CONVERT(INT,"+str(roundcurr.ROUNDING_METHOD)+"))  FROM SAQICO (NOLOCK)A JOIN (SELECT DISTINCT QUOTE_ID,SERVICE_ID,EQUIPMENT_ID,REVISION_ID FROM SAQICO_INBOUND(NOLOCK)  WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"')B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID = B.EQUIPMENT_ID AND QTEREV_ID = REVISION_ID ' ")
					...
					primaryQueryItems = SqlHelper.GetFirst(
						""
						+ str(Parameter1.QUERY_CRITERIA_1)
						+ "  A SET SALES_PRICE = TARGET_PRICE - (TARGET_PRICE * (ISNULL(DISCOUNT,0)/100)),SALES_PRICE_INGL_CURR = TARGET_PRICE_INGL_CURR - (TARGET_PRICE_INGL_CURR * (ISNULL(DISCOUNT,0)/100))   FROM SAQICO (NOLOCK)A JOIN (SELECT DISTINCT  QUOTE_ID,SERVICE_ID,EQUIPMENT_ID,REVISION_ID FROM SAQICO_INBOUND(NOLOCK)  WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"')B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID = B.EQUIPMENT_ID AND QTEREV_ID = REVISION_ID  ' ")
					...
					primaryQueryItems = SqlHelper.GetFirst(
						""
						+ str(Parameter1.QUERY_CRITERIA_1)
						+ "  A SET TOTAL_AMOUNT = ISNULL(SALES_PRICE,0),TOTAL_AMOUNT_INGL_CURR = ISNULL(SALES_PRICE_INGL_CURR,0)   FROM SAQICO (NOLOCK)A JOIN (SELECT DISTINCT QUOTE_ID,SERVICE_ID,EQUIPMENT_ID,REVISION_ID FROM SAQICO_INBOUND(NOLOCK)  WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"')B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID = B.EQUIPMENT_ID  AND QTEREV_ID = REVISION_ID ' ")
						
					#Tax
					primaryQueryItems = SqlHelper.GetFirst(
						""
						+ str(Parameter1.QUERY_CRITERIA_1)
						+ "  A SET TAX_AMOUNT = ( (ISNULL(SALES_PRICE,0) ) * (TAX_PERCENTAGE/100)) , TAX_AMOUNT_INGL_CURR = ( (ISNULL(SALES_PRICE_INGL_CURR,0) ) * (TAX_PERCENTAGE/100))  FROM SAQICO (NOLOCK)A JOIN (SELECT  DISTINCT QUOTE_ID,SERVICE_ID,EQUIPMENT_ID,REVISION_ID FROM SAQICO_INBOUND(NOLOCK)  WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"')B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID = B.EQUIPMENT_ID AND QTEREV_ID = REVISION_ID WHERE TAX_AMOUNT IS NULL  ' ")
					
					#Extended Price
					primaryQueryItems = SqlHelper.GetFirst(
						""
						+ str(Parameter1.QUERY_CRITERIA_1)
						+ "  A SET NET_PRICE = ISNULL(TOTAL_AMOUNT,0) + ISNULL(TAX_AMOUNT,0), NET_PRICE_INGL_CURR = ISNULL(TOTAL_AMOUNT_INGL_CURR,0) + ISNULL(TAX_AMOUNT_INGL_CURR,0) FROM SAQICO (NOLOCK)A JOIN (SELECT  DISTINCT QUOTE_ID,SERVICE_ID,EQUIPMENT_ID,REVISION_ID FROM SAQICO_INBOUND(NOLOCK)  WHERE ISNULL(PROCESS_STATUS,'''')=''INPROGRESS'' AND TIMESTAMP = '"+str(timestamp_sessionid)+"')B ON A.QUOTE_ID = B.QUOTE_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.EQUIPMENT_ID = B.EQUIPMENT_ID AND QTEREV_ID = REVISION_ID WHERE TAX_AMOUNT IS NULL  ' ")
					...
					""
					+ str(Parameter1.QUERY_CRITERIA_1)
					+ "  SAQITM SET BD_PRICE = SUB_SAQITM.BD_PRICE,CEILING_PRICE = SUB_SAQITM.CEILING_PRICE,NET_PRICE = SUB_SAQITM.NET_PRICE,SALES_DISCOUNT_PRICE = SUB_SAQITM.SALES_DISCOUNT_PRICE,TARGET_PRICE = SUB_SAQITM.TARGET_PRICE,TAX_AMOUNT = ROUND((SUB_SAQITM.SALES_PRICE * (ISNULL(SAQITM.TAX_PERCENTAGE,0)/100)),CONVERT(INT,"+str(roundcurr.DECIMAL_PLACES)+"),CONVERT(INT,"+str(roundcurr.ROUNDING_METHOD)+")) , TAX_AMOUNT_INGL_CURR = ROUND((SUB_SAQITM.SALES_PRICE_INGL_CURR * (ISNULL(SAQITM.TAX_PERCENTAGE,0)/100)),CONVERT(INT,"+str(roundcurr.DECIMAL_PLACES)+"),CONVERT(INT,"+str(roundcurr.ROUNDING_METHOD)+")) , BD_PRICE_INGL_CURR = SUB_SAQITM.BD_PRICE_INGL_CURR,TARGET_PRICE_INGL_CURR = SUB_SAQITM.TARGET_PRICE_INGL_CURR,SLSDIS_PRICE_INGL_CURR = SUB_SAQITM.SLSDIS_PRICE_INGL_CURR,CEILING_PRICE_INGL_CURR = SUB_SAQITM.CEILING_PRICE_INGL_CURR,NET_PRICE_INGL_CURR = SUB_SAQITM.NET_PRICE_INGL_CURR,TOTAL_AMOUNT=SUB_SAQITM.TOTAL_AMOUNT,SALES_PRICE = SUB_SAQITM.SALES_PRICE,SALES_PRICE_INGL_CURR = SUB_SAQITM.SALES_PRICE_INGL_CURR,TOTAL_AMOUNT_INGL_CURR = SUB_SAQITM.TOTAL_AMOUNT_INGL_CURR FROM SAQRIT SAQITM(NOLOCK) JOIN(SELECT SUM(SAQICO.BD_PRICE) AS BD_PRICE,SUM(SAQICO.CEILING_PRICE) AS CEILING_PRICE,SUM(SAQICO.NET_PRICE) AS NET_PRICE,SUM(SAQICO.SALES_DISCOUNT_PRICE) AS SALES_DISCOUNT_PRICE,SUM(SAQICO.TOTAL_AMOUNT) AS TOTAL_AMOUNT,SUM(SAQICO.TARGET_PRICE) AS TARGET_PRICE,SUM(SAQICO.TAX_AMOUNT) AS TAX_AMOUNT,SAQICO.QUOTE_ID,SAQICO.SERVICE_RECORD_ID,SUM(BD_PRICE_INGL_CURR) AS BD_PRICE_INGL_CURR,SUM(TARGET_PRICE_INGL_CURR) AS TARGET_PRICE_INGL_CURR,SUM(SLSDIS_PRICE_INGL_CURR) AS SLSDIS_PRICE_INGL_CURR,SUM(CEILING_PRICE_INGL_CURR) AS CEILING_PRICE_INGL_CURR,SUM(NET_PRICE_INGL_CURR) AS NET_PRICE_INGL_CURR,SUM(TOTAL_AMOUNT_INGL_CURR) AS TOTAL_AMOUNT_INGL_CURR,SAQICO.QTEREV_ID,LINE,SUM(SALES_PRICE) AS SALES_PRICE,SUM(SALES_PRICE_INGL_CURR) AS SALES_PRICE_INGL_CURR FROM SAQICO (NOLOCK) WHERE QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"'' GROUP BY SAQICO.QUOTE_ID,SAQICO.SERVICE_RECORD_ID,SAQICO.QTEREV_ID,SAQICO.LINE) SUB_SAQITM  ON SAQITM.QUOTE_ID = SUB_SAQITM.QUOTE_ID AND SAQITM.SERVICE_RECORD_ID = SUB_SAQITM.SERVICE_RECORD_ID AND SUB_SAQITM.QTEREV_ID = SAQITM.QTEREV_ID  AND SAQITM.LINE = SUB_SAQITM.LINE ' ")
					...
					primaryQueryItems = SqlHelper.GetFirst(
						""
					+ str(Parameter1.QUERY_CRITERIA_1)
					+ "  SAQITM SET STATUS=''PRICED'' FROM SAQRIT SAQITM (NOLOCK) WHERE QUOTE_REVISION_CONTRACT_ITEM_ID NOT IN (SELECT QTEITM_RECORD_ID FROM SAQICO B(NOLOCK) WHERE QUOTE_ID = ''"+str(Qt_Id.QUOTE_ID)+"'' AND QTEREV_ID = ''"+str(Qt_Id.REVISION_ID)+"'' AND STATUS IN (''PARTIALLY PRICED'',''ERROR'',''ASSEMBLY IS MISSING'')) AND PRICING_STATUS NOT IN (''ON HOLD - COSTING'',''ON HOLD - PRICING'',''ACQUIRING'',''PARTIALLY PRICED'',''ERROR'',''ASSEMBLY IS MISSING'') '")
