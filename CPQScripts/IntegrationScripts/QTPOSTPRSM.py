	...
	for crmifno in input_data:	
		...
		if str(table).upper() != "NONE" and str(type(table.RESULT)) == "<type 'str'>":
			...
			if "Status: 400" in  crm_response:
				...
				mailClient.Send(msg)
		if Flag == "True":
			Log.Info('crm_response--'+str(crm_response))
