		...
		while Check_flag1 == 1:
			...
			if str(primaryQueryItems) != "None":
				...
				primaryQueryItems = SqlHelper.GetFirst(
					""
					+ str(Parameter.QUERY_CRITERIA_1)
					+ " MAEQUP SET VALDRV_WAFERNODE = ''Advanced'' FROM MAEQUP_INBOUND(NOLOCK) JOIN TEMP_PROCESS_EQUP(NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = TEMP_PROCESS_EQUP.SESSION_ID  JOIN MAEQUP (NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = MAEQUP.EQUIPMENT_ID WHERE MAEQUP_INBOUND.TIMESTAMP='"+ str(timestamp_sessionid)+ "'  AND ISNULL(MAEQUP_INBOUND.INTEGRATION_STATUS,'''') ='''' AND ISNULL(MAEQUP_INBOUND.PROCESS_STATUS,'''')=''READY FOR UPLOAD'' AND ISNULL(TEMP_PROCESS_EQUP.PROCESS_STATUS,'''')='''' AND GENERATION IN (''GEN 7'', ''GEN 7.5'', ''GEN 8'', ''GEN 8F'', ''GEN 8.5'', ''GEN 8.5S'', ''GEN 8.5H'', ''GEN 8.6'', ''GEN 8.7'') AND TECHNOLOGY IN (''TFE'', ''TSP'', ''ALD'', ''METAL OXIDE'', ''HDP'') AND END_PRODUCT_TECHNOLOGY IN (''OLED Rigid'', ''OLED Flexible'', ''QLED'', ''microLED'', ''Others'') AND MAEQUP.GREENBOOK=''DISPLAY'' '" )

				primaryQueryItems = SqlHelper.GetFirst(
									""
									+ str(Parameter.QUERY_CRITERIA_1)
									+ " MAEQUP SET VALDRV_WAFERNODE = ''Advanced'' FROM MAEQUP_INBOUND(NOLOCK) JOIN TEMP_PROCESS_EQUP(NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = TEMP_PROCESS_EQUP.SESSION_ID  JOIN MAEQUP (NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = MAEQUP.EQUIPMENT_ID WHERE MAEQUP_INBOUND.TIMESTAMP='"+ str(timestamp_sessionid)+ "'  AND ISNULL(MAEQUP_INBOUND.INTEGRATION_STATUS,'''') ='''' AND ISNULL(MAEQUP_INBOUND.PROCESS_STATUS,'''')=''READY FOR UPLOAD'' AND ISNULL(TEMP_PROCESS_EQUP.PROCESS_STATUS,'''')='''' AND GENERATION IN (''GEN 10'', ''GEN 10.5'', ''GEN 11'') AND TECHNOLOGY IN (''ALD'', ''TSP'', ''HDP'') AND END_PRODUCT_TECHNOLOGY IN (''OLED Rigid'', ''OLED Flexible'', ''QLED'', ''microLED'', ''Others'') AND MAEQUP.GREENBOOK=''DISPLAY'' '" )

				primaryQueryItems = SqlHelper.GetFirst(
									""
									+ str(Parameter.QUERY_CRITERIA_1)
									+ " MAEQUP SET VALDRV_WAFERNODE = ''Advanced'' FROM MAEQUP_INBOUND(NOLOCK) JOIN TEMP_PROCESS_EQUP(NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = TEMP_PROCESS_EQUP.SESSION_ID  JOIN MAEQUP (NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = MAEQUP.EQUIPMENT_ID WHERE MAEQUP_INBOUND.TIMESTAMP='"+ str(timestamp_sessionid)+ "'  AND ISNULL(MAEQUP_INBOUND.INTEGRATION_STATUS,'''') ='''' AND ISNULL(MAEQUP_INBOUND.PROCESS_STATUS,'''')=''READY FOR UPLOAD'' AND ISNULL(TEMP_PROCESS_EQUP.PROCESS_STATUS,'''')='''' AND GENERATION IN (''GEN 2'', ''GEN 2F'', ''GEN 3'', ''GEN 3.5'', ''GEN 3.5F'', ''GEN 4'', ''GEN 4H'', ''GEN 4F'', ''GEN 4.5'', ''GEN 4.5H'', ''GEN 4.5F'', ''GEN 4.5Q'', ''GEN 5'', ''GEN 5.5'', ''GEN 5.5F'', ''GEN 5.5Q'', ''GEN 6'', ''GEN 6H'', ''GEN 6H-P'') AND TECHNOLOGY IN (''DIGITAL LITHOGRAPHY'') AND END_PRODUCT_TECHNOLOGY IN (''OLED Rigid'', ''OLED Flexible'', ''QLED'', ''microLED'', ''Others'') AND MAEQUP.GREENBOOK=''DISPLAY'' '" )

				primaryQueryItems = SqlHelper.GetFirst(
									""
									+ str(Parameter.QUERY_CRITERIA_1)
									+ " MAEQUP SET VALDRV_WAFERNODE = ''Mature'' FROM MAEQUP_INBOUND(NOLOCK) JOIN TEMP_PROCESS_EQUP(NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = TEMP_PROCESS_EQUP.SESSION_ID  JOIN MAEQUP (NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = MAEQUP.EQUIPMENT_ID WHERE MAEQUP_INBOUND.TIMESTAMP='"+ str(timestamp_sessionid)+ "'  AND ISNULL(MAEQUP_INBOUND.INTEGRATION_STATUS,'''') ='''' AND ISNULL(MAEQUP_INBOUND.PROCESS_STATUS,'''')=''READY FOR UPLOAD'' AND ISNULL(TEMP_PROCESS_EQUP.PROCESS_STATUS,'''')='''' AND GENERATION IN (''GEN 10'', ''GEN 10.5'', ''GEN 11'') AND TECHNOLOGY IN (''SOLAR'', ''ARRAY'', ''A-SI'', ''LTPS'', ''METAL OXIDE'', ''NEW ARISTO'', ''SPUTTERING'') AND END_PRODUCT_TECHNOLOGY IN (''LCD+OLED'', ''OLED Rigid'', ''OLED Flexible'', ''Solar'', ''Touch Panel'', ''Others'') AND MAEQUP.GREENBOOK=''DISPLAY''  '" )
									
				primaryQueryItems = SqlHelper.GetFirst(
									""
									+ str(Parameter.QUERY_CRITERIA_1)
									+ " MAEQUP SET VALDRV_WAFERNODE = ''Mature'' FROM MAEQUP_INBOUND(NOLOCK) JOIN TEMP_PROCESS_EQUP(NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = TEMP_PROCESS_EQUP.SESSION_ID  JOIN MAEQUP (NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = MAEQUP.EQUIPMENT_ID WHERE MAEQUP_INBOUND.TIMESTAMP='"+ str(timestamp_sessionid)+ "'  AND ISNULL(MAEQUP_INBOUND.INTEGRATION_STATUS,'''') ='''' AND ISNULL(MAEQUP_INBOUND.PROCESS_STATUS,'''')=''READY FOR UPLOAD'' AND ISNULL(TEMP_PROCESS_EQUP.PROCESS_STATUS,'''')='''' AND GENERATION IN (''GEN 5.5'', ''GEN 5.5F'', ''GEN 5.5Q'', ''GEN 6'', ''GEN 6H'', ''GEN 6H-P'', ''GEN 8.5'', ''GEN 8.5S'', ''GEN 8.5H'', ''GEN 8.6'', ''GEN 8.7'') AND TECHNOLOGY IN (''LTPS'', ''SOLAR'', ''SPUTTERING'', ''NEW ARISTO'', ''HYBRID'') AND END_PRODUCT_TECHNOLOGY IN (''LCD+OLED'', ''OLED Rigid'', ''OLED Flexible'', ''Solar'', ''Touch Panel'', ''Others'') AND MAEQUP.GREENBOOK=''DISPLAY'' '" )
									
				primaryQueryItems = SqlHelper.GetFirst(
									""
									+ str(Parameter.QUERY_CRITERIA_1)
									+ " MAEQUP SET VALDRV_WAFERNODE = ''Mature'' FROM MAEQUP_INBOUND(NOLOCK) JOIN TEMP_PROCESS_EQUP(NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = TEMP_PROCESS_EQUP.SESSION_ID  JOIN MAEQUP (NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = MAEQUP.EQUIPMENT_ID WHERE MAEQUP_INBOUND.TIMESTAMP='"+ str(timestamp_sessionid)+ "'  AND ISNULL(MAEQUP_INBOUND.INTEGRATION_STATUS,'''') ='''' AND ISNULL(MAEQUP_INBOUND.PROCESS_STATUS,'''')=''READY FOR UPLOAD'' AND ISNULL(TEMP_PROCESS_EQUP.PROCESS_STATUS,'''')='''' AND GENERATION IN (''GEN 2'', ''GEN 2F'', ''GEN 3'', ''GEN 3.5'', ''GEN 3.5F'', ''GEN 4'', ''GEN 4H'', ''GEN 4F'', ''GEN 4.5'', ''GEN 4.5H'', ''GEN 4.5F'', ''GEN 4.5Q'', ''GEN 5'', ''GEN 5.5'', ''GEN 5.5F'', ''GEN 5.5Q'', ''GEN 6'', ''GEN 6H'', ''GEN 6H-P'') AND TECHNOLOGY IN (''TFE'', ''TSP'', ''ALD'', ''METAL OXIDE'', ''HDP'', ''HYBRID'') AND END_PRODUCT_TECHNOLOGY IN (''LCD+OLED'', ''OLED Rigid'', ''OLED Flexible'', ''Solar'', ''Touch Panel'', ''Others'') AND MAEQUP.GREENBOOK=''DISPLAY'' '" )
									
				primaryQueryItems = SqlHelper.GetFirst(
									""
									+ str(Parameter.QUERY_CRITERIA_1)
									+ " MAEQUP SET VALDRV_WAFERNODE = ''Mature'' FROM MAEQUP_INBOUND(NOLOCK) JOIN TEMP_PROCESS_EQUP(NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = TEMP_PROCESS_EQUP.SESSION_ID  JOIN MAEQUP (NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = MAEQUP.EQUIPMENT_ID WHERE MAEQUP_INBOUND.TIMESTAMP='"+ str(timestamp_sessionid)+ "'  AND ISNULL(MAEQUP_INBOUND.INTEGRATION_STATUS,'''') ='''' AND ISNULL(MAEQUP_INBOUND.PROCESS_STATUS,'''')=''READY FOR UPLOAD'' AND ISNULL(TEMP_PROCESS_EQUP.PROCESS_STATUS,'''')='''' AND GENERATION IN (''GEN 2'', ''GEN 2F'', ''GEN 3'', ''GEN 3.5'', ''GEN 3.5F'', ''GEN 4'', ''GEN 4H'', ''GEN 4F'', ''GEN 4.5'', ''GEN 4.5H'', ''GEN 4.5F'', ''GEN 4.5Q'', ''GEN 5'', ''GEN 5.5'', ''GEN 5.5F'', ''GEN 5.5Q'', ''GEN 6'', ''GEN 6H'', ''GEN 6H-P'', ''GEN 7'', ''GEN 7.5'',''GEN 8'', ''GEN 8F'', ''GEN 8.5'', ''GEN 8.5S'', ''GEN 8.5H'', ''GEN 8.6'', ''GEN 8.7'', ''GEN 10'', ''GEN 10.5'', ''GEN 11'') AND TECHNOLOGY IN (''EBT'', ''EBR'') AND END_PRODUCT_TECHNOLOGY IN (''LCD+OLED'', ''OLED Rigid'', ''OLED Flexible'', ''Solar'', ''Touch Panel'', ''Others'') AND MAEQUP.GREENBOOK=''DISPLAY'' '" )

				primaryQueryItems = SqlHelper.GetFirst(
									""
									+ str(Parameter.QUERY_CRITERIA_1)
									+ " MAEQUP SET VALDRV_WAFERNODE = ''Legacy'' FROM MAEQUP_INBOUND(NOLOCK) JOIN TEMP_PROCESS_EQUP(NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = TEMP_PROCESS_EQUP.SESSION_ID  JOIN MAEQUP (NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = MAEQUP.EQUIPMENT_ID WHERE MAEQUP_INBOUND.TIMESTAMP='"+ str(timestamp_sessionid)+ "'  AND ISNULL(MAEQUP_INBOUND.INTEGRATION_STATUS,'''') ='''' AND ISNULL(MAEQUP_INBOUND.PROCESS_STATUS,'''')=''READY FOR UPLOAD'' AND ISNULL(TEMP_PROCESS_EQUP.PROCESS_STATUS,'''')='''' AND ISNULL(GENERATION,'''') <> ''''  AND ISNULL(TECHNOLOGY,'''') <>'''' AND ISNULL(END_PRODUCT_TECHNOLOGY,'''')<>''''  AND ISNULL(VALDRV_WAFERNODE,'''')='''' AND MAEQUP.GREENBOOK=''DISPLAY'' '" )

				primaryQueryItems = SqlHelper.GetFirst(
									""
									+ str(Parameter.QUERY_CRITERIA_1)
									+ " MAEQUP SET VALDRV_WAFERNODE = ''Legacy'' FROM MAEQUP_INBOUND(NOLOCK) JOIN TEMP_PROCESS_EQUP(NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = TEMP_PROCESS_EQUP.SESSION_ID  JOIN MAEQUP (NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = MAEQUP.EQUIPMENT_ID WHERE MAEQUP_INBOUND.TIMESTAMP='"+ str(timestamp_sessionid)+ "'  AND ISNULL(MAEQUP_INBOUND.INTEGRATION_STATUS,'''') ='''' AND ISNULL(MAEQUP_INBOUND.PROCESS_STATUS,'''')=''READY FOR UPLOAD'' AND ISNULL(TEMP_PROCESS_EQUP.PROCESS_STATUS,'''')='''' AND ISNULL(SUBSTRATE_SIZE,'''') = ''200mm''  AND MAEQUP.GREENBOOK NOT IN (''DISPLAY'',''PPC'') '" )

				primaryQueryItems = SqlHelper.GetFirst(
									""
									+ str(Parameter.QUERY_CRITERIA_1)
									+ " MAEQUP SET VALDRV_WAFERNODE = ''Legacy'' FROM MAEQUP_INBOUND(NOLOCK) JOIN TEMP_PROCESS_EQUP(NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = TEMP_PROCESS_EQUP.SESSION_ID  JOIN MAEQUP (NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = MAEQUP.EQUIPMENT_ID WHERE MAEQUP_INBOUND.TIMESTAMP='"+ str(timestamp_sessionid)+ "'  AND ISNULL(MAEQUP_INBOUND.INTEGRATION_STATUS,'''') ='''' AND ISNULL(MAEQUP_INBOUND.PROCESS_STATUS,'''')=''READY FOR UPLOAD'' AND ISNULL(TEMP_PROCESS_EQUP.PROCESS_STATUS,'''')='''' AND ISNULL(SUBSTRATE_SIZE,'''') = ''300mm'' AND TECHNOLOGY_NODE IN( ''≥ 28NM'',''≥4X'',''NOR'',''EQUIP/MATL'',''MPS'',''PACKAGING'',''WFR MFG'',''G&W'',''SOLAR'',''PCM'',''Other'')  AND MAEQUP.GREENBOOK NOT IN (''DISPLAY'',''PPC'') '" )

				primaryQueryItems = SqlHelper.GetFirst(
									""
									+ str(Parameter.QUERY_CRITERIA_1)
									+ " MAEQUP SET VALDRV_WAFERNODE = ''Mature'' FROM MAEQUP_INBOUND(NOLOCK) JOIN TEMP_PROCESS_EQUP(NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = TEMP_PROCESS_EQUP.SESSION_ID  JOIN MAEQUP (NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = MAEQUP.EQUIPMENT_ID WHERE MAEQUP_INBOUND.TIMESTAMP='"+ str(timestamp_sessionid)+ "'  AND ISNULL(MAEQUP_INBOUND.INTEGRATION_STATUS,'''') ='''' AND ISNULL(MAEQUP_INBOUND.PROCESS_STATUS,'''')=''READY FOR UPLOAD'' AND ISNULL(TEMP_PROCESS_EQUP.PROCESS_STATUS,'''')='''' AND ISNULL(SUBSTRATE_SIZE,'''') IN (''300mm'',''10nm'') AND TECHNOLOGY_NODE IN( ''<28NM'')  AND MAEQUP.GREENBOOK NOT IN (''DISPLAY'',''PPC'') '" )

				primaryQueryItems = SqlHelper.GetFirst(
									""
									+ str(Parameter.QUERY_CRITERIA_1)
									+ " MAEQUP SET VALDRV_WAFERNODE = ''Mature'' FROM MAEQUP_INBOUND(NOLOCK) JOIN TEMP_PROCESS_EQUP(NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = TEMP_PROCESS_EQUP.SESSION_ID  JOIN MAEQUP (NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = MAEQUP.EQUIPMENT_ID WHERE MAEQUP_INBOUND.TIMESTAMP='"+ str(timestamp_sessionid)+ "'  AND ISNULL(MAEQUP_INBOUND.INTEGRATION_STATUS,'''') ='''' AND ISNULL(MAEQUP_INBOUND.PROCESS_STATUS,'''')=''READY FOR UPLOAD'' AND ISNULL(TEMP_PROCESS_EQUP.PROCESS_STATUS,'''')='''' AND ISNULL(SUBSTRATE_SIZE,'''') IN (''300mm'') AND TECHNOLOGY_NODE IN( ''2X'',''2Y'',''2Z'',''3D 48P'',''3D 64P'',''3D 96P'')  AND MAEQUP.GREENBOOK NOT IN (''DISPLAY'',''PPC'') '" )

				primaryQueryItems = SqlHelper.GetFirst(
									""
									+ str(Parameter.QUERY_CRITERIA_1)
									+ " MAEQUP SET VALDRV_WAFERNODE = ''Advanced'' FROM MAEQUP_INBOUND(NOLOCK) JOIN TEMP_PROCESS_EQUP(NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = TEMP_PROCESS_EQUP.SESSION_ID  JOIN MAEQUP (NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = MAEQUP.EQUIPMENT_ID WHERE MAEQUP_INBOUND.TIMESTAMP='"+ str(timestamp_sessionid)+ "'  AND ISNULL(MAEQUP_INBOUND.INTEGRATION_STATUS,'''') ='''' AND ISNULL(MAEQUP_INBOUND.PROCESS_STATUS,'''')=''READY FOR UPLOAD'' AND ISNULL(TEMP_PROCESS_EQUP.PROCESS_STATUS,'''')='''' AND ISNULL(SUBSTRATE_SIZE,'''') IN (''300mm'') AND TECHNOLOGY_NODE IN( ''<=10NM'',''1A'',''1X'',''1Y'',''1Z'',''3D 96P'',''XPOINT'',''F1X '')  AND MAEQUP.GREENBOOK NOT IN (''DISPLAY'',''PPC'') '" )

				primaryQueryItems = SqlHelper.GetFirst(
									""
									+ str(Parameter.QUERY_CRITERIA_1)
									+ " MAEQUP SET VALDRV_WAFERNODE = ''Legacy'' FROM MAEQUP_INBOUND(NOLOCK) JOIN TEMP_PROCESS_EQUP(NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = TEMP_PROCESS_EQUP.SESSION_ID  JOIN MAEQUP (NOLOCK) ON MAEQUP_INBOUND.EQUIPMENT_ID = MAEQUP.EQUIPMENT_ID WHERE MAEQUP_INBOUND.TIMESTAMP='"+ str(timestamp_sessionid)+ "'  AND ISNULL(MAEQUP_INBOUND.INTEGRATION_STATUS,'''') ='''' AND ISNULL(MAEQUP_INBOUND.PROCESS_STATUS,'''')=''READY FOR UPLOAD'' AND ISNULL(TEMP_PROCESS_EQUP.PROCESS_STATUS,'''')=''''  MAEQUP.GREENBOOK = ''PPC'' '" )
