...
try:
	...
	primaryQueryItems = SqlHelper.GetFirst(
		""
		+ str(Parameter.QUERY_CRITERIA_1)
		+ " SAGTCD(GOT_CODE,GOT_CODE_DESCRIPTION,GOT_CODES_RECORD_ID)SELECT GOT_CODE,GOT_CODE,CONVERT(VARCHAR(100),NEWID()) FROM (SELECT DISTINCT GOT_CODE FROM MAEQUP(NOLOCK) WHERE ISNULL(GOT_CODE,'''')<>'''' )A  '"	)
