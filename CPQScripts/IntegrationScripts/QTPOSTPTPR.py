		...
		if hasattr(Param, 'CPQ_Columns'): 
			...
			if getpartsdata:
				...
				if currencyType == 'docCurrency':
					...
					JOIN SAQIFP (NOLOCK) ON SAQIFP.PART_NUMBER = SAQRIT.OBJECT_ID AND SAQIFP.QUOTE_RECORD_ID = SAQRIT.QUOTE_RECORD_ID WHERE SAQRIT.QUOTE_RECORD_ID = '{QuoteRecordId}'""".format(total=GetSum.TOTAL, QuoteRecordId=contract_quote_record_id))
