							...
							Sql.RunQuery("""UPDATE SAQRIS 
								...
								NET_PRICE=IQ.NET_PRICE 
									FROM SAQRIS 
										...
										FROM SAQRIT 
										WHERE SAQRIT.QUOTE_RECORD_ID = '{QuoteRecordId}' AND SAQRIT.QTEREV_RECORD_ID = '{rev}' AND SAQRIT.SERVICE_ID = '{SERVICE_ID}' GROUP BY SAQRIT.QUOTE_RECORD_ID, SAQRIT.QTEREV_RECORD_ID,SAQRIT.SERVICE_ID) IQ ON SAQRIS.QUOTE_RECORD_ID = IQ.QUOTE_RECORD_ID AND SAQRIS.QUOTE_REVISION_RECORD_ID = IQ.QTEREV_RECORD_ID AND SAQRIS.SERVICE_ID = IQ.SERVICE_ID
							...
							Sql.RunQuery("""UPDATE SAQTRV 
								...
								NET_PRICE=IQ.NET_PRICE 
									FROM SAQRIS 
										...
										FROM SAQRIS 
										WHERE SAQRIS.QUOTE_RECORD_ID = '{QuoteRecordId}' AND SAQRIS.QTEREV_RECORD_ID = '{rev}' AND SAQRIS.SERVICE_ID = '{SERVICE_ID}' GROUP BY SAQRIS.QUOTE_RECORD_ID, SAQRIS.QTEREV_RECORD_ID,SAQRIS.SERVICE_ID) IQ ON SAQRIS.QUOTE_RECORD_ID = IQ.QUOTE_RECORD_ID AND SAQRIS.QUOTE_REVISION_RECORD_ID = IQ.QTEREV_RECORD_ID AND SAQRIS.SERVICE_ID = IQ.SERVICE_ID
								WHERE QUOTE_RECORD_ID = '{QuoteRecordId}' AND QTEREV_RECORD_ID='{rev}' AND SERVICE_ID = '{SERVICE_ID}'""".format(total_unit=GetSum.TOTAL_UNIT,total_net = GetSum.TOTAL_EXT, QuoteRecordId=contract_quote_record_id,rev =revision_rec_id,SERVICE_ID=get_ancillary_spare.SERVICE_ID))
						...
						if GetEquipment_count:
							...
							Sql.RunQuery("""UPDATE SAQRIS 
								...
								NET_PRICE_INGL_CURR=IQ.NET_PRICE_INGL_CURR 
									FROM SAQRIS 
										INNER JOIN (SELECT SAQRIT.QUOTE_RECORD_ID, SAQRIT.QTEREV_RECORD_ID,SAQRIS.SERVICE_ID,
										...
										FROM SAQRIT 
										WHERE SAQRIT.QUOTE_RECORD_ID = '{QuoteRecordId}' AND SAQRIT.QTEREV_RECORD_ID = '{rev}' AND SAQRIT.SERVICE_ID = '{SERVICE_ID}' GROUP BY SAQRIT.QUOTE_RECORD_ID, SAQRIT.QTEREV_RECORD_ID,SAQRIS.SERVICE_ID) IQ ON SAQRIS.QUOTE_RECORD_ID = IQ.QUOTE_RECORD_ID AND SAQRIS.QUOTE_REVISION_RECORD_ID = IQ.QTEREV_RECORD_ID AND SAQRIS.SERVICE_ID = IQ.SERVICE_ID
								WHERE QUOTE_RECORD_ID = '{QuoteRecordId}' AND QTEREV_RECORD_ID='{rev}' AND SERVICE_ID = '{SERVICE_ID}'""".format( QuoteRecordId=contract_quote_record_id,rev =revision_rec_id,SERVICE_ID=get_ancillary_spare.SERVICE_ID))
							Sql.RunQuery("""UPDATE SAQTRV 
								SET 
								NET_PRICE_INGL_CURR=IQ.NET_PRICE_INGL_CURR 
