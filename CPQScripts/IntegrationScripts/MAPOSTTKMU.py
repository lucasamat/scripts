...
"""
	...
	""
	+ str(Parameter.QUERY_CRITERIA_1)
	+ " SGPMNT(ACTIVE,PM_NAME,CPQTABLEENTRYADDEDBY,ADDUSR_RECORD_ID,CPQTABLEENTRYDATEADDED,PREVENTIVE_MAINTENANCE_RECORD_ID) SELECT SUB_SGPMNT.ACTIVE,SUB_SGPMNT.PM_NAME,''"+ str(User.UserName)
	+ "'',''"+ str(User.Id)
