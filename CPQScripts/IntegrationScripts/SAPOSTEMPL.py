# =========================================================================================================================================
#   __script_name : SAPOSTEMPL.PY
#   __script_description : THIS SCRIPT IS USED TO INSERT EMPLOYEE  DATA IN STAGING TABLE SYINPL
...
try:
    if 'Param' in globals():    
        if hasattr(Param, 'CPQ_Columns'): 
            ...
            primaryQueryItems = SqlHelper.GetFirst( ""+ str(Parameter.QUERY_CRITERIA_1)+ " SYINPL (INTEGRATION_PAYLOAD,INTEGRATION_NAME,SESSION_ID,CPQTABLEENTRYDATEADDED,CPQTABLEENTRYADDEDBY)  select ''"+str(Final_data)+ "'',''EMPLOYEE_DATA'','"+ str(timestamp_sessionid)+ "',Getdate(),''"+str(addby)+ "'' ' ")
    ...
    Log.Info("SAPOSTEMPL ERROR---->:" + str(sys.exc_info()[1]))
    Log.Info("SAPOSTEMPL ERROR LINE NO---->:" + str(sys.exc_info()[-1].tb_lineno))
