						...
						if int(ent_disp_val) > 364:
							...
							if ProductVersionObj is not None:
								...
								for attrs in attributesallowedlst:
									...
									Trace.Write('cpsmatc_incr'+str(cpsmatc_incr))
								Updatecps = "UPDATE {} SET CPS_MATCH_ID ={},CPS_CONFIGURATION_ID = '{}',ENTITLEMENT_XML='{}',{} as CpqTableEntryModifiedBy, GETDATE() as CpqTableEntryDateModified WHERE {} ".format('SAQTSE', cpsmatc_incr,cpsConfigID,insertservice, User.Id, whereReq)
