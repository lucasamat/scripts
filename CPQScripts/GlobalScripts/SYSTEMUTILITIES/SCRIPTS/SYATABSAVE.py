                                        ...
                                        if iskey is not None and flag == "True": 
                                            ...
                                            if (
                                                ...
                                                if len(Field_Labels) > 1:
                                                    Product.Attributes.GetByName(
                                                        "SEC_N_TAB_PAGE_ALERT"
                                                    ).HintFormula = "<div class='col-md-12' id='PageAlert' style='display':'block';  ><div class='row modulesecbnr brdr' data-toggle='collapse' data-target='#Alert13' aria-expanded='true' >NOTIFICATIONS<i class='pull-right fa fa-chevron-down '></i><i class='pull-right fa fa-chevron-up'></i></div><div  id='Alert13' class='col-md-12  alert-notification  brdr collapse in' ><div  class='col-md-12 alert-danger'><label ><img src='/mt/APPLIEDMATERIALS_TST/Additionalfiles/stopicon1.svg' alt='Error'>  ERROR : '{0}' are required fields </label></div></div></div>".format(
                                                        sectalert
                                                    )
