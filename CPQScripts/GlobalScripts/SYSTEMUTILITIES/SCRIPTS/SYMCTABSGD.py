                    ...
                    for sql in sql_obj:
                        ...
                        if data_obj is not None:
                            ...
                            if current_prod == "":
                                ...
                                for ik in NAME:
                                    if PRIMARY_OBJECT_NAMes == "SAQTMT":
                                        if ik == 'QUOTE_ID' or ik == 'QTEREV_ID' or ik == 'REVISION_STATUS' or ik == 'REVISION_DESCRIPTION' or ik == 'CONTRACT_VALID_FROM' or ik == 'CONTRACT_VALID_TO' or ik == 'SALESORG_ID':
                                ...
                                try:
                                    ...
                                    if PageInform == "":
                                        ...
                                        if flag == 3 and (str(x_tabs) == 'Quotes' or str(x_tabs) == 'Contracts'):
                                            ...
                                            QueryCountStr = (
                                                "select rowcnt= count(*)  from " + PRIMARY_OBJECT_NAMes + " INNER JOIN SAQTRV ON  SAQTMT.[MASTER_TABLE_QUOTE_RECORD_ID] = SAQTRV.[QUOTE_RECORD_ID] INNER JOIN SAOPQT ON SAOPQT.[QUOTE_RECORD_ID] = SAQTRV.[QUOTE_RECORD_ID] " + str(where)
                                            )    
                                            Trace.Write('## QueryStr--->'+str(QueryStr))
                                        else:
                                            QueryStr = (
