			...
			if getParentObjQuery is not None:
				...
				for getParentObj in getParentObjQuery:
					...
					if str(getParentObj.TREEIMAGE_URL):
						...
						image_url = '<img class="leftside-bar-icons" src="/mt/appliedmaterials_tst/Additionalfiles/AMAT/Quoteimages/{image_url}"/>'.format(image_url = image_url)+'<img class="leftside-bar-icons" src="/mt/appliedmaterials_tst/Additionalfiles/AMAT/Quoteimages/{image_url}"/>'.format(image_url = image_url)
					else:
						image_url = ''
					ProductDict = {}
					ChildListData = []
