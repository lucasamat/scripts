			...
			for key, invs in enumerate(list(eval(Columns))):
				...
				# 	continue
					...
					if not table_group_columns2:
						table_header += '<th colspan="7" '+rowspan_level1+'  data-align="center"><div><button style="border:none;" class="glyphicon glyphicon-minus-sign" id="price_info_column_toggle" onclick="quote_items_column_toggle(this)"></button>PRICING INFORMATION</div></th>'
					if str(invs) in right_align_list:
						align = 'right'
					elif str(invs) in center_align_list:
						align = 'center'
