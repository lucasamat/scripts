		...
		if Columns != "" and Obj_Name != "":
			...
			for key, invs in enumerate(list(eval(Columns))):
				...
				# 	continue
					...
					rowspan_level1 = ""
					if not table_group_columns2:
						table_header += '<th colspan="5" '+rowspan_level1+'  data-align="right"><div>WTYY/SPLIT INFO<button style="border:none;" class="glyphicon glyphicon-minus-sign" id="warranty_info_column_toggle" onclick="quote_items_column_toggle(this)"></button></div></th>'
					if str(invs) in right_align_list:
						align = 'right'
					elif str(invs) in center_align_list:
						align = 'center'
					...
					if str(invs) in right_align_list:
						...
						if invs == "LINE"and RECORD_ID != 'SYOBJR-98873' :
							...
							if RECORD_ID == "SYOBJR-98877" or RECORD_ID == "SYOBJR-98872" or RECORD_ID == "SYOBJR-98876":
								table_header += (
									'<th  data-field="'
									+ str(invs)
									+ '" data-filter-control="input" data-title-tooltip="'
