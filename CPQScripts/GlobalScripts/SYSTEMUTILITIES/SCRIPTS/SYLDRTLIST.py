			...
			for key, invs in enumerate(list(eval(Columns))):
				...
				# 	continue
					...
					if not table_group_columns2:
						table_header += '<th colspan="5" '+rowspan_level1+'  data-align="center"><div>EVENT INFORMATION<button style="border:none;" id="event_info_column_toggle"></button></div></th>'
					if str(invs) in right_align_list:
						align = 'right'
					elif str(invs) in center_align_list:
						align = 'center'
