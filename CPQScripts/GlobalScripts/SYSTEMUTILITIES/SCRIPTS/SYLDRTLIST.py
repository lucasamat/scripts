                            ...
                            if value123 in checkbox_list:
                                ...
                                if (value123 == "SET_NAME" or value123 == "SETMAT_NAME") and (
                                    ...
                                    if value123 in [
                                        ...
                                        if (str(TreeParentParam).upper() == "BRIDGE PRODUCTS" and  str(RECORD_ID) == "SYOBJR-00005" and str(value123) in ['SCHEDULE_MODE','CUSTOMER_ANNUAL_QUANTITY']) or (str(RECORD_ID) == "SYOBJR-00009" and ( str(value123) == 'SALES_PRICE' or str(value123) == 'DISCOUNT')):
