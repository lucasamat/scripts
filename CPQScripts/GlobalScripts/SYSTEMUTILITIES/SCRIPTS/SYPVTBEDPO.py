...
def PivotTableAttredit(TABLEID, ATTR_ID, PRICEAGREEMENT_ID, SEGMENT_DESC, Display_save_val):
    ...
    sec_str += (
        ...
        + str(ATTR_ID)
        + ' class="btnconfig " onclick="pivottablemat_attr_update(this)" data-dismiss="modal">SAVE</button></div></div><div class="col-md-12"   id="alert_msg_outer" ><div class="row modulesecbnr brdr" data-toggle="collapse" data-target="#Alert24" aria-expanded="true" >NOTIFICATIONS<i class="pull-right fa fa-chevron-down "></i><i class="pull-right fa fa-chevron-up"></i></div><div  id="Alert24" class="col-md-12  alert-notification  brdr collapse in" ><div  class="col-md-12 alert-danger"   id="alert_msg" style="display:none" ><label ><img src="/mt/APPLIEDMATERIALS_TST/Additionalfiles/stopicon1.svg" alt="Error">  </label></div></div></div><div id="container" class="g4 pad-10 brdr except_sec">'
    )
...
def PivotTableAttrView(TABLEID, ATTR_ID, PRICEAGREEMENT_ID, SEGMENT_DESC, Display_save_val):
    ...
    sec_str += '<div id="PIVOT_TABLE_EDIT"><div class="row modulebnr brdr ma_mar_btm"> MATERIAL ATTRIBUTE : VIEW <button type="button" class="close flt_rt" data-dismiss="modal">X</button></div><div class="col-md-12"><div class="row pad-10 bg-lt-wt brdr"> <button type="button" class="btnconfig" data-dismiss="modal">CANCEL</button><button type="button" onclick="pivottable_attr_edit(this)" class="btnconfig">EDIT</button></div></div><div class="col-md-12"   id="alert_msg_outer" ><div class="row modulesecbnr brdr" data-toggle="collapse" data-target="#Alert25" aria-expanded="true" >NOTIFICATIONS<i class="pull-right fa fa-chevron-down "></i><i class="pull-right fa fa-chevron-up"></i></div><div  id="Alert25" class="col-md-12  alert-notification  brdr collapse in" ><div  class="col-md-12 alert-danger"   id="alert_msg"  style="display: none;"><label ><img src="/mt/APPLIEDMATERIALS_TST/Additionalfiles/stopicon1.svg" alt="Error">  </label></div></div></div><div id="container" class="g4 pad-10 brdr except_sec">'
