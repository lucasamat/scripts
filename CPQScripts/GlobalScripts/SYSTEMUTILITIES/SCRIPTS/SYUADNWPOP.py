	...
	if Question_obj is not None:
		...
		# UNMAPPED EQUIPMENTS ENDED
			...
			if Objd_Obj is not None:
				...
				lookup_list = {ins.LOOKUP_API_NAME: ins.API_NAME for ins in Objd_Obj}
				sec_str = '<div class="row modulebnr brdr ma_mar_btm">ADD CONTRACT MANAGER<button type="button" id = "contract_replace" class="close flt_rt" onclick="closepopup_scrl(this)" data-dismiss="modal">X</button></div>'
