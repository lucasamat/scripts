...
class ConfigUpdateScript:
	...
	def build_query(self, column, obj_name, where_string):
		...
		if obj_name == "SAQTMT":
			column = "SAQTMT.MASTER_TABLE_QUOTE_RECORD_ID,SAQTRV.QUOTE_ID,SAQTRV.QTEREV_ID,SAQTMT.ACCOUNT_ID,SAQTMT.ACCOUNT_NAME,SAQTRV.CONTRACT_VALID_FROM,SAQTRV.CONTRACT_VALID_TO,SAQTRV.REVISION_STATUS,SAQTRV.SALESORG_ID,SAQTMT.OWNER_NAME,SAQTMT.POES,SAQTRV.LOW"
			query_string = """
					SELECT {Column_Name}
