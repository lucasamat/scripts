...
def Related_Sub_Banner(
    ...
    if CurrentRecordId.startswith("SYOBJR", 0) == True:
        ...
        if get_quote_status and (str(quote_status.REVISION_STATUS) == 'CPG-CONFIGURATION' or str(quote_status.REVISION_STATUS) == 'NEW REVISION' or str(quote_status.REVISION_STATUS) == 'APR-RECALLED'  or str(quote_status.REVISION_STATUS) == 'CFG-ACQUIRING' or (quote_status.REVISION_STATUS) == 'PRI-PRICING') and Submit_approval == "True":
