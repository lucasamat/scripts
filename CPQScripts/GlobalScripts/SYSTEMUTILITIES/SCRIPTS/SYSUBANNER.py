...
def Related_Sub_Banner(
    ...
    if page_details:
        dynamic_Button = Sql.GetList("SELECT HTML_CONTENT,RELATED_LIST_RECORD_ID FROM SYPGAC (NOLOCK) WHERE PAGE_RECORD_ID = '{}' AND TAB_NAME LIKE '%"+str(CurrentTab)+"%'".format(page_details.RECORD_ID))
        Trace.Write('dyn====')
