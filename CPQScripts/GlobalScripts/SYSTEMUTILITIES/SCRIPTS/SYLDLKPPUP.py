...
def GSCONTLOOKUPPOPUP(TABLEID, objName, RECORD_ID, api_name, where):
    ...
    if VAL_Obj is not None and VAL_Obj != "":
        ...
        if RECORD_ID == 'SYSEFL_QT_01124':
            ...
            sec_str += '<button type="button" class="btnconfig" data-dismiss="modal">CANCEL</button><button type="button" onclick="popupClearall()" class="btnconfig" data-dismiss="modal">CLEAR SELECTION</button>'
        sec_str += "</div>"
