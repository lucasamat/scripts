        ...
        for x,y in zip(ToolId,ToolDesc):
            ...
            if getDefaultValue:
                if x == "Idle Notice Exception":
                    ...
                    sec_str += '<select class="form-control remove_yellow disable_edit" style="" id="'+x.replace(" ","_")+'" type="text"  data-content="'+x.replace(" ","_")+'"  title="'+getDefaultValue.TOOLIDLING_VALUE_CODE+'" disabled = ""'+style+'><option value="select" style="display:none;"> </option><option id="'+x.replace(" ","_")+'" value="'+getDefaultValue.TOOLIDLING_VALUE_CODE+'" selected = "">'+getDefaultValue.TOOLIDLING_VALUE_CODE+'</option>'
            ...
            for x,y in zip(ToolId,ToolDesc):
                ...
                if getDefaultValue:
                    if x == "Idle Notice":
                        ...
                        sec_str += '<select class="form-control remove_yellow disable_edit" style="" id="WarmHotIdleAllowed" type="text"  data-content="'+x.replace(" ","_")+'"  title="'+getDefaultValue.TOOLIDLING_VALUE_CODE+'" disabled=""><option value="select" style="display:none;"> </option><option id="'+x.replace(" ","_")+'" value="'+getDefaultValue.TOOLIDLING_VALUE_CODE+'" selected = "">'+getDefaultValue.TOOLIDLING_VALUE_CODE+'</option>'
                    else:
                        Trace.Write("Idle Else")
