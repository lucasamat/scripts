...
def LoadQuoteSummary():
    ...
    values = {}
    values["Total Excluding Tax/VAT/GST"] = GetDetails.NET_VALUE_INGL_CURR
    values["Total Tax/VAT/GST"] = GetDetails.TAX_AMOUNT_INGL_CURR
    values["Total Est Net Val"] = GetDetails.ESTVAL_INGL_CURR
    values["Total Amt"] = GetDetails.TOTAL_AMOUNT_INGL_CURR
    values["Total Margin"] = GetDetails.CNTMRG_INGL_CURR
    values["Total Margin Pct"] = GetDetails.TOTAL_MARGIN_PERCENT
