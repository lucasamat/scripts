...
def LoadSummary():
    ...
    if ent_value == "Yes":
        ...
        getPRTIAV = Sql.GetList("SELECT TOOLIDLING_ID,TOOLIDLING_NAME,TOOLIDLING_VALUE_CODE,TOOLIDLING_DISPLAY_VALUE FROM SAQTDA (NOLOCK) WHERE QTEREV_RECORD_ID = '{}' AND TOOLIDLING_ID != 'Idling Allowed' ORDER BY TOOLIDLING_ID ASC".format(Quote.GetGlobal("quote_revision_record_id")))
