...
def fabview(ACTION,CurrentRecordId,subtab):	
	...
	sec_str += ('''<div class="dyn_main_head master_manufac glyphicon pointer   glyphicon-chevron-down" onclick="dyn_main_sec_collapse_arrow(this)" data-target=".customer_value_driver_info" data-toggle="collapse"><label class="onlytext"><label class="onlytext"><div>CUSTOMER VALUE DRIVERS INFORMATION</div></label></label></div>''')
