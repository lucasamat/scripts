...
def entitlement_view(RECORD_ID,ObjectName,EntitlementType):

    quoteid = contract_quote_record_id
    ...
    ##addon product fab and greenbook level 
        ...
        ProductPartnumber = treeparentparam	
    elif str(treesupertopparentparam).upper() == "COMPREHENSIVE SERVICES" and str(treetopsuperparentparam).upper() == "ADD-ON PRODUCTS":		
        ProductPartnumber = treesuperparentparam		
    ##addon product fab and greenbook level 
