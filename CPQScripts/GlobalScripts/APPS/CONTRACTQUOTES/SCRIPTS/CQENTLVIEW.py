			...
			if ProductPartnumber:	
				...
				for product_tab_obj in product_tabs_obj:
					...
					if (self.treeparentparam == "Quote Items" or self.treeparam == "Quote Items" or self.treesuperparentparam == "Quote Items" or self.treetopsuperparentparam == "Quote Items"):
						...
						Trace.Write("section_list-"+str(section_list)+"get_readonly_section_list-"+str(get_readonly_section_list))
						if len(section_list) == (get_readonly_section_list) and len(section_list) != 0:
							binding_buttons = ''
						else:
							binding_buttons = "$('#entsave').css('display','block');$('#entcancel').css('display','block');"
						dbl_clk_function += (
