		...
		if TableObj is None and (EntitlementType == "EQUIPMENT"): 
			...
			if product_tabs_obj:
				for product_tab_obj in product_tabs_obj:
					...
					sec_str_boot += ('<div id = "btn_ent" class="g4  except_sec removeHorLine iconhvr sec_edit_sty" style="display: none;"><button id="entcancel" class="btnconfig btnMainBanner sec_edit_sty_btn"  onclick="fabcostlocatecancel(this)" style="display: none;" class="btnconfig">CANCEL</button><button id="entsave" class="btnconfig btnMainBanner sec_edit_sty_btn_'+str(Section_id)+ '"  onclick="fabcostlocatesave(this)" style="display: none;" class="btnconfig">SAVE</button></div>')
					attribute_Name_list = []
