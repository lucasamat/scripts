		...
		if TableObj is None and (EntitlementType == "EQUIPMENT"): 
			...
			if ProductPartnumber:	
				...
				for product_tab_obj in product_tabs_obj:
					...
					if (self.treeparentparam == "Quote Items" or self.treeparam == "Quote Items" or self.treesuperparentparam == "Quote Items" or self.treetopsuperparentparam == "Quote Items" and str(len(get_readonly_section_list)) > 0) :
