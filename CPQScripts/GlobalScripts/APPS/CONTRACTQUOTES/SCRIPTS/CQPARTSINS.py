        ...
        try:
            ...
            Sql.RunQuery("""
                            ...
                            SELECT 
                                ...
                                CASE WHEN SAQTSV.SERVICE_ID='Z0110' THEN '' ELSE 'UNSCHEDULED' END AS SCHEDULE_MODE,
