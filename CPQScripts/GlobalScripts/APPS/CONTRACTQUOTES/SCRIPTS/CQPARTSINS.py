        ...
        try:
            ...
            Log.Info("saqspt+++"+str("""
                            ...
                            SELECT 
                                ...
                                CASE WHEN MAMSOP.SALESUOM_ID<>'' THEN MAMSOP.SALESUOM_ID ELSE MAMTRL.UNIT_OF_MEASURE as SALESUOM_ID,
                                CASE WHEN MAMSOP.SALESUOM_RECORD_ID<>'' THEN MAMSOP.SALESUOM_RECORD_ID ELSE MAMTRL.UOM_RECORD_ID as SALESUOM_RECORD_ID, 
