		...
		if (self.tree_param =='Z0110'):
			Sql.RunQuery("""
							...
							SELECT 
								...
								CASE WHEN TEMP_TABLE.ODCC_FLAG_DESCRIPTION ='' THEN NULL ELSE RIGHT(TEMP_TABLE.ODCC_FLAG_DESCRIPTION,3) AS ODCC_FLAG,
