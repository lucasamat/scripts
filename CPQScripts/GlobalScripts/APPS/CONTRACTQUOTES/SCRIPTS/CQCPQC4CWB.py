...
def writeback_to_c4c(writeback,contract_quote_record_id,quote_revision_record_id):
    ...
    if writeback == "quote_header":
        ...
        if revision_obj:
            ...
            revision_status_code = {"APPROVAL PENDING":"111", "RECALLED":"121", "REJECTED":"131", "APR-APPROVED":"141","CUSTOMER ACCEPTED":"161","SUBMITTED FOR BOOKING":"181","CONTRACT BOOKED":"191","CFG-ON HOLD - COSTING":"221","CUSTOMER REJECTED":"171","CPG-CONFIGURATION":"211","OPPORTUNITY CANCELLED":"231","OPPORTUNITY LOST":"241","PRICED":"101","CFG-ACQUIRING":"261","ON HOLD PRICING":"251"}
