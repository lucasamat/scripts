...
def _insert_subtotal_by_offerring_quote_table():
	...
	if getoffer_details_obj:
		for val in getoffer_details_obj:
			...
			newRow['SERVICE_ID'] = val.getservicerecord.SERVICE_ID
