...
def quoteiteminsert(Qt_id):
	...
	Sql.RunQuery("""UPDATE SAQTRV
						...
						WHERE SAQTRV.QUOTE_RECORD_ID = '{quote_rec_id}' AND SAQTRV.QUOTE_REVISION_RECORD_ID = '{quote_revision_rec_id}' 	""".format(quote_rec_id = Qt_id ,quote_revision_rec_id = get_rev_rec_id.QTEREV_RECORD_ID ) )
