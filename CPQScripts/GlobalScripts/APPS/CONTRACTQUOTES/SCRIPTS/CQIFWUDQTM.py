	...
	Sql.RunQuery("""UPDATE SAQRIT 
					...
					FROM SAQRIT
						INNER JOIN 
							...
							ROUND(ISNULL(TAX_AMOUNT_INGL_CURR,0),ISNULL(PRCURR.ROUNDING_DECIMAL_PLACES,5) ) as TAX_AMOUNT_INGL_CURR,
							ROUND(ISNULL(NET_PRICE_INGL_CURR,0),ISNULL(PRCURR.ROUNDING_DECIMAL_PLACES,5) ) as NET_PRICE_INGL_CURR,
							ROUND(ISNULL(COMVAL_INGL_CURR,0),ISNULL(PRCURR.ROUNDING_DECIMAL_PLACES,5) ) as COMVAL_INGL_CURR,
							ROUND(ISNULL(ESTVAL_INGL_CURR,0),ISNULL(PRCURR.ROUNDING_DECIMAL_PLACES,5) ) as ESTVAL_INGL_CURR,
							ROUND(ISNULL(NET_VALUE_INGL_CURR,0),ISNULL(PRCURR.ROUNDING_DECIMAL_PLACES,5) ) as NET_VALUE_INGL_CURR,
							ROUND(ISNULL(UNIT_PRICE_INGL_CURR,0),ISNULL(PRCURR.ROUNDING_DECIMAL_PLACES,5) ) as UNIT_PRICE_INGL_CURR,
							ROUND(ISNULL(YEAR_1_INGL_CURR,0),ISNULL(PRCURR.ROUNDING_DECIMAL_PLACES,5) ) as YEAR_1_INGL_CURR,
							ROUND(ISNULL(YEAR_2_INGL_CURR,0),ISNULL(PRCURR.ROUNDING_DECIMAL_PLACES,5) ) as YEAR_2_INGL_CURR,
							ROUND(ISNULL(YEAR_3_INGL_CURR,0),ISNULL(PRCURR.ROUNDING_DECIMAL_PLACES,5) ) as YEAR_3_INGL_CURR,
							ROUND(ISNULL(YEAR_4_INGL_CURR,0),ISNULL(PRCURR.ROUNDING_DECIMAL_PLACES,5) ) as YEAR_4_INGL_CURR,
							ROUND(ISNULL(YEAR_5_INGL_CURR,0),ISNULL(PRCURR.ROUNDING_DECIMAL_PLACES,5) ) as YEAR_5_INGL_CURR,
							ROUND(ISNULL(TOTAL_AMOUNT_INGL_CURR,0),ISNULL(PRCURR.ROUNDING_DECIMAL_PLACES,5) ) as TOTAL_AMOUNT_INGL_CURR,
							ROUND(ISNULL(PEREVTCST_INGL_CURR,0),ISNULL(PRCURR.ROUNDING_DECIMAL_PLACES,5) ) as PEREVTCST_INGL_CURR,
							ROUND(ISNULL(PEREVTPRC_INGL_CURR,0),ISNULL(PRCURR.ROUNDING_DECIMAL_PLACES,5) ) as PEREVTPRC_INGL_CURR
							FROM SAQRIT 
