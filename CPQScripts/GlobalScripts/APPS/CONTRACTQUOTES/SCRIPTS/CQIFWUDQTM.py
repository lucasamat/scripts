...
def quote_items_pricing(Qt_id):
	...
	Sql.RunQuery("""UPDATE SAQICO
			...
			FROM SAQICO	(NOLOCK)
			JOIN PRPRBM (NOLOCK) ON PRPRBM.EQUIPMENT_NUMBER = RIGHT('000000000000000000' + CONVERT(VARCHAR(18), SAQICO.EQUIPMENT_ID), 18) AND PRPRBM.SERVICE_PRODUCT_NAME = SAQICO.SERVICE_ID
