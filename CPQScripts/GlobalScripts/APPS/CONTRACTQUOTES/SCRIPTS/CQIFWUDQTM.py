...
def quoteiteminsert(Qt_id):
	...
	Sql.RunQuery("""UPDATE SAQTRV
						...
						SAQTRV.SALES_PRICE_INGL_CURR = IQ.SALES_PRICE_INGL_CURR

						
						FROM SAQTRV (NOLOCK)
						INNER JOIN (SELECT SAQRIT.QUOTE_RECORD_ID, SAQRIT.QTEREV_RECORD_ID,
									SUM(ISNULL(SAQRIT.TARGET_PRICE_INGL_CURR, 0)) as TARGET_PRICE_INGL_CURR,
									SUM(ISNULL(SAQRIT.BD_PRICE_INGL_CURR, 0)) as BD_PRICE_INGL_CURR,
									SUM(ISNULL(SAQRIT.CEILING_PRICE_INGL_CURR, 0)) as CEILING_PRICE_INGL_CURR,
									...
									SUM(ISNULL(SAQRIT.SLSDIS_PRICE_INGL_CURR, 0)) as SLSDIS_PRICE_INGL_CURR,
									SUM(ISNULL(SAQRIT.DISCOUNT_AMOUNT_INGL_CURR, 0)) as DISCOUNT_AMOUNT_INGL_CURR,
									SUM(ISNULL(SAQRIT.SALES_PRICE_INGL_CURR, 0)) as SALES_PRICE_INGL_CURR,
