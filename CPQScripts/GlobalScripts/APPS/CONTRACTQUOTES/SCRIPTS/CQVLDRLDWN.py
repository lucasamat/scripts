...
def ServiceCostAndValueDrivers():
    ...
    + " SAQSGB (FABLOCATION_ID,FABLOCATION_NAME,FABLOCATION_RECORD_ID,SERVICE_ID,SERVICE_DESCRIPTION,SERVICE_RECORD_ID,GREENBOOK,GREENBOOK_RECORD_ID,QUOTE_ID,QUOTE_NAME,QUOTE_RECORD_ID,SALESORG_ID,SALESORG_NAME,SALESORG_RECORD_ID,QTEREV_RECORD_ID,QTEREV_ID,CPQTABLEENTRYADDEDBY, CpqTableEntryModifiedBy, ADDUSR_RECORD_ID, CPQTABLEENTRYDATEADDED, CpqTableEntryDateModified,QUOTE_SERVICE_GREENBOOK_RECORD_ID)SELECT A. *,getdate(),getdate(),CONVERT(VARCHAR(4000),NEWID()) FROM (SELECT DISTINCT A.FABLOCATION_ID,A.FABLOCATION_NAME,A.FABLOCATION_RECORD_ID,A.SERVICE_ID,A.SERVICE_DESCRIPTION,A.SERVICE_RECORD_ID,A.GREENBOOK,A.GREENBOOK_RECORD_ID,A.QUOTE_ID,A.QUOTE_NAME,A.QUOTE_RECORD_ID,A.SALESORG_ID,A.SALESORG_NAME,A.SALESORG_RECORD_ID,A.QTEREV_RECORD_ID,A.QTEREV_ID,A.CPQTABLEENTRYADDEDBY, A.CpqTableEntryModifiedBy, A.ADDUSR_RECORD_ID FROM SAQSCO(NOLOCK) A where a.QUOTE_RECORD_ID = ''"+str(Qt_rec_id)+"'' a.QTEREV_RECORD_ID = ''"+str(quote_revision_record_id)+"'')A left join SAQSGB (NOLOCK) b on a.QUOTE_ID =b.QUOTE_ID and a.FABLOCATION_RECORD_ID =b.FABLOCATION_RECORD_ID and a.SERVICE_RECORD_ID =b.SERVICE_RECORD_ID AND a.GREENBOOK = b.GREENBOOK AND a.QTEREV_RECORD_ID = b.QTEREV_RECORD_ID WHERE b.QUOTE_ID IS NULL'")
