...
class revisionstatuschangedate:
    def __init__(self):
        pass
    def Revisionstatusdatecapture(self,contract_quote_record_id,quote_revision_record_id):
        ...
        return True
REVISIONSTATUS = revisionstatuschangedate()
ApiResponse = ApiResponseFactory.JsonResponse(REVISIONSTATUS.revisionstatuschangedate(contract_quote_record_id,quote_revision_record_id))
