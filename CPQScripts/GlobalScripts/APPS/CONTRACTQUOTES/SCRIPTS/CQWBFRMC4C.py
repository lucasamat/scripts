...
if 'Param' in globals():
    ...
    if hasattr(Param, 'CPQ_Columns'):
        ...
        Log.Info("SELECT SAQTRV.QUOTE_RECORD_ID,SAQTRV.QTEREV_RECORD_ID FROM SAQTRV JOIN SAOPQT ON SAQTRV.QUOTE_RECORD_ID = SAOPQT.QUOTE_RECORD_ID  WHERE SAOPQT.OPPORTUNITY_ID = '{}' AND SAQTRV.ACTIVE = 1".format(opportunity_id))
