						...
						if int(ent_disp_val) > 364:
							...
							if ProductVersionObj is not None:
								...
								for attrs in attributesallowedlst:
									...
									Updatecps = "UPDATE {} SET CPS_MATCH_ID ={},CPS_CONFIGURATION_ID = '{}',ENTITLEMENT_XML='{}',{} as CPQTABLEENTRYADDEDBY, GETDATE() as CPQTABLEENTRYDATEADDED WHERE {} ".format('SAQTSE', cpsmatc_incr,cpsConfigID,insertservice, User.Id, whereReq)
