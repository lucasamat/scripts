...
def QuoteAssemblyPreventiveMaintainenceParent(PerPage, PageInform, A_Keys, A_Values,ASSEMBLYID,EQUIPMENTID):
	...
	table_header = (
		'<table id="'
		+ str(table_id)
		+ '"  data-pagination="false" data-sortable="false" data-search-on-enter-key="true" data-filter-control="true" data-pagination-loop = "false" data-locale = "en-US" ><thead>'
	)
	Columns = [
	...
	for key, invs in enumerate(list(Columns)):
		...
		if checkbox_list is not None and invs in checkbox_list:
			table_header += (
				...
				+ '"  data-field="'
				+ str(invs)
				+ '" data-filter-control="input" data-align="center" data-formatter="CheckboxFieldRelatedList" data-sortable="false"><abbr title="'
				+ str(qstring)
				+ '">'
				+ str(qstring)
				+ "</abbr></th>"
			...
			table_header += (
				...
				+ '"  data-field="'
				+ str(invs)
				+ '" data-filter-control="input" data-formatter="'+str(data_formatter)+'" data-sortable="false"><abbr title="'
				+ str(qstring)
				+ '">'
				+ str(qstring)
				+ "</abbr></th>" 
			...
			table_header += (
				...
				+ '"  data-field="'
				+ str(invs)
				+ '" data-filter-control="input" data-sortable="false"><abbr title="'
				+ str(qstring)
				+ '">'
				+ str(qstring)
				+ "</abbr></th>"
