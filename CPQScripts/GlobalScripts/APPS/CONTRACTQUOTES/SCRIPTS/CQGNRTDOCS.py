...
def attachments():
	secstr = ""
	secstr += '$("#VIEW_DIV_ID").html(<div class="row modulebnr brdr ma_mar_btm">UPLOAD ATTACHMENT <button type="button" class="close flt_rt" onclick="closepopup_scrl()" data-dismiss="modal">X</button></div><div class="col-md-12 padlftrhtnone"><div class="row pad-10 bg-lt-wt brdr"><img style="height:40px;margin-top:-1px;margin-left:-1px;float:left" src="/mt/APPLIEDMATERIALS_TST/Additionalfiles/Secondary Icon.svg"><div class="product_txt_div_child secondary_highlight" style="display:block;text-align:left"><div class="product_txt_child"><abbr title="Key">Upload Attachment</abbr></div><div class="product_txt_to_top_child"><abbr title="ALL">Please click on the file upload icon to add an attachment to your quote revision...</abbr></div></div></div></div><div style="padding-left:0!important;padding-right:5px!important" class="col-md-12 col-sm-12 col-xs-12 section_row_fld opport_info trans_hide enable_custom_fld transaction_summary_new quote_summary collapse in"><div class="col-md-5 col-sm-6 col-xs-12 property_label section_cust_fld_txt"><label style="display:inline-block">Attachment File Name</label></div><div class="col-md-7 col-sm-6 col-xs-12 property_value section_cust_fld_val"><span class="hint_icon_req"><i class="fa fa-info-circle autoClosePopover"></i> <span class="req-field mrg_lft_ft_lft" style="visibility:hidden">*</span></span> <span class="required" style="display:none">*</span><input type="text" id="input_file" class="form-control light_yellow" > <a target="_blank" class="oppo_link" id="tax_vat"></a><input type="image" src="/mt/APPLIEDMATERIALS_TST/Additionalfiles/Secondary Icon.svg" > <input type="file" id="my_file" style="display:none"> <i class="fa fa-lock" aria-hidden="true" style="font-size:13px;float:right;color:#cccaca!important"></i></div></div><button type="button" class="btnconfig" data-dismiss="modal" onclick="closepopup_scrl()">CANCEL</button> <button type="button" id="add-offerings" class="btnconfig" onclick="addOfferings()" data-dismiss="modal">SAVE</button><script> debugger;$("input[type=\'image\']").click(function() {$("input[id=\'my_file\']").click();});$("#my_file").change(function() {var file = $("#my_file")[0].files[0].name;$("#input_file").val(file);});</script>);'
