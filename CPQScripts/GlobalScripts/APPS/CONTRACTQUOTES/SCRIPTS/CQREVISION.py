...
def CreateNewRevision():
    if Quote is not None:
        ...
        quote_rev_data = {"QUOTE_REVISION_RECORD_ID": str(quote_revision_id),"QUOTE_ID": compositeNUmber,"QUOTE_NAME": contract_quote_data.get("contract_quote_data"),"QUOTE_RECORD_ID": ContractRecordId,"ACTIVE":1,"REV_CREATE_DATE":'',"REV_EXPIRE_DATE":'',"REVISION_STATUS":"IN-PROGRESS","QTEREV_ID":currentrevison,"REV_APPROVE_DATE":''}
