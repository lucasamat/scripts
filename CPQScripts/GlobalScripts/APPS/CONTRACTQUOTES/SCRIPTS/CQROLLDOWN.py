...
def CoveredObjEntitlement():
	...
	SAQSFE_query="""
		...
		WHERE SAQTSE.QUOTE_RECORD_ID = '{QuoteRecordId}' AND SAQTSE.SERVICE_ID = '{ServiceId}') IQ""".format(UserId=userId, QuoteRecordId=Qt_rec_id, ServiceId=TreeParam)
	...
	qtqtse_query="""
		...
		WHERE SAQTSE.QUOTE_RECORD_ID = '{QuoteRecordId}' AND SAQTSE.SERVICE_ID = '{ServiceId}') IQ JOIN SAQSFE (NOLOCK) M ON IQ.QTSFBLENT_RECORD_ID = QUOTE_SERVICE_FAB_LOC_ENT_RECORD_ID )OQ""".format(UserId=userId, QuoteRecordId=Qt_rec_id, ServiceId=TreeParam)
