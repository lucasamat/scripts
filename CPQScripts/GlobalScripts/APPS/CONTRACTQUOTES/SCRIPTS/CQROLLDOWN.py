...
#   __script_description : THIS SCRIPT IS USED FOR VALUE DRIVER ROLLDOWN (GETS TRIGGERED AFTER IFLOW SCRIPT - CQVLDRIFLW.py)
...
def ServiceGreenbookLevel():
	# ADD FAB COLUMNS and CHANGE TREE PARAMS
	# MERGE GREENBOOK ROLLDOWN 1520 SAQSCD (SAQSCO and SAQSGD)
	QueryStatement = """
	MERGE SAQSCD SRC USING ( SELECT A.QUOTE_SERVICE_COVERED_OBJECTS_RECORD_ID,A.EQUIPMENT_ID, A.EQUIPMENT_DESCRIPTION, A.	
	EQUIPMENT_RECORD_ID,A.SERVICE_ID,A.SERVICE_DESCRIPTION,A.SERVICE_RECORD_ID,A.QUOTE_ID,A.QUOTE_NAME,A.QUOTE_RECORD_ID,B.TOOL_VALUEDRIVER_ID,B.TOOL_VALUEDRIVER_RECORD_ID,B.GREENBOOK,B.GREENBOOK_RECORD_ID FROM SAQSCO (NOLOCK) A JOIN SAQSGD (NOLOCK) B ON A.QUOTE_RECORD_ID  = B.QUOTE_RECORD_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.GREENBOOK = B.GREENBOOK where B.QUOTE_RECORD_ID = '{rec}' AND B.SERVICE_ID = '{treeparentparam}' AND A.GREENBOOK = '{treeparam}') 
	TGT ON (SRC.QUOTE_RECORD_ID = TGT.QUOTE_RECORD_ID AND SRC.SERVICE_RECORD_ID = TGT.SERVICE_RECORD_ID AND SRC.VALUEDRIVER_ID =TGT.TOOL_VALUEDRIVER_ID AND SRC.QTESRVCOB_RECORD_ID = TGT.QUOTE_SERVICE_COVERED_OBJECTS_RECORD_ID AND SRC.GREENBOOK = TGT.GREENBOOK AND SRC.EQUIPMENT_ID = TGT.EQUIPMENT_ID)
	WHEN MATCHED 
	THEN UPDATE SET SRC.VALUEDRIVER_ID = TGT.TOOL_VALUEDRIVER_ID,SRC.VALUEDRIVER_RECORD_ID =TGT.TOOL_VALUEDRIVER_RECORD_ID,SRC.GREENBOOK = TGT.GREENBOOK
	WHEN NOT MATCHED BY TARGET
	THEN INSERT (GREENBOOK,GREENBOOK_RECORD_ID,QTESRVCOB_RECORD_ID,EQUIPMENT_ID,EQUIPMENT_DESCRIPTION, EQUIPMENT_RECORD_ID,QUOTE_RECORD_ID,SERVICE_ID,SERVICE_DESCRIPTION,SERVICE_RECORD_ID,QUOTE_ID,QUOTE_NAME,VALUEDRIVER_ID,VALUEDRIVER_RECORD_ID,QUOTE_SERVICE_COVERED_OBJ_TOOL_DRIVER_RECORD_ID,CPQTABLEENTRYDATEADDED, CPQTABLEENTRYADDEDBY, ADDUSR_RECORD_ID)
	VALUES (GREENBOOK,GREENBOOK_RECORD_ID,QUOTE_SERVICE_COVERED_OBJECTS_RECORD_ID,EQUIPMENT_ID,EQUIPMENT_DESCRIPTION, EQUIPMENT_RECORD_ID,QUOTE_RECORD_ID,SERVICE_ID,SERVICE_DESCRIPTION,SERVICE_RECORD_ID,QUOTE_ID,QUOTE_NAME,TOOL_VALUEDRIVER_ID,TOOL_VALUEDRIVER_RECORD_ID,NEWID(),'{datetimenow}', '{username}', {userid});""".format(
	rec=Qt_rec_id, datetimenow=datetime.datetime.now().strftime("%m/%d/%Y %H:%M:%S %p"), userid=userId, username=userName,
	treeparentparam=TreeParentParam,treeparam=TreeParam
	)
	Sql.RunQuery(QueryStatement)
	# MERGE GREENBOOK ROLLDOWN 1520 SAQSCV (SAQSCO and SAQSGV)
	QueryStatement = """
	MERGE SAQSCV SRC USING ( SELECT A.QUOTE_SERVICE_COVERED_OBJECTS_RECORD_ID,A.QUOTE_ID,A.QUOTE_NAME,A.QUOTE_RECORD_ID,B.TOOL_VALUEDRIVER_RECORD_ID,B.TOOL_VALUEDRIVER_ID,B.SERVICE_RECORD_ID,B.SERVICE_ID,B.SERVICE_DESCRIPTION,A.EQUIPMENT_ID,A.EQUIPMENT_RECORD_ID,A.EQUIPMENT_DESCRIPTION, B.TOOL_VALUEDRIVER_VALUE_DESCRIPTION,B.GREENBOOK, B.GREENBOOK_RECORD_ID,B.TOOL_VALUEDRIVER_VALUE_RECORD_ID,B.CpqTableEntryDateModified,B.CpqTableEntryModifiedBy,A.SERIAL_NO,B.TOOL_VALUEDRIVER_VALUE_CODE,B.VALUEDRIVER_COEFFICIENT,B.VALUEDRIVER_COEFFICIENT_RECORD_ID FROM SAQSCO (NOLOCK) A JOIN SAQSGV (NOLOCK) B ON A.QUOTE_RECORD_ID  = B.QUOTE_RECORD_ID AND A.SERVICE_ID = B.SERVICE_ID AND A.GREENBOOK = B.GREENBOOK WHERE B.QUOTE_RECORD_ID = '{rec}' AND B.SERVICE_ID = '{treeparentparam}' AND B.GREENBOOK = '{treeparam}') 
	TGT ON (SRC.QUOTE_RECORD_ID = TGT.QUOTE_RECORD_ID AND SRC.TOOL_VALUEDRIVER_ID = TGT.TOOL_VALUEDRIVER_ID AND SRC.SERVICE_ID = TGT.SERVICE_ID AND SRC.QTESRVCOB_RECORD_ID = TGT.QUOTE_SERVICE_COVERED_OBJECTS_RECORD_ID AND SRC.GREENBOOK = TGT.GREENBOOK AND SRC.EQUIPMENT_ID = TGT.EQUIPMENT_ID)
	WHEN MATCHED 
	THEN UPDATE SET SRC.TOOL_VALUEDRIVER_VALUE_DESCRIPTION = TGT.TOOL_VALUEDRIVER_VALUE_DESCRIPTION,SRC.TOOL_VALUEDRIVER_VALUE_RECORD_ID =TGT.TOOL_VALUEDRIVER_VALUE_RECORD_ID,SRC.CpqTableEntryModifiedBy = TGT.CpqTableEntryModifiedBy,SRC.CpqTableEntryDateModified = TGT.CpqTableEntryDateModified,SRC.TOOL_VALUEDRIVER_VALUE_CODE = TGT.TOOL_VALUEDRIVER_VALUE_CODE,SRC.VALUEDRIVER_COEFFICIENT_RECORD_ID = TGT.VALUEDRIVER_COEFFICIENT_RECORD_ID,SRC.VALUEDRIVER_COEFFICIENT = TGT.VALUEDRIVER_COEFFICIENT,SRC.GREENBOOK = TGT.GREENBOOK
	WHEN NOT MATCHED BY TARGET
		THEN INSERT (SERIAL_NUMBER,GREENBOOK, GREENBOOK_RECORD_ID,EQUIPMENT_ID,EQUIPMENT_RECORD_ID,EQUIPMENT_DESCRIPTION,QUOTE_SERVICE_COVERED_OBJ_TOOL_DRIVER_VALUE_RECORD_ID,QUOTE_ID,QTESRVCOB_RECORD_ID,QUOTE_NAME,QUOTE_RECORD_ID,SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,TOOL_VALUEDRIVER_ID,TOOL_VALUEDRIVER_RECORD_ID,TOOL_VALUEDRIVER_VALUE_DESCRIPTION,TOOL_VALUEDRIVER_VALUE_RECORD_ID,TOOL_VALUEDRIVER_VALUE_CODE,VALUEDRIVER_COEFFICIENT_RECORD_ID,VALUEDRIVER_COEFFICIENT,CPQTABLEENTRYDATEADDED, CPQTABLEENTRYADDEDBY, ADDUSR_RECORD_ID, CpqTableEntryModifiedBy,CpqTableEntryDateModified)
		VALUES (SERIAL_NO,GREENBOOK, GREENBOOK_RECORD_ID,EQUIPMENT_ID,EQUIPMENT_RECORD_ID,EQUIPMENT_DESCRIPTION,NEWID(),QUOTE_ID,QUOTE_SERVICE_COVERED_OBJECTS_RECORD_ID,QUOTE_NAME,QUOTE_RECORD_ID,	SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,TOOL_VALUEDRIVER_ID,TOOL_VALUEDRIVER_RECORD_ID,TOOL_VALUEDRIVER_VALUE_DESCRIPTION,TOOL_VALUEDRIVER_VALUE_RECORD_ID,TOOL_VALUEDRIVER_VALUE_CODE,VALUEDRIVER_COEFFICIENT_RECORD_ID,VALUEDRIVER_COEFFICIENT,'{datetimenow}', '{username}', {userid}, {userid}, '{datetimenow}');""".format(
	rec=Qt_rec_id, datetimenow=datetime.datetime.now().strftime("%m/%d/%Y %H:%M:%S %p"), userid=userId, username=userName,
	treeparentparam=TreeParentParam,treeparam=TreeParam
	)
	Sql.RunQuery(QueryStatement)
...
def ServiceLevel():
	#MERGE SAQSFB SAQSFD QTQSFV
	#NEED TO ADD FAB COLUMNS FOR SAQSGB, GD, GV
	...
	+ " SAQSGB (SERVICE_ID,SERVICE_DESCRIPTION,SERVICE_RECORD_ID,GREENBOOK,GREENBOOK_RECORD_ID,QUOTE_ID,QUOTE_NAME,QUOTE_RECORD_ID,SALESORG_ID,SALESORG_NAME,SALESORG_RECORD_ID,CpqTableEntryDateModified,QUOTE_SERVICE_GREENBOOK_RECORD_ID) SELECT A. *,getdate(),CONVERT(VARCHAR(4000),NEWID()) FROM (SELECT DISTINCT A.SERVICE_ID,A.SERVICE_DESCRIPTION,A.SERVICE_RECORD_ID,A.GREENBOOK,A.GREENBOOK_RECORD_ID,A.QUOTE_ID,A.QUOTE_NAME,A.QUOTE_RECORD_ID,A.SALESORG_ID,A.SALESORG_NAME,A.SALESORG_RECORD_ID FROM SAQSCO A left join QTQSGB b on a.QUOTE_RECORD_ID = ''"+str(Qt_rec_id)+"'' and a.QUOTE_ID =b.QUOTE_ID and a.SERVICE_RECORD_ID =b.SERVICE_RECORD_ID AND A.GREENBOOK = b.GREENBOOK WHERE b.QUOTE_ID IS NULL )A ' " )
	# MERGE SAQSGD USING QTQSGB AND SAQSVD - GREENBOOK ROLLDOWN 1520
	QueryStatement = """
	MERGE SAQSGD SRC USING ( SELECT A.SERVICE_ID,A.SERVICE_DESCRIPTION,A.SERVICE_RECORD_ID,A.QUOTE_ID,A.QUOTE_NAME,A.QUOTE_RECORD_ID,A.GREENBOOK, A.GREENBOOK_RECORD_ID,B.TOOL_VALUEDRIVER_ID,B.TOOL_VALUEDRIVER_RECORD_ID FROM QTQSGB(NOLOCK) A JOIN SAQSVD (NOLOCK) B ON A.QUOTE_RECORD_ID  = B.QUOTE_RECORD_ID AND A.SERVICE_ID = B.SERVICE_ID where B.QUOTE_RECORD_ID = '{rec}' AND B.SERVICE_ID = '{treeparam}') 
	TGT ON (SRC.QUOTE_RECORD_ID = TGT.QUOTE_RECORD_ID AND SRC.SERVICE_ID = TGT.SERVICE_ID AND SRC.TOOL_VALUEDRIVER_ID =TGT.TOOL_VALUEDRIVER_ID AND SRC.GREENBOOK = TGT.GREENBOOK)
	WHEN MATCHED 
	THEN UPDATE SET SRC.TOOL_VALUEDRIVER_ID = TGT.TOOL_VALUEDRIVER_ID,SRC.TOOL_VALUEDRIVER_RECORD_ID =TGT.TOOL_VALUEDRIVER_RECORD_ID
	WHEN NOT MATCHED BY TARGET
	THEN INSERT (QUOTE_RECORD_ID,SERVICE_ID,SERVICE_DESCRIPTION,SERVICE_RECORD_ID,QUOTE_ID,QUOTE_NAME,TOOL_VALUEDRIVER_ID,TOOL_VALUEDRIVER_RECORD_ID,GREENBOOK,GREENBOOK_RECORD_ID,QUOTE_SERVICE_GREENBOOK_VAL_DRV_RECORD_ID,CPQTABLEENTRYDATEADDED, CPQTABLEENTRYADDEDBY, ADDUSR_RECORD_ID, CpqTableEntryModifiedBy,CpqTableEntryDateModified)
	VALUES (QUOTE_RECORD_ID,SERVICE_ID,SERVICE_DESCRIPTION,SERVICE_RECORD_ID,QUOTE_ID,QUOTE_NAME,TOOL_VALUEDRIVER_ID,TOOL_VALUEDRIVER_RECORD_ID,GREENBOOK,GREENBOOK_RECORD_ID,NEWID(),'{datetimenow}', '{username}', {userid}, {userid}, '{datetimenow}');""".format(
	...
	QueryStatement = """
	MERGE SAQSGV SRC USING ( SELECT A.QUOTE_ID,A.QUOTE_NAME,A.QUOTE_RECORD_ID,B.TOOL_VALUEDRIVER_RECORD_ID,B.TOOL_VALUEDRIVER_ID,B.SERVICE_RECORD_ID,B.SERVICE_ID,B.SERVICE_DESCRIPTION,A.GREENBOOK,A.GREENBOOK_RECORD_ID,B.TOOL_VALUEDRIVER_VALUE_DESCRIPTION,B.TOOL_VALUEDRIVER_VALUE_RECORD_ID,B.CpqTableEntryDateModified,B.CpqTableEntryModifiedBy,B.TOOL_VALUEDRIVER_VALUE_CODE,B.VALUEDRIVER_COEFFICIENT,B.VALUEDRIVER_COEFFICIENT_RECORD_ID FROM SAQSGB (NOLOCK) A JOIN SAQSDV (NOLOCK) B ON A.QUOTE_RECORD_ID  = B.QUOTE_RECORD_ID AND A.SERVICE_ID = B.SERVICE_ID WHERE B.QUOTE_RECORD_ID = '{rec}' AND B.SERVICE_ID = '{treeparam}' ) 
	TGT ON (SRC.QUOTE_RECORD_ID = TGT.QUOTE_RECORD_ID AND SRC.TOOL_VALUEDRIVER_ID = TGT.TOOL_VALUEDRIVER_ID AND SRC.SERVICE_ID = TGT.SERVICE_ID AND SRC.GREENBOOK = TGT.GREENBOOK)
	WHEN MATCHED 
	...
	WHEN NOT MATCHED BY TARGET
		THEN INSERT (QUOTE_SERVICE_GBK_VAL_DRV_VAL_RECORD_ID,QUOTE_ID,QUOTE_NAME,QUOTE_RECORD_ID,SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,GREENBOOK,GREENBOOK_RECORD_ID,TOOL_VALUEDRIVER_ID,TOOL_VALUEDRIVER_RECORD_ID,TOOL_VALUEDRIVER_VALUE_DESCRIPTION,TOOL_VALUEDRIVER_VALUE_RECORD_ID,TOOL_VALUEDRIVER_VALUE_CODE,VALUEDRIVER_COEFFICIENT_RECORD_ID,VALUEDRIVER_COEFFICIENT,CPQTABLEENTRYDATEADDED, CPQTABLEENTRYADDEDBY, ADDUSR_RECORD_ID, CpqTableEntryModifiedBy,CpqTableEntryDateModified)
		VALUES (NEWID(),QUOTE_ID,QUOTE_NAME,QUOTE_RECORD_ID,	SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,GREENBOOK,GREENBOOK_RECORD_ID,TOOL_VALUEDRIVER_ID,TOOL_VALUEDRIVER_RECORD_ID,TOOL_VALUEDRIVER_VALUE_DESCRIPTION,TOOL_VALUEDRIVER_VALUE_RECORD_ID,TOOL_VALUEDRIVER_VALUE_CODE,VALUEDRIVER_COEFFICIENT_RECORD_ID,VALUEDRIVER_COEFFICIENT,'{datetimenow}', '{username}', {userid}, {userid}, '{datetimenow}');""".format(
	rec=Qt_rec_id, datetimenow=datetime.datetime.now().strftime("%m/%d/%Y %H:%M:%S %p"), userid=userId, username=userName,treeparam=TreeParam
	)
	Sql.RunQuery(QueryStatement)
	# ADD FAB COLUMNS, GREENBOOK KEY (SAQSGB KEY)
	QueryStatement = """
	MERGE SAQSCD SRC USING ( SELECT A.EQUIPMENT_DESCRIPTION,A.EQUIPMENT_ID,A.EQUIPMENT_RECORD_ID,A.QUOTE_ID,A.QUOTE_NAME,A.QUOTE_RECORD_ID,B.TOOL_VALUEDRIVER_RECORD_ID,A.QUOTE_SERVICE_COVERED_OBJECTS_RECORD_ID,B.TOOL_VALUEDRIVER_ID,B.SERVICE_RECORD_ID,B.SERVICE_ID,B.SERVICE_DESCRIPTION,A.GREENBOOK,A.GREENBOOK_RECORD_ID,B.CpqTableEntryDateModified,B.CpqTableEntryModifiedBy,A.SERIAL_NO FROM SAQSCO(NOLOCK) A JOIN SAQSVD (NOLOCK) B ON A.QUOTE_RECORD_ID  = B.QUOTE_RECORD_ID  AND A.SERVICE_ID = B.SERVICE_ID where B.QUOTE_RECORD_ID = '{rec}' and B.SERVICE_ID = '{treeparam}')
	TGT ON (SRC.QUOTE_RECORD_ID = TGT.QUOTE_RECORD_ID AND SRC.QTESRVCOB_RECORD_ID = TGT.QUOTE_SERVICE_COVERED_OBJECTS_RECORD_ID AND SRC.VALUEDRIVER_ID = TGT.TOOL_VALUEDRIVER_ID AND SRC.SERVICE_ID = TGT.SERVICE_ID)
	WHEN MATCHED 
	THEN UPDATE SET SRC.VALUEDRIVER_RECORD_ID = TGT.TOOL_VALUEDRIVER_RECORD_ID,SRC.VALUEDRIVER_ID =TGT.TOOL_VALUEDRIVER_ID,SRC.CpqTableEntryModifiedBy = TGT.CpqTableEntryModifiedBy,SRC.CpqTableEntryDateModified = TGT.CpqTableEntryDateModified,SRC.GREENBOOK = TGT.GREENBOOK,SRC.GREENBOOK_RECORD_ID=TGT.GREENBOOK_RECORD_ID
	WHEN NOT MATCHED BY TARGET
			THEN INSERT (GREENBOOK, GREENBOOK_RECORD_ID,QUOTE_SERVICE_COVERED_OBJ_TOOL_DRIVER_RECORD_ID,EQUIPMENT_DESCRIPTION,EQUIPMENT_ID,EQUIPMENT_RECORD_ID,QUOTE_ID,QUOTE_NAME,QUOTE_RECORD_ID,SERIAL_NUMBER,SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,VALUEDRIVER_ID,VALUEDRIVER_RECORD_ID,QTESRVCOB_RECORD_ID,CPQTABLEENTRYDATEADDED, CPQTABLEENTRYADDEDBY, ADDUSR_RECORD_ID, CpqTableEntryModifiedBy,CpqTableEntryDateModified )
			VALUES (GREENBOOK, GREENBOOK_RECORD_ID,NEWID(),EQUIPMENT_DESCRIPTION,EQUIPMENT_ID,EQUIPMENT_RECORD_ID,QUOTE_ID,QUOTE_NAME,QUOTE_RECORD_ID,SERIAL_NO,SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,TOOL_VALUEDRIVER_ID,TOOL_VALUEDRIVER_RECORD_ID,QUOTE_SERVICE_COVERED_OBJECTS_RECORD_ID,'{datetimenow}', '{username}', {userid}, {userid}, '{datetimenow}');""".format(
		rec=Qt_rec_id, datetimenow=datetime.datetime.now().strftime("%m/%d/%Y %H:%M:%S %p"), userid=userId, username=userName,treeparam=TreeParam
	)
	Sql.RunQuery(QueryStatement)
	QueryStatement = """
	MERGE SAQSCV SRC USING ( SELECT A.EQUIPMENT_DESCRIPTION,A.EQUIPMENT_ID,A.EQUIPMENT_RECORD_ID,A.QUOTE_ID,A.QUOTE_NAME,A.QUOTE_RECORD_ID,B.TOOL_VALUEDRIVER_RECORD_ID,A.QUOTE_SERVICE_COVERED_OBJECTS_RECORD_ID,B.TOOL_VALUEDRIVER_ID,B.SERVICE_RECORD_ID,B.SERVICE_ID,B.SERVICE_DESCRIPTION,A.GREENBOOK,A.GREENBOOK_RECORD_ID,B.TOOL_VALUEDRIVER_VALUE_DESCRIPTION,B.TOOL_VALUEDRIVER_VALUE_RECORD_ID,B.CpqTableEntryDateModified,B.CpqTableEntryModifiedBy,A.SERIAL_NO,B.TOOL_VALUEDRIVER_VALUE_CODE,B.VALUEDRIVER_COEFFICIENT,B.VALUEDRIVER_COEFFICIENT_RECORD_ID FROM SAQSCO(NOLOCK) A JOIN SAQSDV (NOLOCK) B ON A.QUOTE_RECORD_ID  = B.QUOTE_RECORD_ID AND A.SERVICE_ID = B.SERVICE_ID where B.QUOTE_RECORD_ID = '{rec}' and B.SERVICE_ID = '{treeparam}') 
	TGT ON (SRC.QUOTE_RECORD_ID = TGT.QUOTE_RECORD_ID AND SRC.QTESRVCOB_RECORD_ID = TGT.QUOTE_SERVICE_COVERED_OBJECTS_RECORD_ID AND SRC.TOOL_VALUEDRIVER_ID = TGT.TOOL_VALUEDRIVER_ID AND SRC.SERVICE_ID = TGT.SERVICE_ID)
	WHEN MATCHED 
...
def CoveredObjEntitlement():
	...
	Log.Info('136----')
	SAQSFE_query="""
		INSERT SAQSFE (ENTITLEMENT_XML,QUOTE_ID,QUOTE_NAME,QUOTE_RECORD_ID,QTEREV_RECORD_ID,SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,SALESORG_ID,SALESORG_NAME,SALESORG_RECORD_ID,	
		CPS_CONFIGURATION_ID, CPS_MATCH_ID,QTESRVENT_RECORD_ID,FABLOCATION_ID,FABLOCATION_NAME,FABLOCATION_RECORD_ID,QTESRVFBL_RECORD_ID,QUOTE_SERVICE_FAB_LOC_ENT_RECORD_ID, CPQTABLEENTRYADDEDBY,CPQTABLEENTRYDATEADDED)
	...
	qtqtse_query="""
		INSERT SAQSGE (KB_VERSION,QUOTE_ID,QUOTE_NAME,QUOTE_RECORD_ID,QTEREV_RECORD_ID,SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,SALESORG_ID,SALESORG_NAME,SALESORG_RECORD_ID,	
	...
	Log.Info("qtqtse_query---163------"+str(qtqtse_query))
	Sql.RunQuery(qtqtse_query)
	#ENTITLEMENT SV TO CE
	qtqsce_query="""
		INSERT SAQSCE
		(KB_VERSION,ENTITLEMENT_XML,EQUIPMENT_ID,EQUIPMENT_RECORD_ID,QUOTE_ID,QUOTE_RECORD_ID,QTEREV_RECORD_ID,QTESRVCOB_RECORD_ID,QTESRVENT_RECORD_ID,SERIAL_NO,SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,CPS_CONFIGURATION_ID,CPS_MATCH_ID,GREENBOOK,GREENBOOK_RECORD_ID,FABLOCATION_ID,FABLOCATION_NAME,FABLOCATION_RECORD_ID,SALESORG_ID,SALESORG_NAME,SALESORG_RECORD_ID,QUOTE_SERVICE_COVERED_OBJ_ENTITLEMENTS_RECORD_ID,CPQTABLEENTRYADDEDBY,CPQTABLEENTRYDATEADDED) 
	...
	'''SAQIEN = """INSERT SAQIEN 
		...
		) IQ""".format(UserId=User.Id, configurationId=configurationId, cpsmatchId='11', ContractId=Qt_rec_id, serviceId=TreeParam,ContractRecordId=ContractRecordId,en_xml = insertservice)
			
	Sql.RunQuery(SAQIEN)
	Log.Info('SAQIEN--196--renewal-427--'+str(SAQIEN))'''
	#querystmt = SqlHelper.GetFirst("sp_executesql @T=N'INSERT SAQSAE (KB_VERSION,EQUIPMENT_ID,EQUIPMENT_RECORD_ID,QUOTE_ID,QUOTE_RECORD_ID,SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,CPS_CONFIGURATION_ID,CPS_MATCH_ID,GREENBOOK,GREENBOOK_RECORD_ID,FABLOCATION_ID,FABLOCATION_NAME,FABLOCATION_RECORD_ID,ASSEMBLY_DESCRIPTION,ASSEMBLY_ID,ASSEMBLY_RECORD_ID,QTESRVCOA_RECORD_ID,SALESORG_ID,SALESORG_NAME,SALESORG_RECORD_ID,ENTITLEMENT_XML,QTESRVCOE_RECORD_ID,QUOTE_SERVICE_COV_OBJ_ASS_ENT_RECORD_ID,CPQTABLEENTRYADDEDBY,CPQTABLEENTRYDATEADDED) SELECT IQ.*, CONVERT(VARCHAR(4000),NEWID()) as QUOTE_SERVICE_COV_OBJ_ASS_ENT_RECORD_ID, ''"+str(User.Id)+"'' as CPQTABLEENTRYADDEDBY, GETDATE() as CPQTABLEENTRYDATEADDED FROM(SELECT IQ.*,M.ENTITLEMENT_XML,M.QUOTE_SERVICE_COVERED_OBJ_ENTITLEMENTS_RECORD_ID as QTESRVCOE_RECORD_ID FROM ( SELECT DISTINCT SAQTSE.KB_VERSION,SAQSCA.EQUIPMENT_ID,SAQSCA.EQUIPMENT_RECORD_ID,SAQTSE.QUOTE_ID,SAQTSE.QUOTE_RECORD_ID,SAQTSE.SERVICE_DESCRIPTION,SAQTSE.SERVICE_ID,SAQTSE.SERVICE_RECORD_ID,SAQTSE.CPS_CONFIGURATION_ID,SAQTSE.CPS_MATCH_ID,SAQSCA.GREENBOOK,SAQSCA.GREENBOOK_RECORD_ID,SAQSCA.FABLOCATION_ID,SAQSCA.FABLOCATION_NAME,SAQSCA.FABLOCATION_RECORD_ID,SAQSCA.ASSEMBLY_DESCRIPTION,SAQSCA.ASSEMBLY_ID,SAQSCA.ASSEMBLY_RECORD_ID,SAQSCA.QUOTE_SERVICE_COVERED_OBJECT_ASSEMBLIES_RECORD_ID as QTESRVCOA_RECORD_ID,SAQTSE.SALESORG_ID,SAQTSE.SALESORG_NAME,SAQTSE.SALESORG_RECORD_ID FROM SAQTSE (NOLOCK) JOIN (SELECT * FROM SAQSCA (NOLOCK) WHERE SAQSCA.QUOTE_RECORD_ID = ''"+str(Qt_rec_id)+"'' ) SAQSCA ON SAQTSE.QUOTE_RECORD_ID = SAQSCA.QUOTE_RECORD_ID AND SAQTSE.SERVICE_RECORD_ID = SAQSCA.SERVICE_RECORD_ID WHERE SAQTSE.QUOTE_RECORD_ID = ''"+str(Qt_rec_id)+"'' AND SAQTSE.SERVICE_ID = ''"+str(TreeParam)+"'') IQ JOIN SAQSCE (NOLOCK) M ON M.SERVICE_RECORD_ID = IQ.SERVICE_RECORD_ID AND M.QUOTE_RECORD_ID = IQ.QUOTE_RECORD_ID AND M.EQUIPMENT_ID = IQ.EQUIPMENT_ID )IQ '")
	"""SAQSAE_query
		INSERT SAQSAE(KB_VERSION,EQUIPMENT_ID,EQUIPMENT_RECORD_ID,QUOTE_ID,QUOTE_RECORD_ID,SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,CPS_CONFIGURATION_ID,CPS_MATCH_ID,GREENBOOK,GREENBOOK_RECORD_ID,FABLOCATION_ID,FABLOCATION_NAME,FABLOCATION_RECORD_ID,ASSEMBLY_DESCRIPTION,ASSEMBLY_ID,ASSEMBLY_RECORD_ID,QTESRVCOA_RECORD_ID,QTESRVCOE_RECORD_ID,SALESORG_ID,SALESORG_NAME,SALESORG_RECORD_ID,ENTITLEMENT_XML,QUOTE_SERVICE_COV_OBJ_ASS_ENT_RECORD_ID,CPQTABLEENTRYADDEDBY,CPQTABLEENTRYDATEADDED) 
		SELECT IQ.*, CONVERT(VARCHAR(4000),NEWID()) as QUOTE_SERVICE_COV_OBJ_ASS_ENT_RECORD_ID, {UserId} as CPQTABLEENTRYADDEDBY, GETDATE() as CPQTABLEENTRYDATEADDED FROM (SELECT IQ.*,M.ENTITLEMENT_XML FROM (
		SELECT 
		DISTINCT
		SAQTSE.KB_VERSION,SAQSCA.EQUIPMENT_ID,SAQSCA.EQUIPMENT_RECORD_ID,SAQTSE.QUOTE_ID,SAQTSE.QUOTE_RECORD_ID,SAQTSE.SERVICE_DESCRIPTION,SAQTSE.SERVICE_ID,SAQTSE.SERVICE_RECORD_ID,SAQTSE.CPS_CONFIGURATION_ID,SAQTSE.CPS_MATCH_ID,SAQSCA.GREENBOOK,SAQSCA.GREENBOOK_RECORD_ID,SAQSCA.FABLOCATION_ID,SAQSCA.FABLOCATION_NAME,SAQSCA.FABLOCATION_RECORD_ID,SAQSCA.ASSEMBLY_DESCRIPTION,SAQSCA.ASSEMBLY_ID,SAQSCA.ASSEMBLY_RECORD_ID,SAQSCA.QUOTE_SERVICE_COVERED_OBJECT_ASSEMBLIES_RECORD_ID as QTESRVCOA_RECORD_ID,SAQSCE.QUOTE_SERVICE_COVERED_OBJ_ENTITLEMENTS_RECORD_ID as QTESRVCOE_RECORD_ID,SAQTSE.SALESORG_ID,SAQTSE.SALESORG_NAME,SAQTSE.SALESORG_RECORD_ID
		FROM 
		SAQTSE (NOLOCK)
		JOIN (SELECT * FROM SAQSCA (NOLOCK) WHERE SAQSCA.QUOTE_RECORD_ID = '{QuoteRecordId}' ) SAQSCA (NOLOCK) ON SAQSCA.SERVICE_RECORD_ID = SAQTSE.SERVICE_RECORD_ID AND SAQSCA.QUOTE_RECORD_ID = SAQTSE.QUOTE_RECORD_ID 
		JOIN SAQSCE (NOLOCK) ON SAQSCE.SERVICE_RECORD_ID = SAQSCA.SERVICE_RECORD_ID AND SAQSCE.QUOTE_RECORD_ID = SAQSCA.QUOTE_RECORD_ID AND SAQSCE.EQUIPMENT_ID = SAQSCA.EQUIPMENT_ID AND SAQSCE.FABLOCATION_ID = SAQSCA.FABLOCATION_ID AND SAQSCE.GREENBOOK = SAQSCA.GREENBOOK 
		WHERE SAQTSE.QUOTE_RECORD_ID = '{QuoteRecordId}' AND SAQTSE.SERVICE_ID = '{ServiceId}' ) IQ JOIN SAQSCE (NOLOCK) M ON IQ.QTESRVCOE_RECORD_ID = QUOTE_SERVICE_COVERED_OBJ_ENTITLEMENTS_RECORD_ID )IQ .format(
		UserId=User.Id, 
		QuoteRecordId=Qt_rec_id, 
		ServiceId=TreeParam)
		
	Sql.RunQuery(SAQSAE_query)"""
	#Log.Info('SAQSAE_query----'+str("""INSERT SAQSAE (KB_VERSION,EQUIPMENT_ID,EQUIPMENT_RECORD_ID,QUOTE_ID,QUOTE_RECORD_ID,SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,CPS_CONFIGURATION_ID,CPS_MATCH_ID,GREENBOOK,GREENBOOK_RECORD_ID,FABLOCATION_ID,FABLOCATION_NAME,FABLOCATION_RECORD_ID,ASSEMBLY_DESCRIPTION,ASSEMBLY_ID,ASSEMBLY_RECORD_ID,QTESRVCOA_RECORD_ID,SALESORG_ID,SALESORG_NAME,SALESORG_RECORD_ID,ENTITLEMENT_XML,QTESRVCOE_RECORD_ID,QUOTE_SERVICE_COV_OBJ_ASS_ENT_RECORD_ID,CPQTABLEENTRYADDEDBY,CPQTABLEENTRYDATEADDED) SELECT IQ.*, CONVERT(VARCHAR(4000),NEWID()) as QUOTE_SERVICE_COV_OBJ_ASS_ENT_RECORD_ID, '"+str(User.Id)+"' as CPQTABLEENTRYADDEDBY, GETDATE() as CPQTABLEENTRYDATEADDED FROM(SELECT IQ.*,M.ENTITLEMENT_XML,M.QUOTE_SERVICE_COVERED_OBJ_ENTITLEMENTS_RECORD_ID as QTESRVCOE_RECORD_ID FROM ( SELECT DISTINCT SAQTSE.KB_VERSION,SAQSCA.EQUIPMENT_ID,SAQSCA.EQUIPMENT_RECORD_ID,SAQTSE.QUOTE_ID,SAQTSE.QUOTE_RECORD_ID,SAQTSE.SERVICE_DESCRIPTION,SAQTSE.SERVICE_ID,SAQTSE.SERVICE_RECORD_ID,SAQTSE.CPS_CONFIGURATION_ID,SAQTSE.CPS_MATCH_ID,SAQSCA.GREENBOOK,SAQSCA.GREENBOOK_RECORD_ID,SAQSCA.FABLOCATION_ID,SAQSCA.FABLOCATION_NAME,SAQSCA.FABLOCATION_RECORD_ID,SAQSCA.ASSEMBLY_DESCRIPTION,SAQSCA.ASSEMBLY_ID,SAQSCA.ASSEMBLY_RECORD_ID,SAQSCA.QUOTE_SERVICE_COVERED_OBJECT_ASSEMBLIES_RECORD_ID as QTESRVCOA_RECORD_ID,SAQTSE.SALESORG_ID,SAQTSE.SALESORG_NAME,SAQTSE.SALESORG_RECORD_ID FROM SAQTSE (NOLOCK) JOIN (SELECT * FROM SAQSCA (NOLOCK) WHERE SAQSCA.QUOTE_RECORD_ID = '"+str(Qt_rec_id)+"' ) SAQSCA ON SAQTSE.QUOTE_RECORD_ID = SAQSCA.QUOTE_RECORD_ID AND SAQTSE.SERVICE_RECORD_ID = SAQSCA.SERVICE_RECORD_ID WHERE SAQTSE.QUOTE_RECORD_ID = '"+str(Qt_rec_id)+"' AND SAQTSE.SERVICE_ID = '"+str(TreeParam)+"') IQ JOIN SAQSCE (NOLOCK) M ON M.SERVICE_RECORD_ID = IQ.SERVICE_RECORD_ID AND M.QUOTE_RECORD_ID = IQ.QUOTE_RECORD_ID AND M.EQUIPMENT_ID = IQ.EQUIPMENT_ID )IQ"""))
	level = ""
...
def CoveredObjItemEntitlement():
	...
	SAQIEN_query = """
				INSERT SAQIEN 
				(KB_VERSION,ENTITLEMENT_XML,EQUIPMENT_ID,EQUIPMENT_RECORD_ID,LINE_ITEM_ID,QUOTE_ID,QTEITMCOB_RECORD_ID,QTEITM_RECORD_ID,	
	...
	#Log.Info("SAQSAE_query---231-----sp_executesql @T=N'INSERT SAQSAE (KB_VERSION,EQUIPMENT_ID,EQUIPMENT_RECORD_ID,QUOTE_ID,QUOTE_RECORD_ID,SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,CPS_CONFIGURATION_ID,CPS_MATCH_ID,GREENBOOK,GREENBOOK_RECORD_ID,FABLOCATION_ID,FABLOCATION_NAME,FABLOCATION_RECORD_ID,ASSEMBLY_DESCRIPTION,ASSEMBLY_ID,ASSEMBLY_RECORD_ID,QTESRVCOA_RECORD_ID,SALESORG_ID,SALESORG_NAME,SALESORG_RECORD_ID,ENTITLEMENT_XML,QTESRVCOE_RECORD_ID,QUOTE_SERVICE_COV_OBJ_ASS_ENT_RECORD_ID,CPQTABLEENTRYADDEDBY,CPQTABLEENTRYDATEADDED) SELECT IQ.*, CONVERT(VARCHAR(4000),NEWID()) as QUOTE_SERVICE_COV_OBJ_ASS_ENT_RECORD_ID, ''"+str(User.Id)+"'' as CPQTABLEENTRYADDEDBY, GETDATE() as CPQTABLEENTRYDATEADDED FROM(SELECT IQ.*,M.ENTITLEMENT_XML,M.QUOTE_SERVICE_COVERED_OBJ_ENTITLEMENTS_RECORD_ID as QTESRVCOE_RECORD_ID FROM ( SELECT DISTINCT SAQTSE.KB_VERSION,SAQSCA.EQUIPMENT_ID,SAQSCA.EQUIPMENT_RECORD_ID,SAQTSE.QUOTE_ID,SAQTSE.QUOTE_RECORD_ID,SAQTSE.SERVICE_DESCRIPTION,SAQTSE.SERVICE_ID,SAQTSE.SERVICE_RECORD_ID,SAQTSE.CPS_CONFIGURATION_ID,SAQTSE.CPS_MATCH_ID,SAQSCA.GREENBOOK,SAQSCA.GREENBOOK_RECORD_ID,SAQSCA.FABLOCATION_ID,SAQSCA.FABLOCATION_NAME,SAQSCA.FABLOCATION_RECORD_ID,SAQSCA.ASSEMBLY_DESCRIPTION,SAQSCA.ASSEMBLY_ID,SAQSCA.ASSEMBLY_RECORD_ID,SAQSCA.QUOTE_SERVICE_COVERED_OBJECT_ASSEMBLIES_RECORD_ID as QTESRVCOA_RECORD_ID,SAQTSE.SALESORG_ID,SAQTSE.SALESORG_NAME,SAQTSE.SALESORG_RECORD_ID FROM SAQTSE (NOLOCK) JOIN (SELECT * FROM SAQSCA (NOLOCK) WHERE SAQSCA.QUOTE_RECORD_ID = ''"+str(Qt_rec_id)+"'' ) SAQSCA ON SAQTSE.QUOTE_RECORD_ID = SAQSCA.QUOTE_RECORD_ID AND SAQTSE.SERVICE_RECORD_ID = SAQSCA.SERVICE_RECORD_ID WHERE SAQTSE.QUOTE_RECORD_ID = ''"+str(Qt_rec_id)+"'' AND SAQTSE.SERVICE_ID = ''"+str(TreeParam)+"'') IQ JOIN SAQSCE (NOLOCK) M ON M.SERVICE_RECORD_ID = IQ.SERVICE_RECORD_ID AND M.QUOTE_RECORD_ID = IQ.QUOTE_RECORD_ID AND M.EQUIPMENT_ID = IQ.EQUIPMENT_ID )IQ '")
	...
	for ProductPartnumber in ProductPart:
		...
		if ProductVersionObj is not None:
			...
			for attrs in attributesallowedlst:
				...
				</QUOTE_ITEM_ENTITLEMENT>""".format(ent_name = str(attrs),ent_val_code = attributevalues[attrs] if HasDefaultvalue==True else '',ent_type = DTypeset[PRODUCT_ATTRIBUTES.ATT_DISPLAY_DESC] if PRODUCT_ATTRIBUTES else  '',ent_desc = ATTRIBUTE_DEFN.STANDARD_ATTRIBUTE_NAME,ent_disp_val = STANDARD_ATTRIBUTE_VALUES.STANDARD_ATTRIBUTE_DISPLAY_VAL if HasDefaultvalue==True else '',ct = '',pi = '',is_default = '1',pm = '',cf = '')
			SAQSFE_query="""
				...
				WHERE SAQTSE.QUOTE_RECORD_ID = '{QuoteRecordId}' AND SAQTSE.SERVICE_ID = '{ServiceId}') IQ""".format(UserId=User.Id, QuoteRecordId=ContractRecordId, ServiceId=ProductPartnumber,en_xml = insertservice)
			...
			qtqtse_query="""
				...
				WHERE SAQTSE.QUOTE_RECORD_ID = '{QuoteRecordId}' AND SAQTSE.SERVICE_ID = '{ServiceId}') IQ JOIN SAQSFE (NOLOCK) M ON IQ.QTSFBLENT_RECORD_ID = QUOTE_SERVICE_FAB_LOC_ENT_RECORD_ID )OQ""".format(UserId=User.Id, QuoteRecordId=ContractRecordId, ServiceId=ProductPartnumber,en_xml = insertservice)
			...
			) IQ""".format(UserId=User.Id, configurationId=configurationId, cpsmatchId = '11', ContractId=Qt_rec_id, serviceId=ProductPartnumber,ContractRecordId=ContractRecordId,en_xml = insertservice)
			#Log.Info("--378----qtqsce--renewal-"+str(qtqsce))
			Sql.RunQuery(qtqsce)
			#Log.Info('insertservice----'+str(insertservice))
			
			SAQSAE_ent_renewal = """INSERT SAQSAE (KB_VERSION,EQUIPMENT_ID,EQUIPMENT_RECORD_ID,QUOTE_ID,QUOTE_RECORD_ID,SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,CPS_CONFIGURATION_ID,CPS_MATCH_ID,GREENBOOK,GREENBOOK_RECORD_ID,FABLOCATION_ID,FABLOCATION_NAME,FABLOCATION_RECORD_ID,ASSEMBLY_DESCRIPTION,ASSEMBLY_ID,ASSEMBLY_RECORD_ID,QTESRVCOA_RECORD_ID,SALESORG_ID,SALESORG_NAME,SALESORG_RECORD_ID,ENTITLEMENT_XML,QTESRVCOE_RECORD_ID,QUOTE_SERVICE_COV_OBJ_ASS_ENT_RECORD_ID,CPQTABLEENTRYADDEDBY,CPQTABLEENTRYDATEADDED) SELECT IQ.*, CONVERT(VARCHAR(4000),NEWID()) as QUOTE_SERVICE_COV_OBJ_ASS_ENT_RECORD_ID, {UserId} as CPQTABLEENTRYADDEDBY, GETDATE() as CPQTABLEENTRYDATEADDED FROM(SELECT IQ.*,M.ENTITLEMENT_XML,M.QUOTE_SERVICE_COVERED_OBJ_ENTITLEMENTS_RECORD_ID as QTESRVCOE_RECORD_ID FROM ( SELECT DISTINCT SAQTSE.KB_VERSION,SAQSCA.EQUIPMENT_ID,SAQSCA.EQUIPMENT_RECORD_ID,SAQTSE.QUOTE_ID,SAQTSE.QUOTE_RECORD_ID,SAQTSE.SERVICE_DESCRIPTION,SAQTSE.SERVICE_ID,SAQTSE.SERVICE_RECORD_ID,SAQTSE.CPS_CONFIGURATION_ID,SAQTSE.CPS_MATCH_ID,SAQSCA.GREENBOOK,SAQSCA.GREENBOOK_RECORD_ID,SAQSCA.FABLOCATION_ID,SAQSCA.FABLOCATION_NAME,SAQSCA.FABLOCATION_RECORD_ID,SAQSCA.ASSEMBLY_DESCRIPTION,SAQSCA.ASSEMBLY_ID,SAQSCA.ASSEMBLY_RECORD_ID,SAQSCA.QUOTE_SERVICE_COVERED_OBJECT_ASSEMBLIES_RECORD_ID as QTESRVCOA_RECORD_ID,SAQTSE.SALESORG_ID,SAQTSE.SALESORG_NAME,SAQTSE.SALESORG_RECORD_ID FROM SAQTSE (NOLOCK) JOIN (SELECT * FROM SAQSCA (NOLOCK) WHERE SAQSCA.QUOTE_RECORD_ID = '{ContractId}' ) SAQSCA ON SAQTSE.QUOTE_RECORD_ID = SAQSCA.QUOTE_RECORD_ID AND SAQTSE.SERVICE_RECORD_ID = SAQSCA.SERVICE_RECORD_ID WHERE SAQTSE.QUOTE_RECORD_ID = '{ContractId}' AND SAQTSE.SERVICE_ID = '{serviceId}') IQ JOIN SAQSCE (NOLOCK) M ON M.SERVICE_RECORD_ID = IQ.SERVICE_RECORD_ID AND M.QUOTE_RECORD_ID = IQ.QUOTE_RECORD_ID AND M.EQUIPMENT_ID = IQ.EQUIPMENT_ID )IQ""".format(UserId=User.Id,  ContractId=ContractRecordId, serviceId=ProductPartnumber)
			...
			SAQIEN_query = """
				...
				SELECT IQ.*, CONVERT(VARCHAR(4000),NEWID()) as QUOTE_ITEM_COVERED_OBJECT_ENTITLEMENTS_RECORD_ID, {UserId} as CPQTABLEENTRYADDEDBY, GETDATE() as CPQTABLEENTRYDATEADDED FROM (
					...
					JOIN SAQICO (NOLOCK) ON SAQICO.SERVICE_RECORD_ID = SAQTSE.SERVICE_RECORD_ID AND SAQICO.QUOTE_RECORD_ID = SAQTSE.QUOTE_RECORD_ID
					WHERE SAQTSE.QUOTE_RECORD_ID = '{QuoteRecordId}' AND SAQTSE.SERVICE_ID = '{ServiceId}') IQ
				""".format(UserId=User.Id, QuoteRecordId=ContractRecordId, ServiceId=ProductPartnumber)
			Log.Info("SAQIEN_query--445---"+str(SAQIEN_query))
			Sql.RunQuery(SAQIEN_query)
			#querystmt = SqlHelper.GetFirst("sp_executesql @T=N'INSERT SAQSAE (KB_VERSION,EQUIPMENT_ID,EQUIPMENT_RECORD_ID,QUOTE_ID,QUOTE_RECORD_ID,SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,CPS_CONFIGURATION_ID,CPS_MATCH_ID,GREENBOOK,GREENBOOK_RECORD_ID,FABLOCATION_ID,FABLOCATION_NAME,FABLOCATION_RECORD_ID,ASSEMBLY_DESCRIPTION,ASSEMBLY_ID,ASSEMBLY_RECORD_ID,QTESRVCOA_RECORD_ID,SALESORG_ID,SALESORG_NAME,SALESORG_RECORD_ID,ENTITLEMENT_XML,QTESRVCOE_RECORD_ID,QUOTE_SERVICE_COV_OBJ_ASS_ENT_RECORD_ID,CPQTABLEENTRYADDEDBY,CPQTABLEENTRYDATEADDED) SELECT IQ.*, CONVERT(VARCHAR(4000),NEWID()) as QUOTE_SERVICE_COV_OBJ_ASS_ENT_RECORD_ID, ''"+str(User.Id)+"'' as CPQTABLEENTRYADDEDBY, GETDATE() as CPQTABLEENTRYDATEADDED FROM(SELECT IQ.*,M.ENTITLEMENT_XML,M.QUOTE_SERVICE_COVERED_OBJ_ENTITLEMENTS_RECORD_ID as QTESRVCOE_RECORD_ID FROM ( SELECT DISTINCT SAQTSE.KB_VERSION,SAQSCA.EQUIPMENT_ID,SAQSCA.EQUIPMENT_RECORD_ID,SAQTSE.QUOTE_ID,SAQTSE.QUOTE_RECORD_ID,SAQTSE.SERVICE_DESCRIPTION,SAQTSE.SERVICE_ID,SAQTSE.SERVICE_RECORD_ID,SAQTSE.CPS_CONFIGURATION_ID,SAQTSE.CPS_MATCH_ID,SAQSCA.GREENBOOK,SAQSCA.GREENBOOK_RECORD_ID,SAQSCA.FABLOCATION_ID,SAQSCA.FABLOCATION_NAME,SAQSCA.FABLOCATION_RECORD_ID,SAQSCA.ASSEMBLY_DESCRIPTION,SAQSCA.ASSEMBLY_ID,SAQSCA.ASSEMBLY_RECORD_ID,SAQSCA.QUOTE_SERVICE_COVERED_OBJECT_ASSEMBLIES_RECORD_ID as QTESRVCOA_RECORD_ID,SAQTSE.SALESORG_ID,SAQTSE.SALESORG_NAME,SAQTSE.SALESORG_RECORD_ID FROM SAQTSE (NOLOCK) JOIN (SELECT * FROM SAQSCA (NOLOCK) WHERE SAQSCA.QUOTE_RECORD_ID = ''"+str(Qt_rec_id)+"'' ) SAQSCA ON SAQTSE.QUOTE_RECORD_ID = SAQSCA.QUOTE_RECORD_ID AND SAQTSE.SERVICE_RECORD_ID = SAQSCA.SERVICE_RECORD_ID WHERE SAQTSE.QUOTE_RECORD_ID = ''"+str(Qt_rec_id)+"'' AND SAQTSE.SERVICE_ID = ''"+str(ProductPartnumber)+"'') IQ JOIN SAQSCE (NOLOCK) M ON M.SERVICE_RECORD_ID = IQ.SERVICE_RECORD_ID AND M.QUOTE_RECORD_ID = IQ.QUOTE_RECORD_ID AND M.EQUIPMENT_ID = IQ.EQUIPMENT_ID )IQ '")   
	for configurationId,ProductPartnumber in zip(configuration,ProductPart):
		qtqtse_query="""
		INSERT SAQSGE (KB_VERSION,ENTITLEMENT_XML,QUOTE_ID,QUOTE_NAME,QUOTE_RECORD_ID,SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,SALESORG_ID,SALESORG_NAME,SALESORG_RECORD_ID,	
		...
		WHERE SAQTSE.QUOTE_RECORD_ID = '{QuoteRecordId}' AND SAQTSE.SERVICE_ID = '{ServiceId}') IQ""".format(UserId=User.Id, QuoteRecordId=ContractRecordId, ServiceId=ProductPartnumber)
...
def quote_SAQICOupdate(cart_id,cart_user_id):
	...
	if gettotal_bundle_query:
		...
		Log.Info('2655--inside iff--qery-----'+str("""INSERT QT__SAQICO (
						...
						SERVICE_DESCRIPTION, SERVICE_ID,EXTENDED_PRICE, SERVICE_RECORD_ID, WAFER_SIZE, TARGET_PRICE, TECHNOLOGY, TOOL_COMPLETION_FLAG, 
