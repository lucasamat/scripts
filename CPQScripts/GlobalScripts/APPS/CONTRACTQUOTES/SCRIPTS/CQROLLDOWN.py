...
def quote_SAQICOupdate(cart_id,cart_user_id):
	...
	if gettotal_bundle_query:
		...
		Log.Info('2655--inside iff--qery-----'+str("""INSERT QT__SAQICO (
						...
						SERVICE_DESCRIPTION, SERVICE_ID,EXTENDED_PRICE, SERVICE_RECORD_ID, WAFER_SIZE, TECHNOLOGY, 
		...
		quote_item_covered_obj_insert = """INSERT QT__SAQICO (
						...
						FABLOCATION_ID, FABLOCATION_NAME, FABLOCATION_RECORD_ID, ITEM_LINE_ID, 
						MATERIAL_RECORD_ID, PLATFORM, QUOTE_ID, QTEITM_RECORD_ID, QUOTE_NAME, QUOTE_RECORD_ID, SALE_PRICE, SAP_PART_NUMBER, SERIAL_NO,
						SERVICE_DESCRIPTION, SERVICE_ID,EXTENDED_PRICE, SERVICE_RECORD_ID, WAFER_SIZE, TECHNOLOGY, BD_DISCOUNT, BD_DISCOUNT_RECORD_ID, BD_MARGIN,	
						BD_MARGIN_RECORD_ID, CEILING_PRICE,	CLEANING_COST,	CM_PART_COST, CUSTOMER_TOOL_ID,	EQUIPMENTCATEGORY_ID,	
						EQUIPMENTCATEGORY_RECORD_ID, EQUIPMENT_STATUS, KPI_COST, LABOR_COST, MNT_PLANT_ID, MNT_PLANT_NAME,	
						MNT_PLANT_RECORD_ID, PM_PART_COST,	SALE_DISCOUNT, 
						SALES_MARGIN, SALE_MARGIN_RECORD_ID, SALESORG_ID, SALESORG_NAME, SALESORG_RECORD_ID, TARGET_MARGIN, 
