	...
	if TreeParam == "Z0091":
		...
		if get_ancillaryservice:
			...
			qtqtse_query_anc="""
				...
				WHERE SAQTSE.QUOTE_RECORD_ID = '{QuoteRecordId}'  AND SAQTSE.QTEREV_RECORD_ID = '{revision_rec_id}' AND SAQTSE.SERVICE_ID = '{ServiceId}') IQ JOIN SAQSFE (NOLOCK) M ON IQ.QTSFBLENT_RECORD_ID = QUOTE_SERVICE_FAB_LOC_ENT_RECORD_ID )OQ""".format(UserId=userId, QuoteRecordId=Qt_rec_id, ServiceId='Z0046', revision_rec_id = rev_rec_id)
