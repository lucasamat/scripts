		...
		if kwargs.get('applied_preventive_maintainence_quote_type_changed') == "Yes" and kwargs.get('tools_from_ui') != "Yes":
			...
			self._process_query(
					"""INSERT SAQSKP (
						...
						FROM (SELECT SAQSCO.QUOTE_RECORD_ID,SAQSCO.QTEREV_RECORD_ID,SAQSCO.EQUIPMENT_ID,SAQSCO.SERVICE_RECORD_ID,SAQSCO.GREENBOOK_RECORD_ID,SAQGPA.PM_NAME,SAQGPM.KIT_ID FROM SAQSCO(NOLOCK)
