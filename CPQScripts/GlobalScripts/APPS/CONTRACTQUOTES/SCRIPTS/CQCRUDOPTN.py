	...
	def applied_preventive_maintainence(self, **kwargs):
		...
		self._process_query(
			"""INSERT SAQSKP (
				...
				AND SAQGPM.ASSEMBLY_ID = SAQSCA.ASSEMBLY_ID AND SAQGPM.EQUIPMENT_ID =  SAQSCA.EQUIPMENT_ID AND SAQGPM.SERVICE_RECORD_ID =  SAQSCA.SERVICE_RECORD_ID AND SAQGPM.GREENBOOK_RECORD_ID =  SAQSCA.GREENBOOK_RECORD_ID
