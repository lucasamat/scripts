	...
	def applied_preventive_maintainence(self, **kwargs):
		...
		Sql.RunQuery("""UPDATE SAQGPE
					SET ENTITLEMENT_XML = IQ.ENTITLEMENT_XML
						FROM SAQGPE (NOLOCK)
						INNER JOIN (SELECT SAQSGE.ENTITLEMENT_XML,SAQSGE.QUOTE_RECORD_ID,SAQSGE.QTEREV_RECORD_ID
									FROM SAQSGE (NOLOCK) 
