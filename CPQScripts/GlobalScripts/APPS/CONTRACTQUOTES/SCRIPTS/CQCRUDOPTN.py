		...
		if self.values:
			...
			self._process_query(
					"""INSERT SAQFGB(
    					...
    					SAQFEQ.GREENBOOK != SAQFGB.GREENBOOK AND SAQFGB.QTEREV_RECORD_ID = SAQFEQ.QTEREV_RECORD_ID AND SAQFGB.FABLOCATION_ID=SAQFEQ.FABLOCATION_ID
