		...
		if str(get_ent_billing_type_value).upper() == "FIXED":
			...
			Sql.RunQuery("""INSERT SAQIBP (
					...
					SELECT 
						...
						ISNULL(SAQRIT.NET_PRICE_INGL_CURR, 0) / {get_val}  as as BILLING_VALUE_INGL_CURR
			...
			Sql.RunQuery("""INSERT SAQIBP (
						...
						QUOTE_ITEM_BILLING_PLAN_RECORD_ID, BILLING_END_DATE, BILLING_START_DATE,ANNUAL_BILLING_AMOUNT,BILLING_VALUE, BILLING_VALUE_INGL_CURR,BILLING_TYPE,LINE, QUOTE_ID, QTEITM_RECORD_ID,COMMITTED_VALUE_INDT_CURR,
						QUOTE_RECORD_ID,QTEREV_ID,QTEREV_RECORD_ID,
						BILLING_DATE, BILLING_YEAR,
						EQUIPMENT_DESCRIPTION, EQUIPMENT_ID, EQUIPMENT_RECORD_ID, QTEITMCOB_RECORD_ID, 
						SERVICE_DESCRIPTION, SERVICE_ID, SERVICE_RECORD_ID, GREENBOOK, GREENBOOK_RECORD_ID, SERIAL_NUMBER, WARRANTY_START_DATE, WARRANTY_END_DATE,CPQTABLEENTRYADDEDBY, CPQTABLEENTRYDATEADDED
					...
					SELECT 
						...
						SAQSCO.WARRANTY_START_DATE as BILLING_START_DATE,
						ISNULL(SAQRIT.NET_PRICE, 0) / {get_val}  as BILLING_VALUE,
						ISNULL(SAQRIT.ESTVAL_INGL_CURR, 0) / {get_val}  as as BILLING_VALUE_INGL_CURR
						SAQRIT.ESTVAL_INGL_CURR AS ANNUAL_BILLING_AMOUNT,
						'{billing_type}' as BILLING_TYPE,
						SAQRIT.LINE AS LINE,
						SAQSCO.QUOTE_ID,
						SAQRIT.QUOTE_REVISION_CONTRACT_ITEM_ID as QTEITM_RECORD_ID,	
						SAQRIT.COMVAL_INGL_CURR	 as COMMITTED_VALUE_INDT_CURR,				
						SAQSCO.QUOTE_RECORD_ID,
						SAQSCO.QTEREV_ID,
						SAQSCO.QTEREV_RECORD_ID,
						{BillingDate} as BILLING_DATE,						
