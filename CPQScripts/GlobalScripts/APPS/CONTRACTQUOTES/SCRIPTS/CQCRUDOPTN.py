		...
		if str(get_ent_billing_type_value).upper() == "FIXED":
			...
			Sql.RunQuery("""INSERT SAQIBP (
					...
					SELECT 
						...
						ISNULL(SAQRIT.NET_PRICE_INGL_CURR, 0) / {get_val}  as  BILLING_VALUE_INGL_CURR,
