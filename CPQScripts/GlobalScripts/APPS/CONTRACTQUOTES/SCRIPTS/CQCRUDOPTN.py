					...
					if item_billing_plans_obj:
						...
						for service_obj in services_obj:
							...
							Sql.RunQuery("""INSERT QT__BM_YEAR_1 (
											...
											GREENBOOK,GREENBOOK_RECORD_ID,ITEM_LINE_ID,QUOTE_CURRENCY,
											QUOTE_CURRENCY_RECORD_ID,QUOTE_ID,QUOTE_RECORD_ID,QTEITMCOB_RECORD_ID,
										...
										SELECT  ANNUAL_BILLING_AMOUNT,BILLING_START_DATE,
													...
													ITEM_LINE_ID,BILLING_CURRENCY,
													BILLING_CURRENCY_RECORD_ID,QUOTE_ID,QUOTE_RECORD_ID,QTEITMCOB_RECORD_ID,
											...
											FROM (
												SELECT 
													...
													BILLING_END_DATE,BILLING_TYPE,{BillingYear} as BILLING_YEAR,
													EQUIPMENT_DESCRIPTION,EQUIPMENT_ID,GREENBOOK,GREENBOOK_RECORD_ID,
													LINE as ITEM_LINE_ID,BILLING_CURRENCY,
													BILLING_CURRENCY_RECORD_ID,QUOTE_ID,QUOTE_RECORD_ID,QTEITMCOB_RECORD_ID,
													QTEITM_RECORD_ID,SERIAL_NUMBER,
													SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,WARRANTY_END_DATE,
							...
							Sql.RunQuery("""INSERT QT__BM_YEAR_1 (
											...
											QUOTE_CURRENCY_RECORD_ID,QUOTE_ID,QUOTE_RECORD_ID,SERVICE_DESCRIPTION,
										...
										SELECT SUM(CONVERT(BIGINT, ANNUAL_BILLING_AMOUNT)) AS ANNUAL_BILLING_AMOUNT,{BillingYear} as BILLING_YEAR,
													BILLING_CURRENCY,BILLING_CURRENCY_RECORD_ID,QUOTE_ID,QUOTE_RECORD_ID,
											...
											FROM (
												SELECT 
													...
													BILLING_CURRENCY, BILLING_CURRENCY_RECORD_ID,QUOTE_ID,QUOTE_RECORD_ID,													SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,
