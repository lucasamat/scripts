				...
				"""
					INSERT SAQSGB (
						...
						CpqTableEntryDateModified
							...
							SAQSCO.QUOTE_NAME,
							SAQSCO.QUOTE_RECORD_ID,
							CONVERT(NVARCHAR, SAQFEQ.QTEREV_ID) AS QTEREV_ID,
							SAQSCO.QTEREV_RECORD_ID,
							SAQSCO.SALESORG_ID,
							SAQSCO.SALESORG_NAME,
							SAQSCO.SALESORG_RECORD_ID,
							...
							SAQSCO.FABLOCATION_NAME,
							SAQSCO.FABLOCATION_RECORD_ID,
							convert(NVARCHAR, SAQTMT.CONTRACT_VALID_FROM,101) AS CONTRACT_VALID_FROM,
							convert(NVARCHAR, SAQTMT.CONTRACT_VALID_TO,101) AS CONTRACT_VALID_TO,
							SAQTSV.UOM_ID,
							SAQTSV.PAR_SERVICE_DESCRIPTION,
							SAQTSV.PAR_SERVICE_ID,
							SAQTSV.PAR_SERVICE_RECORD_ID,
