...
class ContractQuoteCoveredObjModel(ContractQuoteCrudOpertion):
	...
	def applied_preventive_maintainence(self, **kwargs):
		self._process_query("""INSERT SAQRGG (
				...
				SAQSCA.QUOTE_SERVICE_GREENBOOK_RECORD_ID as QTESRVGBK_RECORD_ID,
				FROM SYSPBT (NOLOCK) 
				...
				JOIN MAEQUP(NOLOCK) ON MAEQUP.PAR_EQUIPMENT_ID = SAQSCA.EQUIPMENT_ID AND SAQTRV.EQUIPMENT_ID = SAQSCA.ASSEMBLY_ID
