...
def EditCBC(Qt_rec_id, Quote, MODE):		
	...
	Sql.RunQuery("UPDATE SAQTRV SET	REVISION_STATUS = 'SUBMITTED FOR BOOKING' WHERE CHECKLIST_ID = '{checklist_id}' AND QUOTE_RECORD_ID = '{quote_rec_id}' AND QTEREV_RECORD_ID = '{quote_rev_recid}' ".format(quote_rec_id = Quote,quote_rev_recid = quote_revision_record_id))		
	return True
