...
def constructCBC(Qt_rec_id, Quote, MODE):
	...
	for sect in dynamic_sect:
		sec_str += '<div id="container"><div><div id="ctr_drop" class="btn-group dropdown"><div class="dropdown"><i data-toggle="dropdown" class="fa fa-sort-desc dropdown-toggle"></i><ul class="dropdown-menu left" aria-labelledby="dropdownMenuButton"><li class="edit_list"> <a id="'+str(sect.RECORD_ID)+'" class="dropdown-item" href="#" onclick="cbcEDIT(this)">EDIT</a></li></ul></div></div>'+str(sect.SECTION_NAME)+'</div><div class="bootstrap-table">'
		sec_str += (
		'<table id="'
		+ str(table_id)
		+ '_'+str(sect.RECORD_ID)+'" data-escape="true"  data-search-on-enter-key="true" data-show-header="true"  data-filter-control="true" class="table table-hover JColResizer" ondblclick=""> <thead><tr>')	
