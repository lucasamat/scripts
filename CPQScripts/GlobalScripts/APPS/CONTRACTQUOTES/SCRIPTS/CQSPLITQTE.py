...
def splitserviceinsert():
    ...
    VALUES (NEWID(),CONTRACT_VALID_FROM, CONTRACT_VALID_TO, DOC_CURRENCY, DOCURR_RECORD_ID, EXCHANGE_RATE, EXCHANGE_RATE_DATE, EXCHANGE_RATE_RECORD_ID, GL_ACCOUNT_NO, GLOBAL_CURRENCY, GLOBAL_CURRENCY_RECORD_ID,LINE2, OBJECT_ID, OBJECT_TYPE, FABLOCATION_ID, FABLOCATION_NAME, FABLOCATION_RECORD_ID, '{splitservice_recid}', '{splitservice_id}', '{splitservice_name}', PROFIT_CENTER, QUANTITY, QUOTE_ID, '{contract_quote_rec_id}', QTEREV_ID, '{quote_revision_rec_id}', REF_SALESORDER, STATUS, TAXCLASSIFICATION_DESCRIPTION, TAXCLASSIFICATION_ID, TAXCLASSIFICATION_RECORD_ID,NET_VALUE_INGL_CURR, NET_PRICE_INGL_CURR,ESTVAL_INGL_CURR, COMVAL_INGL_CURR, GREENBOOK, GREENBOOK_RECORD_ID, QTEITMSUM_RECORD_ID,LINE,QUOTE_REVISION_CONTRACT_ITEM_ID,NET_PRICE);""".format(contract_quote_rec_id=contract_quote_rec_id,quote_revision_rec_id = quote_revision_rec_id,splitservice_recid = splitservice_recid,splitservice_id=splitservice_id,splitservice_name = splitservice_name,equipments_count =equipments_count )
    Sql.RunQuery(QueryStatement)
