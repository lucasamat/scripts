...
'''def FTSCostCalc(objName):
    ...
    if objName == 'SAQTSE':
        where = " QUOTE_RECORD_ID = '{}' AND SERVICE_ID = '{}'".format(quote,get_serviceid)
    ...
    GetRegion = Sql.GetFirst("SELECT REGION,GLOBAL_CURRENCY FROM SAQTMT WHERE MASTER_TABLE_QUOTE_RECORD_ID = '{}'".format(quote))
