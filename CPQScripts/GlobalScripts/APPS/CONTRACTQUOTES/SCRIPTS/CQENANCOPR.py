							...
							if 'AGS_Z0046' in val.ENTITLEMENT_ID:
								...
								if entitlement_obj:
									try:						
										...
										#ServiceId = serviceId
										whereReq = "QUOTE_RECORD_ID = '{}' and SERVICE_ID = '{}' AND QTEREV_RECORD_ID = '{}'".format(contract_quote_record_id,'Z0046',self.contract_quote_revision_record_id)
