...
class ContractQuoteItem:
	...
	def _quote_annualized_items_insert(self, update=False):
		...
		if self.service_id not in ('Z0100','Z0101'):
		...
		if self.service_id not in ('Z0048','A6200','Z0101','Z0100'):
			#Status
