...
class ContractQuoteItem:
			...
			for quote_item_tag in re.finditer(quote_item_tag_pattern, service_entitlement_obj.ENTITLEMENT_XML):
				...
				if entitlement_id_tag_match:
					...
					if entitlement_display_value_tag_match:
						...
						elif self.quote_service_entitlement_type in ('OFFERING + FAB + GREENBOOK + GROUP OF EQUIPMENT', 'OFFERING + GREENBOOK + GR EQUI', 'OFFERING + CHILD GROUP OF PART','OFFERING+FAB+GREENBOOK+CREDIT','OFFERING+GREENBOOK+TOOLS GROUP', 'OFFER. + FAB + GRNBK + CHILD','OFFERING + FAB + GREENBOOK','OFFERING+GNBK+CHILD GRP OF EQU','OFFERING + CHILD GROUP OF EQP','STR-OFFBGB OBJ-GREQ PRD-GRPT'):
	...
	def _quote_items_insert(self, update=False):		
		...
		if self.source_object_name:		
			...
			elif self.quote_service_entitlement_type in ('OFFERING + FAB + GREENBOOK + GROUP OF EQUIPMENT', 'OFFERING + GREENBOOK + GR EQUI', 'OFFERING + CHILD GROUP OF PART','OFFERING+GREENBOOK+TOOLS GROUP','OFFER. + FAB + GRNBK + CHILD','OFFERING + FAB + GREENBOOK','OFFERING+GNBK+CHILD GRP OF EQU','OFFERING + CHILD GROUP OF EQP','STR-OFFBGB OBJ-GREQ PRD-GRPT'):				
