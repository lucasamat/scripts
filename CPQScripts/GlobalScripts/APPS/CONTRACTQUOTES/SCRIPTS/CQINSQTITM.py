					...
					FROM 
						...
						JOIN (
                            SELECT SAQGPA.SERVICE_ID, SAQGPA.GREENBOOK, SAQGPA.FABLOCATION_ID, SAQGPA.GOT_CODE, SAQGPA.KIT_ID, SAQGPA.KIT_NUMBER, SAQGPA.KIT_NUMBER_RECORD_ID, SAQGPA.QUOTE_RECORD_ID, SAQGPA.QTEREV_RECORD_ID, SAQGPA.GOTCODE_RECORD_ID, SAQGPA.MNTEVT_LEVEL, SAQGPA.SERVICE_DESCRIPTION, SAQGPA.SERVICE_RECORD_ID, SAQGPA.FABLOCATION_NAME, SAQGPA.FABLOCATION_RECORD_ID, SAQGPA.GREENBOOK_RECORD_ID, SAQGPA.PROCESS_TYPE, SAQGPA.DEVICE_NODE
                                ...
                                GROUP BY SAQGPA.SERVICE_ID, SAQGPA.GREENBOOK, SAQGPA.FABLOCATION_ID,SAQGPA.GOT_CODE, SAQGPA.KIT_ID,  SAQGPA.KIT_NUMBER, SAQGPA.KIT_NUMBER_RECORD_ID, SAQGPA.QUOTE_RECORD_ID, SAQGPA.QTEREV_RECORD_ID, SAQGPA.GOTCODE_RECORD_ID, SAQGPA.MNTEVT_LEVEL, SAQGPA.SERVICE_DESCRIPTION, SAQGPA.SERVICE_RECORD_ID, SAQGPA.FABLOCATION_NAME, SAQGPA.FABLOCATION_RECORD_ID,SAQGPA.GREENBOOK_RECORD_ID, SAQGPA.PROCESS_TYPE, SAQGPA.DEVICE_NODE
                        ) SAQGPA ON SAQGPA.QUOTE_RECORD_ID = SAQRIT.QUOTE_RECORD_ID AND SAQGPA.QTEREV_RECORD_ID = SAQRIT.QTEREV_RECORD_ID AND SAQGPA.SERVICE_ID = SAQRIT.SERVICE_ID AND SAQGPA.GREENBOOK_RECORD_ID = SAQRIT.GREENBOOK_RECORD_ID AND SAQGPA.KIT_NUMBER = SAQRIT.OBJECT_ID AND SAQGPA.GOT_CODE = SAQRIT.GOT_CODE
						JOIN SAQGPE (NOLOCK) ON SAQGPE.QUOTE_RECORD_ID = SAQRIT.QUOTE_RECORD_ID AND SAQGPE.QTEREV_RECORD_ID = SAQRIT.QTEREV_RECORD_ID AND SAQGPE.SERVICE_ID = SAQRIT.SERVICE_ID AND SAQGPE.KIT_NUMBER = SAQGPA.KIT_NUMBER AND SAQGPE.GOT_CODE = SAQGPA.GOT_CODE				
						JOIN SAQTMT (NOLOCK) ON SAQTMT.MASTER_TABLE_QUOTE_RECORD_ID = SAQRIT.QUOTE_RECORD_ID AND SAQTMT.QTEREV_RECORD_ID = SAQRIT.QTEREV_RECORD_ID         
						JOIN SAQTRV (NOLOCK) ON SAQTRV.QUOTE_RECORD_ID = SAQTMT.MASTER_TABLE_QUOTE_RECORD_ID AND SAQTRV.QTEREV_RECORD_ID = SAQTMT.QTEREV_RECORD_ID 						
						LEFT JOIN PRSPRV (NOLOCK) ON PRSPRV.SERVICE_RECORD_ID = SAQRIT.SERVICE_RECORD_ID					
					WHERE 
