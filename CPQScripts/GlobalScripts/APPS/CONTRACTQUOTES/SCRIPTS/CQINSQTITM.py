...
class ContractQuoteItem:
	...
	def _insert_quote_item_forecast_parts(self):
		if self.service_id == 'Z0100': 
			Sql.RunQuery("""INSERT SAQRIP (QUOTE_ITEM_FORECAST_PART_RECORD_ID,CPQTABLEENTRYADDEDBY, CPQTABLEENTRYDATEADDED,CpqTableEntryModifiedBy,CpqTableEntryDateModified, PART_DESCRIPTION, PART_NUMBER, SERVICE_DESCRIPTION, SERVICE_DESCRIPTION, SERVICE_ID, SERVICE_RECORD_ID,  QUOTE_ID, QTEITM_RECORD_ID, QUOTE_RECORD_ID, QTEREV_ID, QTEREV_RECORD_ID, LINE ) 
			SELECT 
