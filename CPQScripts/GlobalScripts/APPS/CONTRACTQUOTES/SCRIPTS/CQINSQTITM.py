...
class ContractQuoteItem:
	...
	def _quote_annualized_items_insert(self, update=False):
		...
		temp_equipment_entitlement_table = "SAQITE_EXTEND_{}_{}_{}".format(self.contract_quote_id, datetime_string, batch_group_record_id)
