...
class ContractQuoteItem:
	...
	def _quote_items_object_insert(self, update=False):
		...
		if self.quote_service_entitlement_type not in ('OFFERING + EQUIPMENT','OFFERING+EQUIPMENT','OFRNG+EQUIP','OFFERING + SCH. MAIN. EVENT','OFFERING + PM EVENT','OFFERING + EQUIPMENT + NSO','OFFERING + FAB + SCH. MAIN EVT'):
			self._quote_item_qty_update()
