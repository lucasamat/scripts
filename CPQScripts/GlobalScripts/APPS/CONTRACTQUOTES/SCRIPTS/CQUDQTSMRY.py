...
class ContractQuoteSummaryUpdate:
    ...
    def CalculatePlusDiscount(self):
        ...
        Sql.RunQuery("""UPDATE SAQIGB
            ...
            ON SAQIGB.QUOTE_RECORD_ID = IQ.QUOTE_RECORD_ID  AND SAQIGB.QTEREV_RECORD_ID = IQ.QTEREV_RECORD_ID AND SAQIGB.SERVICE_ID = IQ.SERVICE_ID AND SAQICO.FABLOCATION_RECORD_ID = IQ.FABLOCATION_RECORD_ID AND SAQICO.GREENBOOK_RECORD_ID = IQ.GREENBOOK_RECORD_ID
