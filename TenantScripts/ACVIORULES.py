                        ...
                        if CheckViolaionRule2:
                            for result in CheckViolaionRule2:
                                ...
                                if fflag == 1:
                                    ...
                                    if "ACAPMA" in result.WHERE_CONDITION_01:
                                        getData = Sql.GetFirst("SELECT CpqTableEntryId FROM ACAPMA (NOLOCK) WHERE {} '{}'".format(result.WHERE_CONDITION_01,RecordId))
                                        if getData is None:
                                            SqlQuery = None
                                        else:
                                ...
                                if SqlQuery:
                                    ...
                                    if getCustomQuery is not None:
                                        ...
                                        if getCustomQuery.APRCHN_ID == 'SELFAPPR':
                                            ...
                                            Sql.RunQuery("UPDATE SAQTRV SET REVISION_STATUS = 'APR-APPROVAL PENDING',WORKFLOW_STATUS='APPROVALS' WHERE QUOTE_REVISION_RECORD_ID ='{}'".format(RecordId))
                                    else:
