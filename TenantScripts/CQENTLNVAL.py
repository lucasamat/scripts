...
def entitlemnt_attr_update(partnumber,entitlement_table, where):
    ...
    if get_equipment_count:
        ...
        entitlement_details = [{
                                    ...
                                    #A055S000P01-20807
									{
									"field":["IDLING_ALLOWED","Idling Allowed","AGS_{}_GEN_IDLALW".format(partnumber)]
									},
									#A055S000P01-20807
                                    {
                                    ...
                                    #INC08769653 - A
                                    {
                                    "field":["SOFTWARE_SUPPORT","Software support","AGS_{}_NET_SFWSUP".format(partnumber)]
                                    },
                                    #INC08769653 - A
                                    {
                                    ...
                                    {
                                    "field":["NUMLAY","1770 ITNMLY: Number Of Layers","AGS_{}_NET_NUMLAY".format(partnumber)]
                                    },
            ...
            if get_equipment:
                ...
                while cnt <= get_total_count:
                    ...
                    for ent_rec in get_equipment:
                        ...
                        #INC08621345 - Start - A
                        if entitlement_table == 'SAQSGE':
                            addtional_whr = " AND GREENBOOK = '{}' ".format(ent_rec.GREENBOOK )
                        #INC08621345 - End - A
                        ...
                        for entitlement_detail in entitlement_details:
                            ...
                            #A055S000P01-20723 START
                            if entitlement_id == 'AGS_Z0010_VAL_UPIMPV' and dict_val['AGS_Z0010_VAL_UPIMPV'] == ' ':
                                dict_val['AGS_Z0010_VAL_UPIMPV'] = None
                            #A055S000P01-20723 END
