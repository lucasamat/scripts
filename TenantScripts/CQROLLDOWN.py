...
def CoveredObjEntitlement():
	...
	qtqtse_query= """INSERT SAQSGE (KB_VERSION,QUOTE_ID,QUOTE_NAME,QUOTE_RECORD_ID,QTEREV_RECORD_ID,QTEREV_ID,SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,SALESORG_ID,SALESORG_NAME,SALESORG_RECORD_ID,	
		CPS_CONFIGURATION_ID, CPS_MATCH_ID,GREENBOOK,GREENBOOK_RECORD_ID,QTESRVENT_RECORD_ID,ENTITLEMENT_XML,CONFIGURATION_STATUS,QTESRVGBK_RECORD_ID, QUOTE_SERVICE_GREENBOOK_ENTITLEMENT_RECORD_ID,CPQTABLEENTRYADDEDBY,CPQTABLEENTRYDATEADDED )
		...
		SAQTSE.CPS_CONFIGURATION_ID, SAQTSE.CPS_MATCH_ID,SAQSGB.GREENBOOK,SAQSGB.GREENBOOK_RECORD_ID,SAQTSE.QUOTE_SERVICE_ENTITLEMENT_RECORD_ID as QTESRVENT_RECORD_ID,SAQTSE.ENTITLEMENT_XML,SAQTSE.CONFIGURATION_STATUS,SAQSGB.QUOTE_SERVICE_GREENBOOK_RECORD_ID as QTESRVGBK_RECORD_ID FROM
	SAQTSE (NOLOCK) 
    JOIN SAQSGB (NOLOCK) ON SAQTSE.QUOTE_RECORD_ID = SAQSGB.QUOTE_RECORD_ID AND SAQSGB.QTEREV_RECORD_ID = SAQTSE.QTEREV_RECORD_ID AND SAQTSE.SERVICE_ID = SAQSGB.SERVICE_ID
   
		WHERE SAQTSE.QUOTE_RECORD_ID ='{QuoteRecordId}'  AND SAQTSE.QTEREV_RECORD_ID = '{revision_rec_id}' AND SAQTSE.SERVICE_ID = '{ServiceId}' and SAQSGB.GREENBOOK NOT IN (SELECT DISTINCT SAQSGE.GREENBOOK from SAQSGE WHERE QUOTE_RECORD_ID ='{QuoteRecordId}'  AND QTEREV_RECORD_ID = '{revision_rec_id}' AND SERVICE_ID = '{ServiceId}'))IQ""".format(username=userName, QuoteRecordId=Qt_rec_id, ServiceId=TreeParam, revision_rec_id = rev_rec_id)
	#INC08709720,A055S000P01-21055 - End - M
	...
	qtqsce_query="""
		...
		SAQTSE (NOLOCK)
		JOIN SAQSCO (NOLOCK) ON SAQSCO.SERVICE_RECORD_ID = SAQTSE.SERVICE_RECORD_ID AND SAQSCO.QUOTE_RECORD_ID = SAQTSE.QUOTE_RECORD_ID  AND SAQSCO.QTEREV_RECORD_ID = SAQTSE.QTEREV_RECORD_ID
		WHERE SAQTSE.QUOTE_RECORD_ID = '{QuoteRecordId}' AND SAQTSE.QTEREV_RECORD_ID = '{revision_rec_id}' AND SAQTSE.SERVICE_ID = '{ServiceId}' AND SAQSCO.QUOTE_SERVICE_COVERED_OBJECTS_RECORD_ID not in (SELECT QTESRVCOB_RECORD_ID  FROM SAQSCE (NOLOCK) WHERE QUOTE_RECORD_ID = '{QuoteRecordId}'   AND QTEREV_RECORD_ID = '{revision_rec_id}' AND SERVICE_ID = '{ServiceId}') ) IQ""".format(
		username=userName, 
		QuoteRecordId=Qt_rec_id, 
		ServiceId=TreeParam, 
		revision_rec_id = rev_rec_id)
	#A055S000P01-21104 - End - M
	#Q-INC08921490-M ends
	...
	#INC09026574,A055S000P01-21013 - Start - M
	# Duplicate records removed from assembly level entitlement in offering - End
	#INC09026574,A055S000P01-21013 - Start - M
	SAQSAE_ent_renewal= """INSERT SAQSAE (KB_VERSION,EQUIPMENT_ID,EQUIPMENT_RECORD_ID,QUOTE_ID,QUOTE_RECORD_ID,QTEREV_RECORD_ID,QTEREV_ID,SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,CPS_CONFIGURATION_ID,CPS_MATCH_ID,GREENBOOK,GREENBOOK_RECORD_ID,FABLOCATION_ID,FABLOCATION_NAME,FABLOCATION_RECORD_ID,ASSEMBLY_DESCRIPTION,ASSEMBLY_ID,ASSEMBLY_RECORD_ID,QTESRVCOA_RECORD_ID,SALESORG_ID,SALESORG_NAME,SALESORG_RECORD_ID,ENTITLEMENT_XML,CONFIGURATION_STATUS,QTESRVCOE_RECORD_ID,QUOTE_SERVICE_COV_OBJ_ASS_ENT_RECORD_ID,CPQTABLEENTRYADDEDBY,CPQTABLEENTRYDATEADDED) SELECT IQ.*, CONVERT(VARCHAR(4000),NEWID()) as QUOTE_SERVICE_COV_OBJ_ASS_ENT_RECORD_ID, 'COM_USER_CPQ' as CPQTABLEENTRYADDEDBY, GETDATE() as CPQTABLEENTRYDATEADDED FROM (SELECT SAQSCE.KB_VERSION,SAQSCA.EQUIPMENT_ID,SAQSCA.EQUIPMENT_RECORD_ID,SAQSCE.QUOTE_ID,SAQSCE.QUOTE_RECORD_ID,SAQSCE.QTEREV_RECORD_ID,SAQSCE.QTEREV_ID,SAQSCE.SERVICE_DESCRIPTION,SAQSCE.SERVICE_ID,SAQSCE.SERVICE_RECORD_ID,SAQSCE.CPS_CONFIGURATION_ID,SAQSCE.CPS_MATCH_ID,SAQSCA.GREENBOOK,SAQSCA.GREENBOOK_RECORD_ID,SAQSCA.FABLOCATION_ID,SAQSCA.FABLOCATION_NAME,SAQSCA.FABLOCATION_RECORD_ID,SAQSCA.ASSEMBLY_DESCRIPTION,SAQSCA.ASSEMBLY_ID,SAQSCA.ASSEMBLY_RECORD_ID,SAQSCA.QUOTE_SERVICE_COVERED_OBJECT_ASSEMBLIES_RECORD_ID as QTESRVCOA_RECORD_ID,SAQSCE.SALESORG_ID,SAQSCE.SALESORG_NAME,SAQSCE.SALESORG_RECORD_ID ,SAQSCE.ENTITLEMENT_XML,SAQSCE.CONFIGURATION_STATUS,SAQSCE.QUOTE_SERVICE_COVERED_OBJ_ENTITLEMENTS_RECORD_ID as QTESRVCOE_RECORD_ID FROM SAQSCA (NOLOCK) INNER JOIN SAQSCE (NOLOCK) ON SAQSCE.SERVICE_RECORD_ID = SAQSCA.SERVICE_RECORD_ID AND SAQSCE.QUOTE_RECORD_ID = SAQSCA.QUOTE_RECORD_ID AND SAQSCE.QTEREV_RECORD_ID = SAQSCA.QTEREV_RECORD_ID AND SAQSCE.EQUIPMENT_ID = SAQSCA.EQUIPMENT_ID AND SAQSCE.QTESRVCOB_RECORD_ID= SAQSCA.QTESRVCOB_RECORD_ID AND SAQSCE.FABLOCATION_ID = SAQSCA.FABLOCATION_ID WHERE SAQSCE.QUOTE_RECORD_ID = '{ContractId}' AND SAQSCE.QTEREV_RECORD_ID = '{revision_rec_id}' AND SAQSCE.SERVICE_ID = '{serviceId}' ) IQ""".format(username = userName ,  ContractId=Qt_rec_id, serviceId=TreeParam, revision_rec_id = rev_rec_id)
	#INC09026574,A055S000P01-21013 - End - M
	...
	sendEmail(level)
	#INC08615548 - Start - M
	return {"Response": [{"Status": "200","Message": "Entitlement rolldown is completed"}]} #INC08615548 - End - M
...
def sendEmail(level):
	...
	copyEmail6 = MailAddress("Selvirajapriya_Krishnan@contractor.amat.com")#INC08921490
...
def covobjrenewal():
	...
	for ProductPartnumber in ProductPart:
		...
		if ProductVersionObj is not None:
			...
			qtqtse_query="""
				INSERT SAQSGE (KB_VERSION,QUOTE_ID,QUOTE_NAME,QUOTE_RECORD_ID,QTEREV_RECORD_ID,QTEREV_ID,SERVICE_DESCRIPTION,SERVICE_ID,SERVICE_RECORD_ID,SALESORG_ID,SALESORG_NAME,SALESORG_RECORD_ID,	
				CPS_CONFIGURATION_ID, CPS_MATCH_ID,GREENBOOK,GREENBOOK_RECORD_ID,QTESRVENT_RECORD_ID,QTSFBLENT_RECORD_ID,FABLOCATION_ID,FABLOCATION_NAME,FABLOCATION_RECORD_ID,QTESRVGBK_RECORD_ID,ENTITLEMENT_XML, QUOTE_SERVICE_GREENBOOK_ENTITLEMENT_RECORD_ID,CPQTABLEENTRYDATEADDED, CPQTABLEENTRYADDEDBY)
				...
				SELECT 
					DISTINCT	
					SAQTSE.KB_VERSION,SAQTSE.QUOTE_ID,SAQTSE.QUOTE_NAME,SAQTSE.QUOTE_RECORD_ID,SAQTSE.QTEREV_RECORD_ID,SAQTSE.QTEREV_ID,SAQTSE.SERVICE_DESCRIPTION,SAQTSE.SERVICE_ID,SAQTSE.SERVICE_RECORD_ID,SAQTSE.SALESORG_ID,SAQTSE.SALESORG_NAME,SAQTSE.SALESORG_RECORD_ID,SAQTSE.CPS_CONFIGURATION_ID, SAQTSE.CPS_MATCH_ID,SAQSCO.GREENBOOK,SAQSCO.GREENBOOK_RECORD_ID,SAQTSE.QUOTE_SERVICE_ENTITLEMENT_RECORD_ID as QTESRVENT_RECORD_ID,SAQSFE.QUOTE_SERVICE_FAB_LOC_ENT_RECORD_ID as QTSFBLENT_RECORD_ID,SAQSFE.FABLOCATION_ID,SAQSFE.FABLOCATION_NAME,SAQSFE.FABLOCATION_RECORD_ID,SAQSGB.QUOTE_SERVICE_GREENBOOK_RECORD_ID as QTESRVGBK_RECORD_ID
				FROM
				SAQTSE (NOLOCK)
                JOIN SAQSGB (NOLOCK) ON SAQTSE.QUOTE_RECORD_ID = SAQSGB.QUOTE_RECORD_ID AND SAQSGB.QTEREV_RECORD_ID = SAQTSE.QTEREV_RECORD_ID AND SAQTSE.SERVICE_ID = SAQSGB.SERVICE_ID
	...
	for configurationId,ProductPartnumber in zip(configuration,ProductPart):
		...
		CPS_CONFIGURATION_ID, CPS_MATCH_ID,GREENBOOK,GREENBOOK_RECORD_ID,QTESRVGBK_RECORD_ID,QTESRVENT_RECORD_ID,DATA_TYPE,FACTOR_CURRENCY,FACTOR_CURRENCY_RECORD_ID,QUOTE_SERVICE_GREENBOOK_ENTITLEMENT_RECORD_ID,CPQTABLEENTRYDATEADDED, CPQTABLEENTRYADDEDBY)
		...
		SELECT 
			DISTINCT	
			SAQTSE.KB_VERSION,SAQTSE.ENTITLEMENT_XML,SAQTSE.QUOTE_ID,SAQTSE.QUOTE_NAME,SAQTSE.QUOTE_RECORD_ID,SAQTSE.QTEREV_RECORD_ID,SAQTSE.QTEREV_ID,SAQTSE.SERVICE_DESCRIPTION,SAQTSE.SERVICE_ID,SAQTSE.SERVICE_RECORD_ID,SAQTSE.SALESORG_ID,SAQTSE.SALESORG_NAME,SAQTSE.SALESORG_RECORD_ID,SAQTSE.CPS_CONFIGURATION_ID, SAQTSE.CPS_MATCH_ID,SAQSCO.GREENBOOK,SAQSCO.GREENBOOK_RECORD_ID,SAQSGB.QUOTE_SERVICE_GREENBOOK_RECORD_ID as QTESRVGBK_RECORD_ID,SAQTSE.QUOTE_SERVICE_ENTITLEMENT_RECORD_ID as QTESRVENT_RECORD_ID,SAQTSE.DATA_TYPE,SAQTSE.FACTOR_CURRENCY,SAQTSE.FACTOR_CURRENCY_RECORD_ID
		FROM
		SAQTSE (NOLOCK)
        ...
        JOIN SAQSGB (NOLOCK) ON SAQTSE.SERVICE_ID = SAQSGB.SERVICE_ID  AND SAQTSE.QUOTE_RECORD_ID = SAQSGB.QUOTE_RECORD_ID AND SAQSGB.QTEREV_RECORD_ID = SAQTSE.QTEREV_RECORD_ID 
